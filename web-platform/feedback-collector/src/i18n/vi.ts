...
export default {
  ...
  'feedback-collector.can-be-contacted.label-appify-without-link':
    'Có, các đội ngũ Atlassian có thể liên hệ để tìm hiểu về trải nghiệm của tôi cho mục đích cải thiện các ứng dụng và dịch vụ của Atlassian. Tôi công nhận Chính sách quyền riêng tư của Atlassian.',
  'feedback-collector.can-be-contacted.label-without-link':
    'Có, các đội ngũ Atlassian có thể liên hệ với tôi để tìm hiểu thêm về trải nghiệm của tôi nhằm cải thiện các sản phẩm và dịch vụ của Atlassian. Tôi công nhận Chính sách quyền riêng tư của Atlassian.',
