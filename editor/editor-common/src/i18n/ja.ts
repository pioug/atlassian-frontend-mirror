...
export default {
  ...
  'editor.trackChanges.removed': '削除済み',
  'fablric.editor.viewAllInserts': 'すべての挿入アイテムを表示',
  'fabric.editor.accessToSyncedBlockRequested': 'アクセス権をリクエスト済み',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'あなたが取り組んでいる課題に類似する課題に基づいて返信内容を拡張します',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': '返信を提案する',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint': 'Rovo で文章を作成するか、次から選択してください',
  'fabric.editor.ai.config.item.generateEscalationNotes.description':
    '課題のコンテキストに基づいてエスカレーションのメモを生成できます',
  'fabric.editor.ai.config.item.generateEscalationNotes.title': 'エスカレーションのメモを生成する',
  ...
  'fabric.editor.ai.experience.adfStreamingError': '申し訳ありません。応答を取得できませんでした。',
  'fabric.editor.ai.experience.aifcAdfStreamingError': '申し訳ありません。応答を取得できませんでした。',
  'fabric.editor.ai.experience.aifcApiError': '不明なエラーが発生しました。',
  'fabric.editor.ai.experience.aifcApiErrorRetry': '不明なエラーが発生しました。リロードしてもう一度お試しください。',
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    'コンテンツがアトラシアンの<link>利用規定</link>に準拠していません。',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    'あなたのコンテンツには、HIPAA の制限対象となるコンテンツへのリンクが含まれています。リンクを削除して、もう一度お試しください。',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    'リクエストを完了するには、コンテンツが不足しています。コンテンツを追加してから、もう一度お試しください。',
  'fabric.editor.ai.experience.aifcInternalServerError':
    '申し訳ありません。応答を取得できませんでした。5 分後にもう一度お試しになるか、<link>Rovo のステータスを確認してください</link>。',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    '<link>リクエスト数の上限</link>に達しました。5 分ほど待ってから、もう一度お試しください。',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'コンテンツが多すぎるため処理できません。コンテンツを減らしてから、もう一度お試しください。',
  ...
  'fabric.editor.ai.experience.dialogAriaLabel': 'Atlassian Intelligence ダイアログ',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': 'リクエストをキャンセルして応答を破棄しますか?',
  ...
  'fabric.editor.ai.toolbar.adjustLength.title': '長さを調整',
  ...
  'fabric.editor.block.menu.copy.content': 'コンテンツをコピーする',
  'fabric.editor.block.menu.copy.link': 'リンクをコピー',
  'fabric.editor.block.menu.copy.link.to.block': 'ブロックへのリンクをコピー',
  'fabric.editor.block.menu.copy.synced.block': '同期されたブロックをコピー',
  'fabric.editor.block.menu.create.synced.block': '同期されたブロックを作成します',
  'fabric.editor.block.menu.delete.block': '削除',
  'fabric.editor.block.menu.layout': 'レイアウト',
  'fabric.editor.block.menu.link.copied.to.clipboard': 'リンクをクリップボードにコピーしました',
  ...
  'fabric.editor.block.menu.turn.into': '次に変換する',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': 'ドラッグして移動{br}クリックしてメニューを開く',
  ...
  'fabric.editor.breakoutMaxWidthLabel': '最大幅',
  ...
  'fabric.editor.contextPanel.panelContentLabel': 'スクロール可能なコンテキスト パネル コンテンツ',
  'fabric.editor.contextPanel.panelLabel': 'コンテキスト パネル',
  'fabric.editor.copiedToClipboard': 'コピーしました',
  'fabric.editor.copySyncBlock': 'コピー',
  'fabric.editor.copySyncBlockTooltip': '参照をクリップボードにコピー',
  ...
  'fabric.editor.createSyncBlockLabel': '同期されたブロックを作成します',
  ...
  'fabric.editor.deleteConfirmationModalCancelButton': 'キャンセル',
  'fabric.editor.deleteConfirmationModalDeleteButton': '削除',
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, other {このコンテンツを削除すると、{syncBlockCount,number} 個の同期済みブロックも削除されます。他の場所でこれらのブロックを参照すると、エラーが表示されます。削除を続行しますか?}}',
  'fabric.editor.deleteConfirmationModalTitle': '同期済みコンテンツを削除しようとしています',
  ...
  'fabric.editor.editSourceLabel': 'ソースを編集',
  'fabric.editor.editSourceTooltip': '同期ブロックのソース ページに移動',
  'fabric.editor.editSourceTooltipDisabled': 'ソース リンクは現在利用できません',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    'オフラインのようです。同期済みコンテンツを作成するには、インターネットに接続してください。',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    'オフラインのようです。同期済みコンテンツを削除するには、インターネットに接続してください。',
  'fabric.editor.error.description.failToEditWhenOffline':
    'オフラインのようです。同期済みコンテンツを編集するには、インターネットに接続してください。',
  'fabric.editor.error.title.failToCreate': 'オフラインのときは同期済みコンテンツを作成できません',
  'fabric.editor.error.title.failToDelete': '削除できませんでした',
  'fabric.editor.error.title.failToEdit': 'オフラインのときは同期済みコンテンツを編集できません',
  ...
  'fabric.editor.highlight.removeColor': '色を削除',
  ...
  'fabric.editor.imageBorderColor.dropdownAriaLabel': 'イメージ枠線オプションの [色] ドロップダウン',
  ...
  'fabric.editor.limitedModeDescription':
    '速度を改善して所要時間を短縮するため、<learnMoreLink>一部の編集機能が制限されています</learnMoreLink>。',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'スピードと所要時間を改善するには、一部の編集機能が制限されている場合をご確認ください。',
  'fabric.editor.limitedModeTitle': 'スピードを改善する',
  ...
  'fabric.editor.longEmptyNodePlaceholderPrefix': '次を入力: ',
  ...
  'fabric.editor.requestAccessToSyncedBlock': 'アクセス権をリクエスト',
  'fabric.editor.requestAccessToSyncedBlockError': '問題が発生しました。クリックしてもう一度お試しください',
  ...
  'fabric.editor.resizeHandle': 'サイズ変更ハンドル',
  ...
  'fabric.editor.shortEmptyNodePlaceholderSuffix': ' を入力して挿入',
  ...
  'fabric.editor.syncBlockGroup': '同期ブロックのタイプ',
  'fabric.editor.syncBlockPlaceholderText':
    'コンテンツを追加してからこの同期ブロックをコピーすると、スペースをまたいでアクセスできます',
  'fabric.editor.syncedBlock': '同期されたブロックを作成します',
  'fabric.editor.syncedBlock.description': '複数の場所間でコンテンツを同期します',
  'fabric.editor.syncedBlockGeneralErrorDescription': 'この同期されたブロックの読み込み中に問題が発生しました。',
  'fabric.editor.syncedBlockNotFoundDescription': 'この同期されたブロックを読み込めません。',
  'fabric.editor.syncedBlockNotFoundIconAltText': '同期されたブロックが見つかりません。',
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    'この同期済みブロックのソースとなるコンテンツ アイテムにはアクセスできません。',
  'fabric.editor.syncedBlockPermissionDeniedHeading': 'この同期済みブロックを閲覧する権限がありません',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': '権限は拒否されました。',
  ...
  'fabric.editor.taskList': 'タスク リスト',
  ...
  'fabric.editor.toolbarAppears': 'ツールバーの表示',
