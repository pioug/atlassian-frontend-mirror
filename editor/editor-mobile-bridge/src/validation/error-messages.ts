...
export const PAYLOAD_OBJECT = IS_DEV ? 'SelectionPayload expected to be object' : '1';
export const SELECTION_SHAPE = IS_DEV
	? 'SelectionPayload needs to be of shape { selection, rect }'
	: '2';
export const RECT_OBJECT = IS_DEV ? 'SelectionPayload.rect expected to be object' : '3';
