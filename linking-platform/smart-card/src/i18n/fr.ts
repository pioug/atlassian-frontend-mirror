...
export default {
  ...
  "fabric.linking.connect_unauthorised_account_description": "Connectez-vous à Atlassian pour obtenir plus d'informations sur votre travail et collaborer depuis un seul et même endroit.",
