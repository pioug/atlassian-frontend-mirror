...
export default {
  'feedback-collector.can-be-contacted.label':
    'Atlassian må kontakte mig vedrørende denne feedback',
  'feedback-collector.cancel-button.label': 'Annuller',
  'feedback-collector.enrol-in-research.label':
    'Jeg vil gerne deltage i produktundersøgelser',
  ...
  'feedback-collector.form.suggestion.label':
    'Fortæl os, hvad du gerne så forbedret',
  ...
  'feedback-collector.success-flag.description':
    'Din feedback hjælper os med at forbedre vores produkter.',
