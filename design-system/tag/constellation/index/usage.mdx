...
Use tags to label UI objects for quick recognition and navigation. They can be used for various types of objects, including: free form text, predefined text, rules, or contacts.
...
Tags can be permanent or removable (by displaying the remove icon). When a tag is removed, the tags will realign towards their direction of alignment (aligned to the start or end).
