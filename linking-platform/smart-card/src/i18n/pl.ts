...
export default {
  ...
  'fabric.linking.connect_unauthorised_account_description-appify':
    'Połącz konto {context}, aby współpracować w różnych aplikacjach Atlassian.',
  ...
  'fabric.linking.connect_unauthorised_account_description_no_provider-appify':
    'Połącz swoje konto, aby współpracować w różnych aplikacjach Atlassian.',
  ...
  'fabric.linking.follow_project_error-galaxia':
    'Podczas próby zaobserwowania przestrzeni wystąpił błąd. Sprawdź połączenie internetowe lub odśwież stronę i spróbuj ponownie.',
  ...
  'fabric.linking.learn_more_about_connecting_account-appify':
    'Dowiedz się więcej o łączeniu konta z aplikacjami Atlassian.',
  ...
  'fabric.linking.unfollow_project_description-galaxia':
    'Przestań obserwować, aby nie dostawać więcej powiadomień o przestrzeni',
  ...
  'fabric.linking.unfollow_project_error-galaxia':
    'Podczas próby zaprzestania obserwowania przestrzeni wystąpił błąd. Sprawdź połączenie internetowe lub odśwież stronę i spróbuj ponownie.',
