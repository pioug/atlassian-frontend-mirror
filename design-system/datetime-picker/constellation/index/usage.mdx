...
Date time picker is commonly used in [forms](/components/form).
...
- If you need to specify date or time only, see [date picker](/components/datetime-picker/date-picker) or
  [time picker](/components/datetime-picker/time-picker).
