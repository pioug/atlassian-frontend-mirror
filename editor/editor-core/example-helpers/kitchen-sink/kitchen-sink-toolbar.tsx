...
export const KitchenSinkToolbar = React.memo((props: KitchenSinkToolbarProps) => {
	return (
		<React.Fragment>
			<LanguagePicker languages={languages} locale={props.locale} onChange={props.loadLocale} />
