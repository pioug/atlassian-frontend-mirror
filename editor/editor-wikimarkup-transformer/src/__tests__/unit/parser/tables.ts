...
this is a new line text, not in the table`,
		...
		['should parse properly medias inside a cell', '|!quicktime.mov|width=300,height=400!|'],
		[
...
`,
		...
		['ADFS-700 Should not consider trailing spaces as a cell at the end of row', '|a| \n|b|'],
		[
