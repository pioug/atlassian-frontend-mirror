...
**Unit doc:** `.agents/knowledge-index/domains/media/units/atlaskit-icon-file-type.md`
**Standards page:** `.agents/knowledge-index/domains/media/units/atlaskit-icon-file-type/standards-and-patterns.md`
