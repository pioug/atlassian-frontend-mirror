...
//Hungarian
export default {
  '1M7iXg': 'JQL-lekérdezésszerkesztő',
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Ellenőrizd a kapcsolatot, majd frissíts, vagy <a>nyisd meg ezt a Jira-munkateret a Confluence-ben</a>, és ellenőrizd.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Csatlakoztasd a(z) {providerName}-fiókodat, hogy együtt dolgozhassatok több Atlassian-alkalmazásban is.',
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    'Várj néhány percet, majd próbálkozz újra. Ha a probléma továbbra is fennáll, ellenőrizd a terület beállításait, vagy fordulj a támogatáshoz.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Ellenőrizd a kapcsolatot, majd frissíts, vagy <a>nyisd meg ezt a munkateret a Jirában</a>, és ellenőrizd.',
