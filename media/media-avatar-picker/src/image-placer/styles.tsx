...
export const marginWrapperSquareStyles = ({ width, height, size }: MarginWrapperProps) =>
	css({
		position: 'absolute',
		left: 0,
		top: 0,
...
export const marginWrapperCircleStyles = ({ width, height, size }: MarginWrapperProps) =>
	css({
		position: 'absolute',
		overflow: 'hidden',
		left: '0px',
