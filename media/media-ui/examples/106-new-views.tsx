...
import { ButtonAppearances } from '../../../core/button/src';
    ...
    <IntlProvider locale={'en'}>
      <Page>
        <div style={{ padding: '30px' }}>
          ...
          <ActionList items={[PreviewAction({ src: kittyThumb })]} />
          ...
          <BlockCardResolvedView
            ...
            context={{ text: providerProps.name, icon: providerProps.iconUrl }}
            description={bylineProps.text}
          ...
          <BlockCardForbiddenView
            byline={{
              text:
                'somebody@somewhere does not have permission to view this preview',
            }}
            context={{ text: providerProps.name, icon: providerProps.iconUrl }}
