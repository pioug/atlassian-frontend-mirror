...
describe('BitbucketTransformer: serializer', () => {
	describe('tables', () => {
		...
		it('should serialized even if there is only header row', () => {
			expect(
				markdownSerializer.serialize(
					table()(tr(th({})(p('h1')), th({})(p('h2')), th({})(p('h3'))))(defaultSchema),
				),
			).toEqual('| h1 | h2 | h3 |\n| --- | --- | --- |\n');
		});
			...
			expect(
				markdownSerializer.serialize(
					table()(
						...
						tr(td({})(p('c11', strong('CC'))), td({})(p('c12')), td({})(p('c13'))),
					)(defaultSchema),
				),
			).toEqual('| h1**HH** | h2 | h3 |\n| --- | --- | --- |\n| c11**CC** | c12 | c13 |\n');
		});
		...
		it('should preserve inline code correctly', () => {
			expect(
				markdownSerializer.serialize(
					table()(
						tr(th({})(p('h1')), th({})(p('h2')), th({})(p('h3'))),
						tr(td({})(p('c11', code('test'))), td({})(p('c12')), td({})(p('c13'))),
					)(defaultSchema),
				),
			).toEqual('| h1 | h2 | h3 |\n| --- | --- | --- |\n| c11`test` | c12 | c13 |\n');
		});
		...
		it('should separate content of multiple blocks with space', () => {
			expect(
				markdownSerializer.serialize(
					table()(
						tr(th({})(p('h1')), th({})(p('h2')), th({})(p('h3'))),
						tr(td({})(p('c111'), p('c112')), td({})(p('c12')), td({})(p('c13'))),
					)(defaultSchema),
				),
			).toEqual('| h1 | h2 | h3 |\n| --- | --- | --- |\n| c111 c112 | c12 | c13 |\n');
		});
