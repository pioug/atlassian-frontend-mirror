...
export default {
  ...
  'editor.trackChanges.removed': '제거됨',
  'fablric.editor.viewAllInserts': '모든 삽입 보기',
  'fabric.editor.accessToSyncedBlockRequested': '액세스 요청됨',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    '작업 중인 이슈와 비슷한 이슈를 기반으로 회신을 개선합니다.',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': '회신 제안',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint': 'Rovo로 글을 쓰거나 아래에서 선택하세요',
  ...
  'fabric.editor.ai.experience.adfStreamingError': '죄송합니다. 응답을 받을 수 없습니다.',
  'fabric.editor.ai.experience.aifcAdfStreamingError': '죄송합니다. 응답을 받을 수 없습니다.',
  'fabric.editor.ai.experience.aifcApiError': '알 수 없는 오류가 발생했습니다.',
  'fabric.editor.ai.experience.aifcApiErrorRetry': '알 수 없는 오류가 발생했습니다. 다시 로드한 후 다시 시도하세요.',
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    '콘텐츠가 Atlassian의 <link>사용 제한 정책</link>을 준수하지 않을 수 있습니다.',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    '콘텐츠에 HIPAA 제한 콘텐츠에 대한 링크가 포함되어 있습니다. 링크를 제거하고 다시 시도하세요.',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    '요청을 완료하려면 더 많은 콘텐츠가 필요합니다. 더 많은 콘텐츠를 선택하고 다시 시도하세요.',
  'fabric.editor.ai.experience.aifcInternalServerError':
    '죄송합니다. 응답을 받을 수 없습니다. 5분 후에 다시 시도하거나 <link>Rovo 상태를 확인</link>하세요.',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    '<link>최대 요청 수</link>에 도달했습니다. 5분 후에 다시 시도하세요.',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    '처리해야 할 콘텐츠가 너무 많습니다. 콘텐츠를 더 적게 선택하고 다시 시도하세요.',
  ...
  'fabric.editor.ai.experience.dialogAriaLabel': 'Atlassian Intelligence 대화 상자',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': '요청을 취소하고 응답을 버리시겠습니까?',
  ...
  'fabric.editor.ai.toolbar.DefineDropdownIconTitle.title': '정의',
  'fabric.editor.ai.toolbar.adjustLength.title': '길이 조정',
  ...
  'fabric.editor.block.menu.copy.content': '콘텐츠 복사',
  'fabric.editor.block.menu.copy.link': '링크 복사',
  'fabric.editor.block.menu.copy.link.to.block': '차단할 링크 복사',
  'fabric.editor.block.menu.copy.synced.block': '동기화된 블록 복사',
  'fabric.editor.block.menu.create.synced.block': '동기화된 차단 만들기',
  'fabric.editor.block.menu.delete.block': '삭제',
  'fabric.editor.block.menu.layout': '레이아웃',
  'fabric.editor.block.menu.link.copied.to.clipboard': '링크가 클립보드에 복사됨',
  'fabric.editor.block.menu.move.down': '아래로 이동',
  'fabric.editor.block.menu.move.up': '위로 이동',
  'fabric.editor.block.menu.new.lozenge': '신규',
  'fabric.editor.block.menu.paragraph': '문단',
  'fabric.editor.block.menu.turn.into': '다음으로 전환',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': '드래그하여 이동합니다 {br} 메뉴를 열려면 클릭하세요',
  ...
  'fabric.editor.breakoutMaxWidthLabel': '최대 너비',
  ...
  'fabric.editor.createSyncBlockLabel': '동기화된 블록 만들기',
  ...
  'fabric.editor.deleteConfirmationModalCancelButton': '취소',
  'fabric.editor.deleteConfirmationModalDeleteButton': '삭제',
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, other {이 콘텐츠를 삭제하면 {syncBlockCount,number}개의 동기화된 블록도 제거됩니다. 기타 위치에 있는 이 블록을 참조하면 오류가 표시됩니다. 삭제를 계속하시겠습니까?}}',
  'fabric.editor.deleteConfirmationModalTitle': '동기화된 콘텐츠를 삭제하려고 합니다',
  ...
  'fabric.editor.editSourceLabel': '소스 편집',
  'fabric.editor.editSourceTooltip': '동기화 블록의 소스 페이지로 이동',
  'fabric.editor.editSourceTooltipDisabled': '소스 링크는 현재 사용할 수 없습니다',
  ...
  'fabric.editor.elementbrowser.featured.whiteboard.description':
    '화이트보드를 사용하여 페이지에 시각적 개체를 추가합니다',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    '오프라인 상태인 것 같습니다. 동기화된 콘텐츠를 만들려면 인터넷에 연결하세요.',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    '오프라인 상태인 것 같습니다. 동기화된 콘텐츠를 삭제하려면 인터넷에 연결하세요.',
  'fabric.editor.error.description.failToEditWhenOffline':
    '오프라인 상태인 것 같습니다. 동기화된 콘텐츠를 편집하려면 인터넷에 연결하세요.',
  'fabric.editor.error.title.failToCreate': '오프라인에서 동기화된 콘텐츠를 만들 수 없음',
  'fabric.editor.error.title.failToDelete': '삭제하지 못했습니다',
  'fabric.editor.error.title.failToEdit': '오프라인에서 동기화된 콘텐츠를 편집할 수 없음',
  ...
  'fabric.editor.highlight.removeColor': '색상 제거',
  ...
  'fabric.editor.limitedModeDescription':
    '속도와 응답 시간을 높이기 위해 <learnMoreLink>일부 편집 기능이 제한</learnMoreLink>됩니다.',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    '속도와 반응 시간을 높이기 위해 일부 편집 기능이 제한되어 있습니다.',
  'fabric.editor.limitedModeTitle': '속도 개선',
  ...
  'fabric.editor.longEmptyNodePlaceholderPrefix': '/를',
  'fabric.editor.longEmptyNodePlaceholderSlash': '입력하여',
  ...
  'fabric.editor.quickinsert.new.lozenge': '신규',
  ...
  'fabric.editor.referenceSyncBlockTooltip': '동기화 출처: {title}',
  ...
  'fabric.editor.requestAccessToSyncedBlock': '액세스 요청',
  'fabric.editor.requestAccessToSyncedBlockError': '문제가 발생했습니다. 다시 시도하려면 클릭하세요.',
  ...
  'fabric.editor.shortEmptyNodePlaceholderSlash': '입력하여',
  'fabric.editor.shortEmptyNodePlaceholderSuffix': '삽입',
  ...
  'fabric.editor.syncBlock.toolbar.newLozenge': '신규',
  'fabric.editor.syncBlockGroup': '동기화 블록 유형',
  'fabric.editor.syncBlockPlaceholderText':
    '콘텐츠를 추가한 후 이 동기화된 블록을 복사하여 여러 스페이스에서 액세스하세요',
  'fabric.editor.syncedBlock': '동기화된 블록 만들기',
  'fabric.editor.syncedBlock.description': '여러 위치 간 콘텐츠 동기화',
  'fabric.editor.syncedBlockGeneralErrorDescription': '이 동기화된 블록을 로드하는 동안 문제가 발생했습니다.',
  'fabric.editor.syncedBlockNotFoundDescription': '이 동기화된 블록을 로드할 수 없습니다.',
  'fabric.editor.syncedBlockNotFoundIconAltText': '동기화된 블록을 찾을 수 없습니다.',
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    '이 동기화된 블록의 소스는 귀하가 액세스할 수 없는 콘텐츠 항목입니다.',
  'fabric.editor.syncedBlockPermissionDeniedHeading': '이 동기화된 블록을 볼 권한이 없습니다',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': '권한이 거부되었습니다.',
