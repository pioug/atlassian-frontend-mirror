...
/**
 * @deprecated The legacy icon "check-circle-outline" is deprecated in favour of "@atlaskit/icon/core/check-circle" and will be removed in an upcoming major release
 * 
