...
-   [#90865](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/90865)
    ...
    This changeset exists because a PR touches these packages in a way that doesn't require a
    release
-   Updated dependencies
...
-   [#80438](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/80438)
    ...
    [ux] Add media viewer previews to inline media and media single images when Editor is in view
    mode
...
-   [#67822](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/67822)
    ...
    [ux] ED-21870 Fix - divider is removed from document when switching between media single to
    image inline
-   Updated dependencies
...
-   [#60678](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/60678)
    ...
    [ED-21042] Synchronously flush state update in Picker Facade Provider to get consistent
    behaviour in React 16 and 18
...
-   [#43145](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/43145)
    ...
    'platform.editor.media.inline-image.base-support' feature flag. With the flag on, Adding an
    image to a non-empty paragraph and list node inserts an media inline node, instead of media
    single node.
-   Updated dependencies
...
-   [#42899](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/42899)
    [`4b3e40bff6f`](https://bitbucket.org/atlassian/atlassian-frontend/commits/4b3e40bff6f) - Added
    a new media plugin state `allowInlineImages` to support upcoming feature development.
