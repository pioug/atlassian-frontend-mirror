...
export default {
  ...
  'fabric.editor.ai.config.item.advancedPrompt.description': '指定任務、指示和規則',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': '創意',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    '例如：1. 從公司目標的簡介文件開始。2. 建立重要團隊成員的列表，以便在第一週見面認識。',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder': '提供任務指示以協助產生特定輸出。',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    '例如：輸出必須遵循公司樣式準則，並且不要使用未經驗證的資料。',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': '規則',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': '概述任何您希望遵循的規則。',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': '請提供任務',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage': '例如：為加入團隊的新員工建立入職文件。',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': '任務',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': '描述需要完成的任務。',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': '語氣',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': '休閒',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': '教學',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': '富有同理心',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': '中性',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': '專業',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': '建立進階提示',
  'fabric.editor.ai.config.item.advancedPrompt.title': '建立進階提示',
