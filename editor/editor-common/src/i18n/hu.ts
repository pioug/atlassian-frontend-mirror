...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Utasítások',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Feladatok, útmutatások és szabályok meghatározása',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Kreativitás',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Magas',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Alacsony',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Közepes',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Példa: 1. Kezdd a dokumentumot egy rövid összefoglalással a vállalati céljainkról. 2. Írj egy listát a kulcsfontosságú csapattagokról, akikkel találkozniuk kell az első héten.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Adj meg utasításokat a feladathoz, amelyek segítenek a kívánt eredmény elérésében.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Példa: A kimenetnek meg kell felelnie a vállalati stílusra vonatkozó irányelveknek, és nem szerepelhet benne ellenőrizetlen adat.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Szabályok',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': 'Foglald össze a betartandó szabályokat.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Add meg a feladatot',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Példa: Betanítási dokumentáció létrehozása a csapathoz csatlakozó új dolgozók számára.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Feladat',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Írd le a végrehajtandó feladatot.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Hangnem',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Barátságos',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Tájékoztató',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Empatikus',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Semleges',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Professzionális',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Speciális utasítás írása',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Speciális utasítás írása',
