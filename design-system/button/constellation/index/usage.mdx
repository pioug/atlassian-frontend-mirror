...
import buttonAlignmentModal from './images/button-alignment-modal.png';
import buttonAlignmentPage from './images/button-alignment-page.png';
...
2. **Label:** Text that explains the result of selecting the button. Use action verbs or phrases to tell the user what will happen next, and follow the [button label content guidelines](/components/button/usage#content-guidelines).
...
This is not accessible. Disabled buttons aren't reachable in the tab order and don't receive hover, focus, or click events.
