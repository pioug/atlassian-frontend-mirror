...
Build your spotlight in Post Office to track and coordinate the experience so you can prevent
message fatigue.

[Learn how to use Post Office. (Atlassians only)](https://go.atlassian.com/use-post-office)
