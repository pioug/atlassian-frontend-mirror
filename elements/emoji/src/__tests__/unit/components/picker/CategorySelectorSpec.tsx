...
import {
	default as EmotionCategorySelector,
	type Props,
	sortCategories,
} from '../../../../components/picker/CategorySelector';
import { default as CompiledCategorySelector } from '../../../../components/compiled/picker/CategorySelector';
...
describe('<CategorySelector /> - compiled', () => {
	const setupComponent = (props?: Props) => renderWithIntl(<CompiledCategorySelector {...props} />);
...
describe('<CategorySelector /> - emotion', () => {
	const setupComponent = (props?: Props) => renderWithIntl(<EmotionCategorySelector {...props} />);
