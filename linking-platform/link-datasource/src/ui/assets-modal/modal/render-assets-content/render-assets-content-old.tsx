...
import {
	EmptyStateOld,
	IssueLikeDataTableViewOld,
	scrollableContainerShadowsCssComponents,
} from '../../../issue-like-table/issue-like-table-old';
...
const LoadingView = () => (
	...
	>
		<EmptyStateOld testId="assets-aql-datasource-modal--loading-state" />
	</div>
);

export const RenderAssetsContentOld = (props: RenderAssetsContentProps) => {
	const {
		status,
		responseItems,
		responseItemIds,
