...
<SectionMessage>
  ...
  You do not need to use this addon for drawing drop indicators! You can use whatever rendering and styling approach you like. This addon just makes drawing lines with `react` + `@emotion/react` easy.
