...
test.describe('List inside a blockquote', () => {
  ...
  test.describe('List in a non-nested blockquote', () => {
    ...
    test(`should insert a bullet list on typing - inside blockquote`, async ({
      editor,
    }) => {
    ...
    test(`should be able to insert nested lists  - inside blockquote`, async ({
      editor,
    }) => {
      await editor.selection.set({ anchor: 2, head: 2 });
      await editor.keyboard.type('- ');
      ...
      await expect(editor).toMatchDocument(
        doc(blockquote(ul(li(p('item 1'), ul(li(p(''))))))),
      );
    });
  ...
  test.describe('List inside a blockquote nested in a table', () => {
    ...
    test(`should insert an ordered list on typing 1.  inside blockquote`, async ({
      editor,
    }) => {
  ...
  test.describe('Media inside list within a blockquote', () => {
    ...
    test(`should be able to add media and remove it (via backspace)`, async ({
      editor,
    }) => {
...
test.describe('quick-insert: numbered list', () => {
  ...
  test('Insert Blockquote in the middle of numbered list', async ({
    editor,
  }) => {
    await editor.selection.set({ anchor: 5, head: 5 });
    await editor.keyboard.type(' ');
  ...
  test('Insert Blockquote in the beginning of numbered list', async ({
    editor,
  }) => {
...
test.describe('quick-insert: nested numbered list', () => {
  ...
  test('Insert Blockquote in the middle of nested numbered list', async ({
    editor,
  }) => {
  ...
  test('Insert Blockquote in the beginning of nested numbered list', async ({
    editor,
  }) => {
  ...
  test('Insert Blockquote in the end of nested numbered list', async ({
    editor,
  }) => {
    await editor.selection.set({ anchor: 16, head: 16 });
    await editor.keyboard.type(' ');
