  ...
  const cases = [
    {
      closestEdge: 'top',
      description:
        'should target the first index when entering from the top of a vertical list',
      destinationIndex: 0,
      direction: 'vertical',
    },
    {
      closestEdge: 'bottom',
      description:
        'should target the last index when entering from the bottom of a vertical list',
      destinationIndex: 2,
      direction: 'vertical',
    },
    {
      closestEdge: 'left',
      description:
        'should target the first index when entering from the left of a horizontal list',
      destinationIndex: 0,
    ...
    },
    {
      closestEdge: 'right',
      description:
        'should target the last index when entering from the right of a horizontal list',
      destinationIndex: 2,
      direction: 'horizontal',
    },
  ] as const;
  ...
  cases.forEach(({ closestEdge, description, destinationIndex, direction }) => {
    it(description, () => {
      ...
      const { getByTestId } = render(
        <List direction={direction} onDragEnd={onDragEnd} />,
      );
