	...
	describe('when columns are merged', () => {
		describe('1st combination of colspans', () => {
			it(`columnIndex: 0`, () => {
				const input = doc(
					table()(
						row(td()(p('{headCell}')), cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
						row(cEmpty, cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
						row(td()(p('{anchorCell}')), cEmpty, cEmpty, cEmpty, td({ colspan: 2 })(p(''))),
					),
				);
			...
			Array.from(Array(4).keys()).forEach((columnIndex) => {
				it(`columnIndex: ${columnIndex + 1}`, () => {
					const input = doc(
						table()(
							row(cEmpty, td({ colspan: 2 })(p('')), cEmpty, td()(p('{headCell}')), cEmpty),
							row(cEmpty, cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
							row(cEmpty, td()(p('{anchorCell}')), cEmpty, td({ colspan: 2 })(p('')), cEmpty),
						),
					);
					const { tr, anchorCell, headCell } = init(input);
			...
			it(`columnIndex: 5`, () => {
				const input = doc(
					table()(
						row(cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty, td()(p('{headCell}'))),
						row(cEmpty, cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
						row(cEmpty, cEmpty, cEmpty, td({ colspan: 2 })(p('')), td()(p('{anchorCell}'))),
					),
				);
				const { tr, anchorCell, headCell } = init(input);
		...
		describe('2nd combination of colspans', () => {
			it(`columnIndex: 0`, () => {
				const input = doc(
					table()(
						row(td()(p('{headCell}')), cEmpty, cEmpty, cEmpty, td({ colspan: 2 })(p(''))),
						row(cEmpty, cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
						row(td()(p('{anchorCell}')), cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
					),
				);
				const { tr, anchorCell, headCell } = init(input);
			...
			Array.from(Array(4).keys()).forEach((columnIndex) => {
				it(`columnIndex: ${columnIndex + 1}`, () => {
					const input = doc(
						table()(
							row(cEmpty, cEmpty, cEmpty, td({ colspan: 2 })(p('{headCell}')), cEmpty),
							row(cEmpty, cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
							row(cEmpty, td({ colspan: 2 })(p('{anchorCell}')), cEmpty, cEmpty, cEmpty),
						),
					);
					const { tr, anchorCell, headCell } = init(input);
			...
			it(`columnIndex: 5`, () => {
				const input = doc(
					table()(
						row(cEmpty, cEmpty, cEmpty, td({ colspan: 2 })(p('')), td()(p('{headCell}'))),
						row(cEmpty, cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty),
						row(cEmpty, td({ colspan: 2 })(p('')), cEmpty, cEmpty, td()(p('{anchorCell}'))),
					),
				);
				const { tr, anchorCell, headCell } = init(input);
	...
	describe('when columns and rows are merged', () => {
		describe('1st combination of colspans and rowspans', () => {
			it(`columnIndex: 0`, () => {
				const input = doc(
					table()(
						row(td()(p('{headCell}')), td({ rowspan: 2 })(p('')), cEmpty, cEmpty, cEmpty),
						row(cEmpty, td({ colspan: 2 })(p('')), cEmpty),
						row(cEmpty, td({ colspan: 2 })(p('')), td({ rowspan: 2 })(p('')), cEmpty),
			...
			Array.from(Array(3).keys()).forEach((columnIndex) => {
				it(`columnIndex: ${columnIndex + 1}`, () => {
					const input = doc(
						table()(
							row(cEmpty, td({ rowspan: 2 })(p('')), cEmpty, td()(p('{headCell}')), cEmpty),
							row(cEmpty, td({ colspan: 2 })(p('')), cEmpty),
							row(cEmpty, td({ colspan: 2 })(p('')), td({ rowspan: 2 })(p('')), cEmpty),
			...
			it(`columnIndex: 4`, () => {
				const input = doc(
					table()(
						row(cEmpty, td({ rowspan: 2 })(p('')), cEmpty, cEmpty, td()(p('{headCell}'))),
						row(cEmpty, td({ colspan: 2 })(p('')), cEmpty),
						row(cEmpty, td({ colspan: 2 })(p('')), td({ rowspan: 2 })(p('')), cEmpty),
		...
		describe('2st combination of colspans and rowspans', () => {
			it(`columnIndex: 0`, () => {
				const input = doc(
					table()(
						row(td()(p('{headCell}')), cEmpty, cEmpty, td({ rowspan: 2 })(p('')), cEmpty),
						row(cEmpty, td({ colspan: 2 })(p('')), cEmpty),
						row(cEmpty, td({ rowspan: 2 })(p('')), td({ colspan: 2 })(p('')), cEmpty),
						row(td()(p('{anchorCell}')), cEmpty, cEmpty, cEmpty),
					),
				);
				const { tr, anchorCell, headCell } = init(input);
			...
			Array.from(Array(3).keys()).forEach((columnIndex) => {
				it(`columnIndex: ${columnIndex + 1}`, () => {
					const input = doc(
						table()(
							row(cEmpty, cEmpty, cEmpty, td({ rowspan: 2 })(p('{headCell}')), cEmpty),
							row(cEmpty, td({ colspan: 2 })(p('')), cEmpty),
							row(cEmpty, td({ rowspan: 2 })(p('{anchorCell}')), td({ colspan: 2 })(p('')), cEmpty),
			...
			it(`columnIndex: 4`, () => {
				const input = doc(
					table()(
						row(cEmpty, cEmpty, td({ rowspan: 2 })(p('')), cEmpty, td()(p('{headCell}'))),
						row(cEmpty, td({ colspan: 2 })(p('')), cEmpty),
						row(cEmpty, td({ rowspan: 2 })(p('')), td({ colspan: 2 })(p('')), cEmpty),
						row(cEmpty, cEmpty, cEmpty, td()(p('{anchorCell}'))),
					),
