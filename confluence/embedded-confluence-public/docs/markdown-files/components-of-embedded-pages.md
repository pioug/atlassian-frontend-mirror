...
| `isHeightSetFromContent ` | `boolean`                                                                                                                        | **(Optional)** If provided, the height of the view component will be set to the height of the confluence content being rendered. If you want to ensure scrolling within the embed works as expected (i.e. a table of contents macro is present), please reference scrollToHashHandler below.                                                                                                                                                         |
|                           |
...
| `iframeRef`               | `React.Ref<HTMLIFrameElement>`                                                                                                   | **(Optional)** Ref to the underlying iframe (object or callback ref).                                                                                                                                                                                                                                                                                                                                                                                |
| `onLoad`                  | `React.ReactEventHandler<HTMLIFrameElement>`                                                                                     | **(Optional)** Called when the iframe loads; invoked after internal load handling.                                                                                                                                                                                                                                                                                                                                                                   |
| `onMouseEnter`            | `React.MouseEventHandler<HTMLIFrameElement>`                                                                                     | **(Optional)** Mouse enter handler passed through to the iframe.                                                                                                                                                                                                                                                                                                                                                                                     |
| `onMouseLeave`            | `React.MouseEventHandler<HTMLIFrameElement>`                                                                                     | **(Optional)** Mouse leave handler passed through to the iframe.                                                                                                                                                                                                                                                                                                                                                                                     |
| `sandbox`                 | `string`                                                                                                                         | **(Optional)** Sets the iframe `sandbox` attribute (e.g. `allow-scripts allow-same-origin`).                                                                                                                                                                                                                                                                                                                                                         |
| `scrollToHashHandler`     | `Function`, see [definition](#scrolltohashhandler-definition)                                                                    | **(Optional)** Custom parent scroll handler used for in-page hash navigation when `isHeightSetFromContent` is true. If not provided, embedded Confluence will default to `window.scrollTo`.                                                                                                                                                                                                                                                          |
