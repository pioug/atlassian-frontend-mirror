...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-size-small').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-size-medium').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-size-large').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-size-xlarge').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-theme-link').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-theme-black').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-hide-background').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-hide-elevation').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-hide-padding').default}
...
${(
	<CustomExample
		background={true}
		Component={require('../../../examples/content/ui-options-clickable-container').default}
