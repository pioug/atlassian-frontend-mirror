...
describe('Object Result', () => {
	...
	it('should render the `containerName` prop if no objectKey provided', () => {
		...
		expect(resultWrapper.text()).toEqual(expect.stringContaining('Burger Sling'));

		expect(resultWrapper.text()).not.toEqual(expect.stringContaining('· Burger Sling'));
	});
	...
	it('should render the `objectKey` and `containerName` prop together', () => {
		...
		expect(resultWrapper.text()).toEqual(expect.stringContaining('KFC-11 · Burger Sling'));
	});
});
