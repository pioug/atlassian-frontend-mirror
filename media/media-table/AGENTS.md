...
`.agents/knowledge-index/domains/media/units/atlaskit-media-table.md` **Standards page:**
`.agents/knowledge-index/domains/media/units/atlaskit-media-table/standards-and-patterns.md`
**CLI:**
