export const getTokenUsageGuidelines = (
	...
	return { usage: '', cssProperties: [] }; // Fallback if tokenId doesn't match any token type
};

const usageMappings: Record<TokenCategory, { usage: string; cssProperties: string[] }> = {
	'color.text': {
		usage:
	...
	'font.lineHeight': {
		usage:
			'Granular control of font line height (e.g. font.lineHeight.100). Use only when overriding the default in composites',
