...
- Write button text that clearly explains what will happen next in the flow.
- If the illustration provides useful information, include alternative text. If it's only for decoration, avoid alt text to save time for people using assistive technology, like screen readers.
