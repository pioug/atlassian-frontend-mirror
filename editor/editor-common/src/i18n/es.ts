...
export default {
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Por ejemplo: 1. Empieza el documento con una breve descripción de los objetivos de nuestra empresa. 2. Crea una lista de los miembros clave del equipo que se reúnan en su primera semana.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Proporcionar instrucciones de tareas para ayudar a generar resultados específicos.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Por ejemplo: la salida debe seguir las normas de estilo de la empresa y no utilizar datos no verificados.',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Por ejemplo: crea una documentación de incorporación para los nuevos empleados que se unan al equipo.',
