...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': '指示',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'タスク、指示、ルールを指定します',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': '創造性',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': '高',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': '低',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': '中',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    '例: 1. ドキュメントの冒頭で、当社の目標を概説します。2. 入社 1 週目に会う主要なチーム メンバーのリストを作成します。',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    '特定のアウトプットを生成するためのタスク指示を提供してください。',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    '例: アウトプットは会社のスタイル ガイドラインに準拠したものにしてください。未検証のデータは使用しないでください。',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'ルール',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': '守ってもらいたいルールを説明します。',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'タスクを入力してください',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    '例: チームに参加する新入社員のためのオンボーディング ドキュメントを作成してください。',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'タスク',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': '完了する必要があるタスクについて説明します。',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'トーン',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'カジュアル',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': '教育的',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': '共感的',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': '中立的',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'プロフェッショナル',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': '高度なプロンプトを作成',
  'fabric.editor.ai.config.item.advancedPrompt.title': '高度なプロンプトを作成',
