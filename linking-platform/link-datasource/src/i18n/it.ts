...
export default {
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Controlla la tua connessione e aggiorna la schermata, oppure <a>apri questo spazio Jira in Confluence</a> per esaminarlo.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Connetti il tuo account {providerName} per collaborare al lavoro nelle app Atlassian.',
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    "Attendi qualche minuto e riprova. Se il problema persiste, controlla le impostazioni dello spazio o contatta l'assistenza.",
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Controlla la tua connessione e aggiorna la schermata, oppure <a>apri questo spazio in Jira</a> per esaminarlo.',
