...
**Unit doc:** `.agents/knowledge-index/domains/media/units/atlaskit-media-picker.md`
...
- 3 feature flags: `platform_media_package_react19_lifecycle_fix`, `platform_media_picker_upload_batching`, `should-render-to-parent-should-be-true-media-exif`
- Export subpaths: `.`, `./browser`, `./clipboard`, `./components/types`, `./dropzone`, `./plugin`, `./preview`, `./types`
