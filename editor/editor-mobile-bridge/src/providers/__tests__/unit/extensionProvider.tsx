...
import { type ExtensionProvider, type ExtensionManifest } from '@atlaskit/editor-common/extensions';
...
describe('createExtensionProvider', () => {
	...
	it('should return empty provider when enableConfluenceMobileMacros is false', () => {
		return createExtensionProvider(
			...
			.then((extensionProvider: ExtensionProvider) => extensionProvider.getExtensions())
