...
| Drag and drop framework                                       | Atlassian drag and drop<br/>(element adapter) | React Beautiful DnD             | React DnD<br/>(+ `react-dnd-html5-backend`) | DnD kit<br/>(+ `@dnd-kit/modifiers` + `@dnd-kit/sortable`) | Draggable (Shopify) |
| ---------------------------------------------------- | ----------------------------------------------- | --------------------------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------- | -------------------- |
