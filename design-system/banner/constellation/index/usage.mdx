...
functionality, or important site-wide information that affects the user's ability to use the
product.
...
2. **Message**: A short description of the severity of the issue, products affected, and any actions
...
- In [error messages](https://atlassian.design/content/writing-guidelines/writing-error-messages) admit when the problem is ours by using *we* instead of *you*. Using *you* can make the person feel like they’re responsible – for example, "We've lost the connection" is friendlier than "Something's wrong with your connection."
