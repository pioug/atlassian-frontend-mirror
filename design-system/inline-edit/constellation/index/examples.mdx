...
Inline edit is a wrapper around a custom input component such as a [text field](/components/textfield/). It starts in a read-only view called `readView` and people can activate the field to edit it.
