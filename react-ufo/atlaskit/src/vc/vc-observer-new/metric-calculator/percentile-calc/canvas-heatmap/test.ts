...
describe('calculatePercentiles', () => {
	it('should correctly calculate percentiles with accumulated elements from timestamps', () => {
		...
		const result = calculatePercentiles(timePixelCounts, elementMap, percentiles, 50, 0);
	...
	it('should handle empty entries gracefully', () => {
		...
		const result = calculatePercentiles(timePixelCounts, elementMap, percentiles, 100, 0);
		expect(result).toEqual(expected);
	});
	...
	it('should correctly calculate percentiles with startTime offset', () => {
		...
		const result = calculatePercentiles(timePixelCounts, elementMap, percentiles, 50, 50);
		expect(result).toEqual(expected);
	});
});
