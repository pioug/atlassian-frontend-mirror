...
<SectionMessage appearance="discovery">
	Tag group's appearance follows the <a href="/components/tag">tag</a> component. When the{' '}
	<strong>platform-dst-lozenge-tag-badge-visual-uplifts</strong> feature flag is enabled, tag group
