...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Istruzioni',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Specifica il compito, le istruzioni e le regole',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Creatività',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Alta',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Bassa',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Media',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Esempio: 1. Inizia il documento con una breve panoramica degli obiettivi della nostra azienda. 2. Crea un elenco dei membri del team da incontrare nel corso della prima settimana.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Fornisci le istruzioni sul compito per contribuire a generare risultati specifici.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    "Ad esempio, l'output deve rispettare la guida di stile dell'azienda e non utilizzare dati non verificati.",
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Regole',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Indica tutte le regole che desideri siano rispettate.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Specifica il compito',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Ad esempio, crea la documentazione di onboarding per i nuovi dipendenti che entrano a far parte del team.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Compito',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder':
    'Descrivi il compito che deve essere completato.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Tono',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Informale',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Istruttivo',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Empatico',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Neutro',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Professionale',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Crea una richiesta avanzata',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Crea una richiesta avanzata',
