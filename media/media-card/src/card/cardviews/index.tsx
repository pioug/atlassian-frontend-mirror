		...
		switch (status) {
			case 'uploading':
				if (cardPreview) {
					...
					return <IconCardView status={status} progress={progress} {...baseProps} />;
				}
			case 'processing':
				if (cardPreview) {
					return (
						<React.Fragment>
							...
							<div style={{ display: didImageRender ? 'none' : 'inline' }}>
								<ProcessingCardView disableAnimation={disableAnimation} {...baseProps} />
							</div>
						</React.Fragment>
					);
				} else {
					return <ProcessingCardView disableAnimation={disableAnimation} {...baseProps} />;
				}
			case 'complete':
				if (cardPreview) {
					return (
			...
			case 'failed-processing':
				return <ErrorCardView disableAnimation={disableAnimation} error={error} {...baseProps} />;
				...
				if (cardPreview) {
					return (
						<React.Fragment>
							...
							<div style={{ display: didImageRender ? 'none' : 'inline' }}>
								<LoadingCardView {...baseProps} disableAnimation={disableAnimation} />
							</div>
						</React.Fragment>
					);
				} else {
					return <LoadingCardView {...baseProps} disableAnimation={disableAnimation} />;
				}
		}
	};
