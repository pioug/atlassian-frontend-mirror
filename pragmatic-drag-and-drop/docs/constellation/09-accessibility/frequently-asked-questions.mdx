...
- The pattern does not support scrolling a scroll container (or the window) to make room for a draggable wanting to move on the cross axis.

_These limitations exist because it is super complex to get the `react-beautiful-dnd` keyboard pattern working in all cases (even for lists and lists of lists)_
