...
export default {
  ...
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchTitleOld': '搜索对象',
  ...
  'linkDataSource.jira-issues.accessRequiredWithSiteOld': '您无权访问以下站点：',
  ...
  'linkDataSource.jira-issues.configmodal.chooseSiteOld': '选择站点',
  ...
  'linkDataSource.jira-issues.noResultsFoundOld': '未找到结果',
  ...
  'linkDataSource.jira-issues.unableToLoadResults.visual-refresh-sllv': '在尝试获取结果时遇到问题',
  'linkDataSource.jira-issues.unableToLoadResultsOld': '无法加载结果',
