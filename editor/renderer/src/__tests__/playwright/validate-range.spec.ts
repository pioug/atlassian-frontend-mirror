...
test.describe('validate-range: paragraphsWithMedia', () => {
	...
	test(`A selection containing text and media validates false`, async ({ renderer }) => {
...
test.describe('validate-range: paragraphWithInlineNodes', () => {
	...
	test(`A selection containing text and mention validates false`, async ({ renderer }) => {
		const paragraphs = renderer.page.locator(PARAGRAPH);
	...
	test(`A selection containing text and emoji validates false`, async ({ renderer }) => {
		const paragraphs = renderer.page.locator(PARAGRAPH);
	...
	test(`A selection containing text and status validates false`, async ({ renderer }) => {
		const paragraphs = renderer.page.locator(PARAGRAPH);
	...
	test(`A full line selection with inline nodes validates false`, async ({ renderer }) => {
		const paragraphs = renderer.page.locator(PARAGRAPH);
...
test.describe('validate-range: paragraphWithoutInlineNodes', () => {
	...
	test(`A full line selection without inline nodes validates true`, async ({ renderer }) => {
		const paragraphs = renderer.page.locator(PARAGRAPH);
