...
export default {
  ...
  'fabric.linking.connect_unauthorised_account_description-appify':
    'Anslut ditt {context}-konto för att samarbeta i flera Atlassian-appar.',
  ...
  'fabric.linking.connect_unauthorised_account_description_no_provider-appify':
    'Anslut ditt konto för att samarbeta i flera Atlassian-appar.',
  ...
  'fabric.linking.follow_project_error-galaxia':
    'Ett fel uppstod när vi försökte följa utrymmet. Kontrollera din anslutning eller uppdatera sidan och försök igen.',
  ...
  'fabric.linking.learn_more_about_connecting_account-appify':
    'Ta reda på mer om att ansluta ditt konto till Atlassian-appar.',
  ...
  'fabric.linking.unfollow_project_error-galaxia':
    'Ett fel uppstod när vi försökte sluta följa utrymmet. Kontrollera din anslutning eller uppdatera sidan och försök igen.',
