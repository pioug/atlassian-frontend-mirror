...
- [Show what is draggable](#show-what-is-draggable)
- [Use previews and drop indicators during dragging](#use-clear-previews-and-drop-indicators-during-dragging)
  - [Multiple item drag previews](#multiple-item-drag-previews)
- [Show the item in its new location](#show-the-item-in-its-new-position)
- [Provide keyboard-accessible ways to move items](#provide-accessible-controls)
- [Follow examples and specs for cards, lists, and trees](#examples-of-multi-item-select-drag-and-drop)
...
For best performance, implement with [native drag previews](./adapters/element-adapter/drag-previews), or use the [Figma kit (Atlassian only)](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=38-5065&mode=design>) in designs.
...
To achieve this, use the [react drop indicator](./optional-packages/react-drop-indicator) in code or the [Figma kit indicator](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=38-5065&mode=desig>) in designs.
...
Implement this using [flourish](./optional-packages/flourish) in code or show the color in the [Figma kit](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=38-5065&mode=design>) for designs.
...
For more details, view [the full accessibility guide and examples](/pragmatic-drag-and-drop/accessibility/).
...
Use the [drag handle menu component](./optional-packages/react-accessibility) in code or the [Figma kit drag handle menu](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=38-2098&mode=design>) in designs.
...
| Hover cursor                   | `cursor:grab`                                                                                  | [Cursor:grab](./design-guidelines)                                                                                                                                                | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drag cursors                   | Reverts to pointer (browser limitation)                                                        | [Cursor](./design-guidelines)                                                                                                                                                     | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drag handle icon               | `color.icon.default` (or other icon token with typical hover interaction colors on background) | [Drag handle](./optional-packages/react-accessibility) or [Drag handle menu](/components/pragmatic-drag-and-drop/packages/react-accessibility/drag-handle-dropdown-menu/examples) | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drag preview                   | >`280px` to avoid transparency issue                                                           | [Native drag preview](./adapters/element/drag-previews)                                                                                                                           | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drop indicator stroke          | `2px`                                                                                          | [React drop indicator](./optional-packages/react-drop-indicator)                                                                                                                  | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drop indicator color           | `color.border.selected` or `#0c66e4`                                                           | [React drop indicator](./optional-packages/react-drop-indicator)                                                                                                                  | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drop indicator terminal circle | `8px diameter`                                                                                 | [React drop indicator](./optional-packages/react-drop-indicator)                                                                                                                  | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
| Drop flourish color change     | `color.background.selected`                                                                    | [Flourish](./optional-packages/flourish)                                                                                                                                          | [DND library](<https://www.figma.com/file/3E3rGPX4YHlVUP3cNyRykB/Pragmatic-Drag-%26-Drop-UI-Kit-(PDND)?type=design&node-id=0%3A1&mode=design&t=4UwHqNt2ffApWviO-1>) |
...
- [Drag and drop accessibility guide](/pragmatic-drag-and-drop/accessibility/)]
