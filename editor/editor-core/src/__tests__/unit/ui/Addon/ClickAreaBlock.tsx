...
describe('ClickAreaBlock', () => {
	...
	beforeEach(() => {
		clickAreaClickHandlerMock = jest.spyOn(ClickAreaHelper, 'clickAreaClickHandler');
	...
	it('should invoke clickAreaClickHandler when clicked', () => {
		...
		expect(clickAreaClickHandlerMock).toHaveBeenCalledWith(editorView, expect.any(Object));
	});
