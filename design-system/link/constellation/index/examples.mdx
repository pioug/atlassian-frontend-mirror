...
import Inverse from '../../examples/constellation/link-inverse';
...
<SectionMessage
	...
	actions={[
		<SectionMessageAction href="/components/primitives/anchor/examples">
...
>
	...
	the <Link href="/components/primitives/anchor/examples">anchor primitive</Link>.
</SectionMessage>
...
<Example
	...
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={FontStyleInheritance}
	packageName="@atlaskit/link"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
