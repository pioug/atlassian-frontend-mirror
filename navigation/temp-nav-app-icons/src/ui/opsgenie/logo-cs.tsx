 ...
 * @codegen <<SignedSource::ee7561acf88534c9d42e29f104aaf7cb>>
...
const svg = `<svg height="100%" viewBox="0 0 164 32">
    <g clip-path="url(#clip0_95164_15759)">
        ...
        <g clip-path="url(#clip1_95164_15759)">
    ...
    <defs>
        <clipPath id="clip0_95164_15759">
            <path fill="var(--icon-color, white)" d="M0 0h164v32H0z"/>
        </clipPath>
        <clipPath id="clip1_95164_15759">
            <path fill="var(--icon-color, white)" d="M7.333 5.979h17.532v20.042H7.333z"/>
        </clipPath>
    </defs>
</svg>
`;
