 ...
 * @codegen <<SignedSource::73b5602fb91256476ddef5be6fd0f436>>
...
const svg = `<svg width="68" height="24" fill="none" viewBox="0 0 68 24">
 ...
 */
export function LoomInternalLogo({ label, testId }: AppLogoProps) {
