...
import { dropTargetForFiles } from '@atlaskit/pragmatic-drag-and-drop/adapter/files';
...
import { dropTargetForElements } from '@atlaskit/pragmatic-drag-and-drop/adapter/elements';
...
- During a drag operation:
  ...
  - You can _remount_ a _drop targets_ (see [reconciliation](/components/pragmatic-drag-and-drop/how-it-works/reconciliation))
...
- [Visual affordances for drop targets](/components/pragmatic-drag-and-drop/design-guidelines/visual-affordances#moving-items-between-drop-targets)
