...
const useJqlErrorMock = jest.fn<HookFunction<JQLParseError | null>, []>(() => [null, {}]);
const useExternalMessagesMock = jest.fn<HookFunction<ExternalMessagesNormalized>, []>(() => [
	normalizedExternalMessagesEmpty,
	{},
]);
const useEditorStateHasJqlErrorMock = jest.fn<HookFunction<boolean>, []>(() => [false, {}]);
