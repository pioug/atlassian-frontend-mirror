...
describe('RendererActions matches', () => {
	describe('#getIndexMatch', () => {
		describe('textContent', () => {
			...
			>([
				...
				['line break', doc(p('Gingerbread'), p('Marshmallow')), 'GingerbreadMarshmallow'],
				['hard break', doc(p('Tiramisu', hardBreak(), 'Marzipan')), 'TiramisuMarzipan'],
				[
	...
	describe('#countMatches', () => {
		test.each<[string, string, string, number]>([
			...
			['links with parameters', 'https://www.google.com/results?page=1', 'results?page=1', 1],
