...
<DoDontGrid>
	...
	>
		Align buttons on the right in the footer. <br /> <br /> If you have more than 1 button, place
	...
	>
		...
		expected flow of actions. <br /> <br /> Don't put primary buttons to the left of secondary or
		tertiary buttons.
	</DoDont>
</DoDontGrid>
...
<DoDontGrid>
	...
	>
		Don’t use a modal dialog for complex interactions or large tables. <br /> <br /> Avoid
...
- To onboard or update people about new functionality, use custom modal dialog or
  [spotlight](/components/spotlight) pattern.
