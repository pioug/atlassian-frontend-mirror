...
export default {
  ...
  'fabric.elements.share.to.slack.back.button': 'Tilbage',
  'fabric.elements.share.to.slack.button': 'Del med Slack',
  'fabric.elements.share.to.slack.channel-picker.validation.required':
    'Vælg en person eller kanal.',
  ...
  'fabric.elements.slack.success.message': 'Delt med {slackEntity}',
};
