...
import { createCardClient, createEmojiProvider, createMentionProvider } from '../src/providers';
				...
				<div css={toolbar}>
					<div css={clipboardZone}>
						...
						<TextArea
							...
							isCompact
							resize="smart"
							ref={(ref: HTMLTextAreaElement | null) => (this.textAreaRef = ref)}
						/>
						<button css={copyWrapper} aria-label="copy" onClick={this.copyToClipboard}>
