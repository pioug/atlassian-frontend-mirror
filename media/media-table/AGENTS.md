...
`MediaTable` (default export), `MediaTableProps`, `MediaTableItem`, `SortOrderType`, `NameCell`, `NameCellProps`

## Development notes

- React Compiler is enabled for this package
- Internal dependencies: `@atlaskit/media-client`, `@atlaskit/media-client-react`, `@atlaskit/media-ui`, `@atlaskit/media-viewer`
