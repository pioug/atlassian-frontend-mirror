...
export default {
  'feedback-collector.can-be-contacted.label':
    'Společnost Atlassian mě může ohledně této zpětné vazby kontaktovat',
  'feedback-collector.cancel-button.label': 'Zrušit',
  'feedback-collector.enrol-in-research.label':
    'Chci se zúčastnit produktového průzkumu',
  ...
  'feedback-collector.form.suggestion.label':
    'Dejte nám vědět, co byste chtěli zlepšit',
  ...
  'feedback-collector.success-flag.description':
    'Vaše cenná zpětná vazba nám pomáhá neustále zlepšovat naše produkty.',
