 ...
 * @codegen <<SignedSource::55992cbc01ae561200fd2d1d263666ac>>
 ...
 */
export function AdminLogo({ label, testId }: AppLogoProps) {
	return <LogoWrapper svg={svg} label={label || 'Admin'} testId={testId} />;
}
