...
import { appearanceControl, controls, kitchenSinkControl } from './kitchen-sink-styles';
...
export const KitchenSinkControls = React.memo((props: KitchenSinkControlsProps) => {
	const {
		adfEnabled,
		editorEnabled,
		errorsEnabled,
