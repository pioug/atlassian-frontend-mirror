import { disableAllAnimations, getExampleUrl } from '@atlaskit/visual-regression/helper';

function getURL(): string {
	return getExampleUrl('media', 'media-card', 'Test-VR-SSR-cases', global.__BASEURL__);
}
