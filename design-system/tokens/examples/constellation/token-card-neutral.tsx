...
const neutralStyles = {
	bold: {
		...
		hoverBackgroundColor: token('color.background.neutral.bold.hovered', '#2C3E5D'),
		activeBackgroundColor: token('color.background.neutral.bold.pressed', '#172B4D'),
	...
	default: {
		...
		border: `1px solid ${token('color.border', '#091E4224')}`,
		hoverBackgroundColor: token('color.background.neutral.hovered', '#091E4224'),
		activeBackgroundColor: token('color.background.neutral.pressed', '#091E424F'),
	...
	subtle: {
		...
		border: `1px solid ${token('color.border', '#091E4224')}`,
		hoverBackgroundColor: token('color.background.neutral.subtle.hovered', '#091E420F'),
		activeBackgroundColor: token('color.background.neutral.subtle.pressed', '#091E4224'),
		iconColor: token('color.icon', '#44546F'),
	},
};
