						...
						members: [
							...
							},
							{
								...
								trailingComments: [
									{
										type: 'commentBlock',
										value: 'The title text for the dialog. The default is _Upload an avatar_.',
							...
							},
							{
								...
								trailingComments: [
									{
										type: 'commentBlock',
										value: 'This optional property is used while the avatar is loaded.',
							...
							},
							{
								...
								trailingComments: [
									{
										type: 'commentBlock',
										value: 'This property decribe the text related to the Avatar.',
