...
const ExampleComment = ({ children, shouldRenderNestedCommentsInline }: ExampleCommentProps) => (
	<Comment
		...
		<div data-testid="comment">
			<p>
				<label htmlFor="checkbox">
					...
					/>{' '}
					Apply <Code>shouldRenderNestedCommentsInline</Code> to the 2nd and 4th comments
				</label>
			</p>
			<div>
				<ExampleComment>
