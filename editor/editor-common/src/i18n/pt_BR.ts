...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Instruções',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Especifique tarefas, instruções e regras',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Criatividade',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Alta',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Baixa',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Média',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Por exemplo: 1. Comece o documento com uma breve visão geral das metas da empresa. 2. Crie uma lista de membros importantes da equipe para encontrar na primeira semana.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Dê instruções sobre a tarefa para ajudar a gerar resultados específicos.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Por exemplo: o resultado deve seguir as diretrizes de estilo da empresa e não usar dados não verificados.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Regras',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': 'Descreva as regras que devem ser seguidas.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Informe a tarefa',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Por exemplo: crie uma documentação de integração para novos funcionários da equipe.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Tarefa',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Descreva a tarefa que precisa ser concluída.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Tom',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Profissional',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Crie um prompt avançado',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Crie um prompt avançado',
