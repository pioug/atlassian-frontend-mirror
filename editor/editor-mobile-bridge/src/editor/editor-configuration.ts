...
export default class MobileEditorConfiguration implements EditorConfigurationProvider {
	...
	update(editorConfig: string) {
		...
		this.enableQuickInsert =
			config.enableQuickInsert !== undefined ? config.enableQuickInsert : this.enableQuickInsert;
		...
		this.allowCollabProvider =
			config.allowCollabProvider !== undefined
				...
				: this.allowCollabProvider;
		this.placeholder = config.placeholder !== undefined ? config.placeholder : this.placeholder;
		this.allowCustomPanel =
			config.allowCustomPanel !== undefined ? config.allowCustomPanel : this.allowCustomPanel;
