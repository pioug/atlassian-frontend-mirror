...
describe('getIdentifierCollection', () => {
	...
	it('should use identifier collection if its present', () => {
		...
		expect(getIdentifierCollection(identifier, defaultCollection)).toEqual('some-collection');
	});
	...
	it('should default to given collection name if identifier.collection name is not defined', () => {
		...
		expect(getIdentifierCollection(identifier, defaultCollection)).toEqual(defaultCollection);
	});
	...
	it('should return undefined for external images', () => {
		...
		expect(getIdentifierCollection(identifier, defaultCollection)).toBeUndefined();
	});
});
