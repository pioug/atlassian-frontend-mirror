...
import SpotlightPulseFalse from '../../examples/constellation/spotlight-pulse-false';
...
<Example
	Component={SpotlightBlanketIsTinted}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightActionsAppearance}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightActionsBefore}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
[usage tab](/components/onboarding/usage).
...
<Example
	Component={SpotlightHeadingAfterElement}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightDialogPlacement}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightDialogWidth}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightTargetRadius}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightTargetBackground}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightTargetReplacement}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightConditionalTargets}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
