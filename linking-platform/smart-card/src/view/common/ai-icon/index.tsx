...
const AiIcon = (props: SVGProps) => {
	const iconColor = getBooleanFF('platform.linking-platform.smart-card.hover-card-action-redesign')
		? token('color.icon', '#44546F')
		: token('color.icon.accent.blue', B200);
	const textColor = getBooleanFF('platform.linking-platform.smart-card.hover-card-action-redesign')
		? token('color.icon', '#44546F')
		: token('color.text.accent.blue', B400);
	...
	return (
        ...
        elements. So let's define them first. */}
			<defs>
				...
				>
					<stop offset="0.270833" stopColor={iconColor} color={iconColor} />
					<stop offset="1" stopColor={textColor} color={textColor} />
				</linearGradient>
				<linearGradient
					id="ai_icon_lg1"
					x1="12.5"
					...
					gradientUnits="userSpaceOnUse"
				>
					<stop offset="0.1875" stopColor={iconColor} color={iconColor} />
					<stop offset="1" stopColor={textColor} color={textColor} />
				</linearGradient>
				<linearGradient
					id="ai_icon_lg2"
					...
					gradientUnits="userSpaceOnUse"
				>
					<stop stopColor={textColor} color={textColor} />
					<stop offset="0.791667" stopColor={iconColor} color={iconColor} />
				</linearGradient>
				<linearGradient
					id="ai_icon_lg3"
					x1="12.5"
				...
				>
					<stop stopColor={textColor} color={textColor} />
					<stop offset="0.802083" stopColor={iconColor} color={iconColor} />
				</linearGradient>
			</defs>
			<g>
				<path
