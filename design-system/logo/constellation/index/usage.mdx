...
<SectionMessage appearance="information">
	If you need to use these logos outside of product, you can{' '}
...
Lockups include both the logomark and product name. These are used in signup and login.

![logomarks](images/logo-lockup.png)

#### Logomark

Logomark doesn’t include the product name. Only use logomarks on their own when the context is very
...
Make sure product or brand name is always included as alternative text when you use a logo lockup or
logomark.
