...
const overflowMenuTriggerSelector = '[data-testid="within-modal--overflow-menu--trigger"]';
...
describe.skip('avatar group within-modal snapshots', () => {
	it('should match the snapshot of the avatar group within a modal', async () => {
		...
		const url = getExampleUrl('design-system', 'avatar-group', 'within-modal', __BASEURL__);
