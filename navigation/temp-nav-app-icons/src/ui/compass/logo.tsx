 ...
 * @codegen <<SignedSource::9a2afaaa2e1d6067f90b9e279655ffaa>>
 ...
 */
export function CompassLogo({ label, testId }: AppLogoProps) {
	return <LogoWrapper svg={svg} label={label || 'Compass'} testId={testId} />;
}
