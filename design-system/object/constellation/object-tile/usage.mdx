...
Use them to highlight <a href="/components/object/examples">objects</a> in a layout, such as next to
a group of text. To represent standard icons in a tile, use
...
the <a href="/components/object/examples">object</a> component.
...
<a href="/components/object/examples">Object</a>. Do not scale down object tile below 20px.
