	...
	internalCreators.terminalClause(
		...
		internalCreators.listOperand(
			[
				...
				internalCreators.valueOperand('Cannot Reproduce', '"Cannot Reproduce"', [26, 44]),
			],
			[14, 45],
		),
		[],
	...
	internalCreators.terminalClause(
		...
		[
			internalCreators.predicate(
				internalCreators.predicateOperator(PREDICATE_OPERATOR_FROM, 'from', [15, 19]),
				internalCreators.valueOperand('To do', '"To do"', [20, 27]),
				[15, 27],
			),
			internalCreators.predicate(
				internalCreators.predicateOperator(PREDICATE_OPERATOR_TO, 'to', [28, 30]),
				internalCreators.valueOperand('In progress', '"In progress"', [31, 44]),
				[28, 44],
			),
			internalCreators.predicate(
				internalCreators.predicateOperator(PREDICATE_OPERATOR_AFTER, 'after', [45, 50]),
...
export const jqlWasClauseQuery = internalCreators.query(
	internalCreators.terminalClause(
		...
		[
			internalCreators.predicate(
				internalCreators.predicateOperator(PREDICATE_OPERATOR_DURING, 'during', [19, 25]),
				internalCreators.listOperand(
					[
	...
	internalCreators.compoundClause(
		...
		[
			...
			internalCreators.terminalClause(
				...
				[
					internalCreators.predicate(
						internalCreators.predicateOperator(PREDICATE_OPERATOR_AFTER, 'aFtEr', [72, 77]),
...
export const jqlQuotedStringsQuery = internalCreators.query(
	internalCreators.terminalClause(
		...
		internalCreators.listOperand(
			[
				internalCreators.valueOperand("Value with 'spaces'", "'Value with \\'spaces\\''", [23, 46]),
				internalCreators.functionOperand(
					internalCreators.functionString('quotedFunction', '"quotedFunction"', [48, 64]),
	...
	internalCreators.orderBy(
		[
			internalCreators.orderByField(
				internalCreators.field('Another quoted', '"Another quoted"', [], [88, 104]),
