...
import type { MountProps } from '@atlaskit/renderer/examples/helper/testing-setup';
...
BrowserTestCase(
  ...
  // TODO: Re-skipped all, need to unskip again after fixing: https://product-fabric.atlassian.net/browse/ED-16306
