...
export default {
  ...
  'focused-task-close-account.deactivate-account.overview.paragraph.loseAccess.admin':
    '{fullName} さんはアトラシアンのすべてのアカウント サービスへの<b>アクセス権限を直ちに失います</b>。現在アクセス権限のあるサービス:',
  'focused-task-close-account.deactivate-account.overview.paragraph.loseAccess.admin.noSites':
    '{fullName} さんはアトラシアンのすべてのアカウント サービスへの<b>アクセス権限を直ちに失います</b>。現在、コミュニティや Marketplace などのサービスを除いて、アクセス権限はありません。',
  ...
  'focused-task-close-account.delete-account.overview.inline-dialog.data-apps.self':
    'あなた、または他のユーザーがアトラシアン製品に機能を追加するアプリケーションをインストールしている可能性があります。これらのアプリはプロファイル情報を保存している可能性があります。',
  ...
  'focused-task-close-account.delete-account.overview.paragraph.loseAccess.self':
    'アトラシアンのすべてのアカウント サービスへの<b>アクセス権限を直ちに失います</b>。 現在アクセス権限のあるサービス:',
  'focused-task-close-account.delete-account.overview.paragraph.loseAccess.self.noSites':
    'アトラシアンのすべてのアカウント サービスへの<b>アクセス権限を直ちに失います</b>。現在、コミュニティや Marketplace などのサービスを除いて、アクセス権限はありません。',
