...
export default md`
  ${(
		<>
			<p>
				Dynamic tables give users the ability to add content to a table without refreshing the page.
				It comes with pagination, sorting, and re-ordering functionality. Dynamic table can be both
