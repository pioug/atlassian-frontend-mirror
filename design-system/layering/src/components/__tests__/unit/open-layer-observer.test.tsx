...
import {
	...
	useOpenLayerObserverBehindFG,
} from '../../open-layer-observer/use-open-layer-observer';
...
ffTest.on('platform_dst_open_layer_observer_close_layers', 'OpenLayerObserver', () => {
	it('useOpenLayerObserverBehindFG should return null when flag is enabled and there is no layer observer', () => {
		const { result } = renderHook(useOpenLayerObserverBehindFG);
...
ffTest.off('platform_dst_open_layer_observer_close_layers', 'OpenLayerObserver', () => {
	it('useOpenLayerObserverBehindFG should return null when flag is disabled', () => {
		const { result } = renderHook(useOpenLayerObserverBehindFG);
