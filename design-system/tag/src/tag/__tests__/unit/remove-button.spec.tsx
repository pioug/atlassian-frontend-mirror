...
describe('<RemoveButton />', () => {
	...
	it('should apply the given onClick', () => {
		...
		const { getByTestId } = render(<RemoveButton onClick={onClick} testId="remove-button" />);
	...
	it('should apply the given onFocus', () => {
		...
		const { getByTestId } = render(<RemoveButton onFocus={onFocus} testId="remove-button" />);
	...
	it('should apply the given onBlur', () => {
		...
		const { getByTestId } = render(<RemoveButton onBlur={onBlur} testId="remove-button" />);
	...
	it('should apply the given onKeyPress', () => {
		...
		const { getByTestId } = render(<RemoveButton onKeyPress={onKeyPress} testId="remove-button" />);
