...
test.describe('List', () => {
  ...
  test('list: should be able to insert lists via keyboard shortcut 1', async ({
    editor,
  }) => {
  ...
  test('list: should be able to insert lists via keyboard shortcut 2', async ({
    editor,
  }) => {
    await editor.keyboard.press(shortcutInsertList);
...
test.describe('when using listsAdf', () => {
  ...
  test('list: should handle backspace correctly when at the start of a list', async ({
    ...
    await expect(editor).toHaveDocument(
      doc(
        ul(li(p('wefwef1wefwef2wefwef3'), ul(li(p('wefwef4wefwef5wefwef6'))))),
        p(),
        p('wefwef7'),
        ol()(
          li(p('wefwef1')),
    ...
    await expect(editor).toHaveDocument(
      doc(
        ul(li(p('wefwef1wefwef2wefwef3wefwef4wefwef5wefwef6wefwef7'))),
        ol()(
          li(p('wefwef1wefwef2wefwef3'), ol()(li(p('wefwef4wefwef5wefwef6')))),
        ),
        p(),
        p('wefwef7'),
      ),
  ...
  test('list: should handle backspace correctly when at the start of an ordered list', async ({
    editor,
  }) => {
    //Case 2 with indented child
    await editor.selection.set({
