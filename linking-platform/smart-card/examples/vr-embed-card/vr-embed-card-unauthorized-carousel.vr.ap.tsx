...
import type { SmartCardProvider } from '@atlaskit/link-provider/smart-card-provider';
...
const TEST_DROPBOX_URL = 'https://dropbox.com/mock';
...
export const EmbedCardUnauthorizedCarouselDropboxInAtlasSlide1: React.FC = createComponent({
	displayName: 'EmbedCardUnauthorizedCarouselFigmaInTrelloSlide1',
	config: {
		experiments: [{ key: 'platform_sl_embed_preauth_teaser_exp', value: { isEnabled: true } }],
	},
	product: 'ATLAS',
	url: TEST_DROPBOX_URL,
});
