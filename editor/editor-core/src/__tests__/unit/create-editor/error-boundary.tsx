...
const contextIdentifierProvider = storyContextIdentifierProviderFactory(mockCtxIdentifierProvider);
...
describe('create-editor/error-boundary', () => {
	...
	beforeAll(() => {
		componentDidCatch = jest.spyOn(EditorErrorBoundary.prototype, 'componentDidCatch');
		userAgent = jest.spyOn(window.navigator, 'userAgent', 'get').mockReturnValue('Supported');
	});
