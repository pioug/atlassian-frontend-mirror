...
Use `medium` or `wide` for most applications. Use `extended` and `full` with caution, because there
isn’t enough visual affordance that this is a drawer and not a new page.
