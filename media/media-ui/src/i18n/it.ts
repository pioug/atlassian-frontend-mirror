...
export default {
  ...
  'fabric.media.video_captions_delete_captions_confirmation_description':
    'Conferma di voler eliminare questa didascalia.',
  'fabric.media.video_captions_delete_captions_confirmation_header': 'Elimina didascalia',
  'fabric.media.video_captions_delete_error_description': 'Impossibile eliminare la didascalia.',
  'fabric.media.video_captions_delete_success_description': 'La didascalia è stata rimossa da questo video.',
  ...
  'fabric.media.video_captions_upload_error_description': 'Impossibile caricare la didascalia.',
  'fabric.media.video_captions_upload_success_description': 'La didascalia per questo video è stata caricata.',
