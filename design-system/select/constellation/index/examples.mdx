...
<Example
	Component={SelectSingleClearable}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectGroupedOptions}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectAppearanceDefault}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectAppearanceSubtle}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectControlStyleOverride}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectControlStyleOverrideLegacy}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectIndicatorsClear}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectIndicatorsDropdown}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
...
<Example
	Component={SelectIndicatorsLoading}
	packageName="@atlaskit/select"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-list-item': true }}
/>
