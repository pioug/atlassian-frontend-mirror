...
export default {
  ...
  'fabric.media.video_captions_delete_captions_confirmation_description':
    'Bekreft at du ønsker å slette denne underteksten.',
  ...
  'media.media-avatar-picker.image-cropper.arrow-keys.label':
    'Bilde som kan dras. Påse at skjermleseren ikke er i lesemodus. Bruk piltastene til å flytte og beskjære bildet.',
