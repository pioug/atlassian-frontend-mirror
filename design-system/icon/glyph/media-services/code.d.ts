...
/**
 * @deprecated The legacy icon "media-services/code" is deprecated in favour of "@atlaskit/icon/core/angle-brackets" and will be removed in an upcoming major release
 * 
