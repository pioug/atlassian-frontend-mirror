...
export default function Example(): React.JSX.Element {
	...
	return (
		<IntlProvider locale="en">
			<ResourcedEmojiControl emojiConfig={getEmojiConfig()} customEmojiProvider={emojiProvider}>
				<>
					<h1>Optimistic Fetching of Resourced Emoji</h1>
					<p>
						Resourced Emoji can take in a optimistic prop that allow the emoji resource to fetch its
						own emoji meta data and fallback to the emoji provider collection if it fails.
					</p>
					<h2>Optimistic Emoji Rendering</h2>
					<p>First renders a static image url before rendering the hydrated component</p>
					<EmojiWrapper>
						<ResourcedEmoji
							emojiId={emojiIds[0]}
