...
export default {
  ...
  'fabric.media.add_captions': 'Thêm chú thích',
  ...
  'fabric.media.manage_captions': 'Quản lý chú thích',
  ...
  'fabric.media.video_captions_delete_captions_confirmation_description':
    'Xin hãy xác nhận rằng bạn muốn xóa chú thích này.',
  'fabric.media.video_captions_delete_captions_confirmation_header': 'Xóa chú thích',
  'fabric.media.video_captions_delete_error_description': 'Không xóa được chú thích.',
  'fabric.media.video_captions_delete_success_description': 'Chú thích đã bị xóa thành công khỏi video này.',
  ...
  'fabric.media.video_captions_upload_error_description': 'Không tải được chú thích lên.',
  'fabric.media.video_captions_upload_success_description': 'Chú thích đã được tải lên thành công cho video này.',
  ...
  'media.media-avatar-picker.image-cropper.arrow-keys.label':
    'Hình ảnh có thể kéo. Đảm bảo trình đọc màn hình của bạn không ở chế độ duyệt. Sử dụng các phím mũi tên để di chuyển và xén hình ảnh',
