...
This will require configuration, refer to our [Get started](/get-started/develop#set-up-your-bundling-environment) guide.
...
**must** configure your project, please refer to our [Get started](/get-started/develop#set-up-your-bundling-environment) guide.
