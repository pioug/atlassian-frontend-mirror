...
// Align: 'end' + shift forwards. Locks in the direction contract: `forwards`
// moves the popover toward the cross-axis END for every align value, so this
// shifts the same way as the align: 'start' fixture above.
...
// JS fallback: align: 'end' + shift forwards. This is the fixture that caught
// `applyCrossAxisShift` mirroring the CSS path's per-align margin sign onto a
// coordinate, which moved END-aligned popovers toward the cross-axis START,
// opposite to the CSS path. It should now match the CSS fixture above.
