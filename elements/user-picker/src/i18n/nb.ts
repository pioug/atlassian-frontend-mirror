...
export default {
  ...
  'fabric.elements.user-picker.source.other-atlassian-appify': 'Andre Atlassian apper',
  'fabric.elements.user-picker.team.byline': 'Team',
  'fabric.elements.user-picker.team.byline.official': 'Offisielt team {verifiedIcon}',
  ...
  'fabric.elements.user-picker.team.member.50plus.official': 'Offisielt team {verifiedIcon} • over 50 medlemmer',
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'Offisielt team {verifiedIcon} • over 50 medlemmer, inkludert deg',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {Offisielt team {verifiedIcon} • {count} medlem} other {Offisielt team {verifiedIcon} • {count} medlemmer}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {Offisielt team {verifiedIcon} • {count} medlem, inkludert deg} other {Offisielt team {verifiedIcon} • {count} medlemmer, inkludert deg}}',
