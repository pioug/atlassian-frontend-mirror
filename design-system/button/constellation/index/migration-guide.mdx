...
New button components with improved APIs are here. If you're using the old `@atlaskit/button`, you can start migrating some default and loading button usages to the [new button](/components/button/button-new), [icon button](/components/button/icon-button), and [link button](/components/button/link-button) today.
...
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `appearance` set to `link` or `subtle link` on non-link buttons | Consider using [semantically correct buttons and links](/components/button/button-new/usage#use-buttons-for-actions-and-links-for-navigation) instead, or the new Link component or Anchor primitive. |
