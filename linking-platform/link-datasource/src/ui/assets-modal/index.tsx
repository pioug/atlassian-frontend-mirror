...
const LazyAssetsConfigModal = lazy(() =>
  import(
    /* webpackChunkName: "@atlaskit-internal_linkdatasource-assetsmodal" */ './modal'
  ).then(module => ({ default: module.AssetsConfigModal })),
);
const AssetsConfigModalWithWrappers = (props: AssetsConfigModalProps) => {
  return (
    <Suspense
      fallback={<div data-testid={'assets-aql-datasource-table-suspense'} />}
    >
