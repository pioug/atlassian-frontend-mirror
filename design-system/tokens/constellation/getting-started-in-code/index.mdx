...
Design tokens and theming are currently only recommended for use by Atlassian employees. If you’re an Atlassian employee, go to [go/tokens-early-adopters](http://go/tokens-early-adopters) for questions or issues about design tokens and relevant tooling. Go to [go/help-design-system](http://go/help-design-system) for all other questions related to the Atlassian Design System.
