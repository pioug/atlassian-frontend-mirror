...
import { CardViewV2, CardViewV2Base, type CardViewV2Props } from '../../card/v2/cardViewV2';
...
const renderCardViewBase = (props: Partial<CardViewV2Props> = {}, renderOptions = {}) =>
	render(
		<IntlProvider
			locale="en"
			messages={{
	...
	describe('Dimensions and Breakpoint', () => {
		...
		[100, 135, containerWidth, defaultCardDimensionsWidth].forEach((width) => {
			it(`should pass the correct breakpoint to the Wrapper when dimension width is ${width}`, () => {
				render(<CardViewV2Base status="complete" mediaItemType="file" dimensions={{ width }} />);
