...
test('Focus should be on nested container while navigating via keyboard', async ({
  page,
}) => {
...
test('Nested container should not be focused while navigating via mouse', async ({
  page,
}) => {
  await page.visitExample(
    'design-system',
