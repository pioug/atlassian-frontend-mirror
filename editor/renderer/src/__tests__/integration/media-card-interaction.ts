...
// FIXME: This test was automatically skipped due to failure on 27/05/2023: https://product-fabric.atlassian.net/browse/ED-18104
BrowserTestCase(
      ...
      if (page.isBrowser('firefox')) {
        ...
        expect(
          await client.waitUntil(
            ...
            // Increase timeout from default of 3000 because "weird and *slow* approach"
            { timeout: 6000 },
          ),
        ).toBe(true);
      } else {
