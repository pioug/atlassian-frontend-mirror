...
import type { BackgroundColor, Space } from '@atlaskit/primitives';
...
const layerContainerStyles = xcss({ position: 'relative', width: '800px', height: '650px' });
