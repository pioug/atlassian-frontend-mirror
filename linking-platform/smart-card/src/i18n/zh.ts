...
export default {
  ...
  'fabric.linking.direct_access_crossjoin': '立即加入',
  'fabric.linking.direct_access_description_crossjoin': '您的团队使用 {product} 进行协作，而您可以立即开始使用该产品！',
  ...
  'fabric.linking.forbidden_description_crossjoin': '请联系您的管理员申请对 {hostname} 的访问权限。',
  ...
  'fabric.linking.no_access_title_crossjoin': '加入 {product} 即可查看此内容',
  ...
  'fabric.linking.request_access_description_crossjoin':
    '您的团队使用 {product} 进行协作。请向您的管理员发送访问请求。',
