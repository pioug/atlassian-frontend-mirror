...
import DateTimePickerNew, {
	datePickerDefaultAriaLabel as datePickerDefaultAriaLabelNew,
	timePickerDefaultAriaLabel as timePickerDefaultAriaLabelNew,
} from '../../date-time-picker-fc-new';
import DateTimePickerOld, {
	datePickerDefaultAriaLabel as datePickerDefaultAriaLabelOld,
	timePickerDefaultAriaLabel as timePickerDefaultAriaLabelOld,
} from '../../date-time-picker-fc-old';
...
[
	{
		...
		datePickerDefaultAriaLabel: datePickerDefaultAriaLabelNew,
		timePickerDefaultAriaLabel: timePickerDefaultAriaLabelNew,
	},
	{
		DateTimePicker: DateTimePickerOld,
		datePickerDefaultAriaLabel: datePickerDefaultAriaLabelOld,
		timePickerDefaultAriaLabel: timePickerDefaultAriaLabelOld,
	},
].forEach(({ DateTimePicker, datePickerDefaultAriaLabel, timePickerDefaultAriaLabel }) => {
		...
		describe('Accessible names and descriptions', () => {
			...
			it('should add aria-describedby when prop is supplied', () => {
				...
				expect(datePicker).toHaveAttribute(
					'aria-describedby',
					expect.stringContaining(describedBy),
				);
				const timePicker = screen.getByTestId(timePickerTestId);
