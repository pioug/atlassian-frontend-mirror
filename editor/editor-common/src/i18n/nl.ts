...
export default {
  ...
  'editor.trackChanges.toolbarIconLabel': 'Wijzigingen bijhouden',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': 'Aanvraag annuleren en gegenereerde reactie verwijderen?',
  ...
  'fabric.editor.ai.toolbar.makeShorter.title': 'Korter maken',
