...
export const PlainConfluenceSearchConfigModalOld = (
	...
	const renderTableModalContent = useCallback(() => {
		if (status === 'rejected') {
			...
			return (
				<ContentContainer>
					<InitialStateView
						icon={<ConfluenceSearchInitialStateSVGOld />}
...
export const ConfluenceSearchConfigModalOld = (props: ConfluenceSearchConfigModalProps) => {
	return (
		<StoreContainer>
