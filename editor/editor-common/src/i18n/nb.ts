...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Instrukser',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Spesifiser oppgave, instruksjoner og regler',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Kreativitet',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Høy',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Lav',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Middels',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'For eksempel: 1. Start dokumentet med en kort oversikt over selskapets mål. 2. Opprett en liste over viktige teammedlemmer som de skal møte den første uken.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Oppgi oppgaveinstruksjoner for å generere bestemte resultater.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'For eksempel: Resultatet må følge selskapets retningslinjer for stil og ikke bruke uverifiserte data.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Regler',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': 'Beskriv reglene som skal følges.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Oppgi oppgave',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'For eksempel: Opprett innføringsdokumentasjon for nye ansatte som blir med i teamet.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Oppgave',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Beskriv oppgaven som skal fullføres.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Tone',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Uformell',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Informerende',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Medfølende',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Nøytral',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Profesjonell',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Lag avansert instruks',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Bygg avanserte instruksjoner',
