...
**Unit doc:** `.agents/knowledge-index/domains/media/units/atlaskit-media-test-data.md`
...
`sampleBinaries`, `artifactSets`, `ItemWithBinaries`, `Binaries`, `GeneratedItemWithBinaries`, `ItemWithBinariesGenerator`
...
- Export subpaths: `.`, `./artifact-sets`, `./create-item-with-binaries`, `./items-with-binaries/types`, `./items-with-binaries`, `./sample-binaries`, `./sample-file-items`, `./types`
