...
export default {
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Exempel: 1. Börja dokumentet med en kort översikt över våra företagsmål. 2. Skapa en lista med viktiga teammedlemmar att träffa under första veckan.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Tillhandahåll instruktioner om du vill generera specifika utdata.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Exempel: utdata måste följa företagets riktlinjer för stil och inte använda obekräftade data.',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Exempel: skapa en introduktionsdokumentation för nya medarbetare som går med i teamet.',
