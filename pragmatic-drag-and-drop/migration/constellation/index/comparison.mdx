...
Pointer and keyboard dragging are supported by default, equivalent to the default `react-beautiful-dnd` sensors:
...
The main use case of combining is trees, for which there are more suitable packages. 
