...
export default {
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Ví dụ: 1. Bắt đầu tài liệu bằng một phần tổng quan ngắn gọn về các mục tiêu của công ty chúng tôi. 2. Tạo danh sách các thành viên đội ngũ quan trọng để họp trong tuần đầu tiên.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Cung cấp hướng dẫn cho nhiệm vụ để giúp tạo ra kết quả cụ thể.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Ví dụ: Nội dung đầu ra phải tuân theo hướng dẫn về phong cách của công ty và không sử dụng dữ liệu chưa được xác minh.',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Ví dụ: Tạo tài liệu hướng dẫn cho nhân viên mới gia nhập đội ngũ.',
