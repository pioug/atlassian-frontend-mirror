...
export default {
  ...
  "fabric.emoji.choose.file.screenReaderDescription": "絵文字のファイルを選択します。選択できるファイルは、JPG、PNG、GIF 形式で、サイズは最大 1 MB です。",
  ...
  "fabric.emoji.select.skin.tone.ariaLabel": "スキン トーンを選択、{selectedTone}"
};
