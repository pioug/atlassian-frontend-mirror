...
>
  <p>
    This Stylelint plugin includes rules to help you use{' '}
    <a href="/foundations/design-tokens">design tokens</a>, which will soon be
    the new way to apply color and spacing values.
    <br />
    <br />
    Do not use the design token-related rules until design tokens are available for
    you to adopt.
  </p>
</SectionMessage>
