...
<Link href="/content/writing-guidelines/writing-a-warning-message/">
...
Focus moves to the first interactive element, often the close button at the top, inside the modal
dialog when rendered. Pass the `autoFocus` prop an element `ref` to focus on a specific element.
