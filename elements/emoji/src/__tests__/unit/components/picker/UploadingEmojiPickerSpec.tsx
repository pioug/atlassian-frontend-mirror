...
describe('<UploadingEmojiPicker /> - compiled', () => {
	...
	describe('delete', () => {
		...
		it('shows the emoji delete preview when the delete button is clicked', async () => {
			await helper.setupCompiledPicker({ emojiProvider }, undefined, onEvent);
...
describe('<UploadingEmojiPicker /> - emotion', () => {
	let onEvent: jest.SpyInstance;
	...
	describe('delete', () => {
		...
		it('shows the emoji delete preview when the delete button is clicked', async () => {
			await helper.setupEmotionPicker({ emojiProvider }, undefined, onEvent);
			await openDeletePrompt();
		});
