...
order: 1
title: React
description: Using @atlaskit/drag-and-drop with react
---

### Attaching behaviour

We advise that you attach drag and drop behaviour to elements using [`useEffect`](https://reactjs.org/docs/hooks-effect.html)
...
For more details, see our [deferred loading guide](TODO).
