---
order: 1
title: Closest Edge Addon
description: Detecting the closest edge of a drop target during a drag operation
---
...
```ts
import { attachClosestEdge, extractClosestEdge, Edge } from '@atlaskit/drag-and-drop-hitbox/closest-edge';
