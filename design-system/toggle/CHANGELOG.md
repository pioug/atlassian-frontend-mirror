...
-   [#27393](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/27393)
    [`73237f2e62e`](https://bitbucket.org/atlassian/atlassian-frontend/commits/73237f2e62e) - [ux]
    Fix token usages on toggle icon and handle background.
...
-   [#24004](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/24004)
    [`0349cb94ca3`](https://bitbucket.org/atlassian/atlassian-frontend/commits/0349cb94ca3) -
...
-   [#16752](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/16752)
    [`cbf4b3928b4`](https://bitbucket.org/atlassian/atlassian-frontend/commits/cbf4b3928b4) -
    Internal changes to `@atlaskit/toggle` to support adoption of '@compiled/react'.
...
-   [#17576](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/17576)
    ...
    **Note**: It is a re-release of the wrongly `patched` version `11.4.1` that should have been a
    ...
    in alpha). These changes are intended to be interoperable with the legacy theme
    implementation.Legacy dark mode users should expect no visual or breaking changes.
...
-   [#14319](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/14319)
    ...
    Fix toggle focus ring in windows high contrast mode
...
-   [#10569](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/10569)
    [`242d84dc481`](https://bitbucket.org/atlassian/atlassian-frontend/commits/242d84dc481) - [ux]
    Fix toggle shape in windows high contrast mode
...
-   [#7468](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/7468)
    [`1afc5c6e66`](https://bitbucket.org/atlassian/atlassian-frontend/commits/1afc5c6e66) - The
    layout of toggle icons is not showing correctly, fixed it by explicitly set box-sizing to
    content-box
...
-   [#5860](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/5860)
    [`da6f3ca7ff`](https://bitbucket.org/atlassian/atlassian-frontend/commits/da6f3ca7ff) - ###
    Brief
    ...
    When `defaultChecked` is passed in, that means you want it to be `stateful` and the component
    will have a `state` reflecting `checked` or `unchecked` all by itself. In contrast, if
    `defaultChecked` is absent, it turns to a stateless component and you have to control it on you
    own, by using `isChecked` prop.
...
-   fix; remove state from ToggleStateless
