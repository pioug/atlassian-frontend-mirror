import { getExampleUrl, loadPage, waitForTooltip } from '@atlaskit/visual-regression/helper';

describe('Snapshot Test', () => {
	it('Breadcrumbs-basic should match production example', async () => {
		const url = getExampleUrl('design-system', 'breadcrumbs', 'basic', global.__BASEURL__);
		const { page } = global;
	...
	it('Breadcrumbs number of items exceed maxItems', async () => {
		const url = getExampleUrl('design-system', 'breadcrumbs', 'long', global.__BASEURL__);
	...
	it('Breadcrumbs truncation', async () => {
		const url = getExampleUrl('design-system', 'breadcrumbs', 'truncation', global.__BASEURL__);
	...
	it('Breadcrumbs  - with icons', async () => {
		const url = getExampleUrl('design-system', 'breadcrumbs', 'icons', global.__BASEURL__);
	...
	it('Breadcrumbs  - with markup', async () => {
		const url = getExampleUrl('design-system', 'breadcrumbs', 'with-markup', global.__BASEURL__);
