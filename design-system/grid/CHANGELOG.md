...
- [`5efa084adb42a`](https://bitbucket.org/atlassian/atlassian-frontend-monorepo/commits/5efa084adb42a) -
  Experimental React 19 support: widen the peer dependency range, use React 19 in development, and
  fix the grid-widths VR example's missing React key. Test coverage remains partial.
