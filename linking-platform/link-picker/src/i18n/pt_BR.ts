...
export default {
  ...
  'fabric.linkPicker.search.error.heading':
    'Houve alguns problemas ao carregar os dados.',
  'fabric.linkPicker.search.linkAriaLabel':
    'As sugestões vão aparecer abaixo à medida que você digita no campo',
  'fabric.linkPicker.search.linkLabel': 'Pesquise ou cole o link',
  'fabric.linkPicker.search.linkPlaceholder':
    'Encontre links recentes ou cole um link novo',
