              ...
              leadingComments: [
                {
                  ...
                  raw: '* Sets whether the content auto flip when it reaches the border set it as true for default flip or set the custom flip positions ',
                },
              ],
              ...
              leadingComments: [
                {
                  ...
                  raw: "* Element to act as a boundary for the Layer. The Layer will not sit outside this element if it can help it. If, through it's normal positoning, it would end up outside the boundary the layer will flip positions if the autoPosition prop is set. ",
                },
              ],
              ...
              leadingComments: [
                {
                  ...
                  raw: '* HTML content to display in the layer. Will be aligned to the target according to the position prop. ',
                },
              ],
              default: { kind: 'null' },
            },
              ...
              leadingComments: [
                {
                  ...
                  raw: '* String representing the offsets from the target element in the format "[x-offset][y-offset]", measured in pixels. ',
                },
              ],
              ...
              leadingComments: [
                {
                  ...
                  raw: '* Callback that is used to know when the flipped state of Layer changes. This occurs when placing a Layered element in the requested position would cause Layer to be rendered outside of the boundariesElement (usually viewport). ',
                },
              ],
              default: {
                kind: 'function',
              ...
              leadingComments: [
                {
                  ...
                  raw: '* Position of a layer relative to its target. The position attribute takes two positional arguments in the format position="edge edge-position", where edge specifies what edge to align the layer to, and edge-position specifies where on that edge the layer should appear. ',
                },
              ],
              ...
              leadingComments: [
                {
                  ...
                  raw: '* Force the layer to always be positioned fixed to the viewport. Note that the layer will become detached from the target element when scrolling so scroll lock or close on scroll handling may be necessary. ',
                },
              ],
              default: { kind: 'boolean', value: false },
            },
              ...
              leadingComments: [
                {
                  ...
                  raw: "* Callback that is used to know when the Layer positions it's content. This will only be called once soon after mounting when the Layer's transformed/flipped position is first calculated. ",
                },
              ],
              default: {
                kind: 'function',
