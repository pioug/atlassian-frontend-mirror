...
<SectionMessage
	...
	appearance="warning"
>
	Motion has been updated in Modal and is in Early Access. The motion updates are currently behind the feature flag: platform-dst-motion-uplift.
</SectionMessage>
