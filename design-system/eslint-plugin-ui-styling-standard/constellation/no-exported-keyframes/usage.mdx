...
Forbid exporting `keyframes` function calls. Exporting `keyframes` function calls can result in
unexpected behaviour at runtime, and is not statically analysable.
