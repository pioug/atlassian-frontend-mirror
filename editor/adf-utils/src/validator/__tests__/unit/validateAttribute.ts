...
describe('validateAttrs', () => {
	...
	describe('number', () => {
		...
		it('should check optional', () => {
			expect(validateAttrs(spec, undefined)).toBeFalsy();
			expect(validateAttrs({ ...spec, optional: true }, undefined)).toBeTruthy();
		});
	...
	describe('string', () => {
		...
		it('should check validatorFn', () => {
			expect(
				validateAttrs({ ...spec, validatorFn: 'someCustomFunction' }, 'this should pass'),
			).toBeTruthy();
			expect(
				validateAttrs({ ...spec, validatorFn: 'anotherCustomFunction' }, 'this should fail'),
			).toBeFalsy();
		});
