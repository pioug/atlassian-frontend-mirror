...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': '说明',
  'fabric.editor.ai.config.item.advancedPrompt.description': '指定任务、说明和规则',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': '创意',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': '中等',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    '例如：1. 文档开头简要概述我们的公司目标。2. 创建主要团队成员名单，以便在其入职的第一周会面。',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder': '提供任务说明以帮助生成特定的输出。',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    '例如：输出必须遵循公司风格指南，且不得使用未经验证的数据。',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': '规则',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': '概述您希望遵循的所有规则。',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': '请提供任务',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage': '例如：为加入团队的新员工创建入职文档。',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': '任务',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': '描述需要完成的任务。',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': '语气',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': '轻松随意',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': '教育口吻',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': '善解人意',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': '中立口吻',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': '专业口吻',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': '构建高级提示',
  'fabric.editor.ai.config.item.advancedPrompt.title': '构建高级提示',
  ...
  'fabric.editor.ai.experience.suggestionGroupHeading.studio': '工作室',
