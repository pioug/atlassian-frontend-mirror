...
export default {
  ...
  'fabric.elements.user-picker.group.byline.admin-managed': 'Adminisztrátori csoport {verifiedIcon}',
  ...
  'fabric.elements.user-picker.source.other-atlassian-appify': 'Más Atlassian-alkalmazások',
  'fabric.elements.user-picker.team.byline': 'Csapat',
  'fabric.elements.user-picker.team.byline.official': 'Hivatalos csapat {verifiedIcon}',
  ...
  'fabric.elements.user-picker.team.member.50plus.official': 'Hivatalos csapat {verifiedIcon} • Több mint 50 tag',
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'Hivatalos csapat {verifiedIcon} • Veled együtt több mint 50 tag',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {Hivatalos csapat {verifiedIcon} • {count} tag} other {Hivatalos csapat {verifiedIcon} • {count} tag}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {Hivatalos csapat {verifiedIcon} • Veled együtt {count} tag} other {Hivatalos csapat {verifiedIcon} • Veled együtt {count} tag}}',
