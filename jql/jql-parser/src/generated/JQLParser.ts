...
export class JQLParser extends Parser {
  ...
  public jqlOrClause(): JqlOrClauseContext {
    let _localctx: JqlOrClauseContext = new JqlOrClauseContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlAndClause(): JqlAndClauseContext {
    let _localctx: JqlAndClauseContext = new JqlAndClauseContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlNotClause(): JqlNotClauseContext {
    let _localctx: JqlNotClauseContext = new JqlNotClauseContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlSubClause(): JqlSubClauseContext {
    let _localctx: JqlSubClauseContext = new JqlSubClauseContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlTerminalClause(): JqlTerminalClauseContext {
    let _localctx: JqlTerminalClauseContext = new JqlTerminalClauseContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlTerminalClauseRhs(): JqlTerminalClauseRhsContext {
    let _localctx: JqlTerminalClauseRhsContext =
      new JqlTerminalClauseRhsContext(this._ctx, this.state);
  ...
  public jqlEqualsOperator(): JqlEqualsOperatorContext {
    let _localctx: JqlEqualsOperatorContext = new JqlEqualsOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlLikeOperator(): JqlLikeOperatorContext {
    let _localctx: JqlLikeOperatorContext = new JqlLikeOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlComparisonOperator(): JqlComparisonOperatorContext {
    let _localctx: JqlComparisonOperatorContext =
      new JqlComparisonOperatorContext(this._ctx, this.state);
  ...
  public jqlInOperator(): JqlInOperatorContext {
    let _localctx: JqlInOperatorContext = new JqlInOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlIsOperator(): JqlIsOperatorContext {
    let _localctx: JqlIsOperatorContext = new JqlIsOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlWasOperator(): JqlWasOperatorContext {
    let _localctx: JqlWasOperatorContext = new JqlWasOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlWasInOperator(): JqlWasInOperatorContext {
    let _localctx: JqlWasInOperatorContext = new JqlWasInOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlChangedOperator(): JqlChangedOperatorContext {
    let _localctx: JqlChangedOperatorContext = new JqlChangedOperatorContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlFieldProperty(): JqlFieldPropertyContext {
    let _localctx: JqlFieldPropertyContext = new JqlFieldPropertyContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlCustomField(): JqlCustomFieldContext {
    let _localctx: JqlCustomFieldContext = new JqlCustomFieldContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlString(): JqlStringContext {
    let _localctx: JqlStringContext = new JqlStringContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlNumber(): JqlNumberContext {
    let _localctx: JqlNumberContext = new JqlNumberContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlOperand(): JqlOperandContext {
    let _localctx: JqlOperandContext = new JqlOperandContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlFunction(): JqlFunctionContext {
    let _localctx: JqlFunctionContext = new JqlFunctionContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlFunctionName(): JqlFunctionNameContext {
    let _localctx: JqlFunctionNameContext = new JqlFunctionNameContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlArgumentList(): JqlArgumentListContext {
    let _localctx: JqlArgumentListContext = new JqlArgumentListContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlListStart(): JqlListStartContext {
    let _localctx: JqlListStartContext = new JqlListStartContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlListEnd(): JqlListEndContext {
    let _localctx: JqlListEndContext = new JqlListEndContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlArgument(): JqlArgumentContext {
    let _localctx: JqlArgumentContext = new JqlArgumentContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlWasPredicate(): JqlWasPredicateContext {
    let _localctx: JqlWasPredicateContext = new JqlWasPredicateContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlDatePredicateOperator(): JqlDatePredicateOperatorContext {
    let _localctx: JqlDatePredicateOperatorContext =
      new JqlDatePredicateOperatorContext(this._ctx, this.state);
  ...
  public jqlDateRangePredicateOperator(): JqlDateRangePredicateOperatorContext {
    let _localctx: JqlDateRangePredicateOperatorContext =
      new JqlDateRangePredicateOperatorContext(this._ctx, this.state);
  ...
  public jqlUserPredicateOperator(): JqlUserPredicateOperatorContext {
    let _localctx: JqlUserPredicateOperatorContext =
      new JqlUserPredicateOperatorContext(this._ctx, this.state);
  ...
  public jqlValuePredicateOperator(): JqlValuePredicateOperatorContext {
    let _localctx: JqlValuePredicateOperatorContext =
      new JqlValuePredicateOperatorContext(this._ctx, this.state);
  ...
  public jqlOrderBy(): JqlOrderByContext {
    let _localctx: JqlOrderByContext = new JqlOrderByContext(
      this._ctx,
      this.state,
    );
  ...
  public jqlSearchSort(): JqlSearchSortContext {
    let _localctx: JqlSearchSortContext = new JqlSearchSortContext(
      this._ctx,
      this.state,
    );
...
export class JqlWasClauseContext extends JqlTerminalClauseRhsContext {
  ...
  public jqlWasPredicate(
    i?: number,
  ): JqlWasPredicateContext | JqlWasPredicateContext[] {
    if (i === undefined) {
...
export class JqlNonNumberFieldContext extends JqlFieldContext {
  ...
  public jqlFieldProperty(
    i?: number,
  ): JqlFieldPropertyContext | JqlFieldPropertyContext[] {
    if (i === undefined) {
...
export class JqlChangedPredicateContext extends ParserRuleContext {
  ...
  public jqlValuePredicateOperator():
...
export class JqlOrderByContext extends ParserRuleContext {
  ...
  public jqlSearchSort(
    i?: number,
  ): JqlSearchSortContext | JqlSearchSortContext[] {
    if (i === undefined) {
