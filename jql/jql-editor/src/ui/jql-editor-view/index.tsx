...
const JQLEditorView = ({
	...
	const [, { setEditorViewContainer, setEditorViewContainerScroll }] = useStoreActions();

	const [editorViewHasFocus, { onEditorViewBlur, onEditorViewFocus }] = useEditorViewHasFocus();
	...
	const onMainRef = useCallback(
		(element: HTMLElement | null) => portalActions.onRegisterPluginContainer('main', element),
		[portalActions],
	);
