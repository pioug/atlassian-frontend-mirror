...
- The blanket component is commonly used with the [modal dialog](/components/modal-dialog)
  component.
- Other components that use the blanket include the [drawer](/components/drawer) and
  [spotlight](/components/onboarding).
