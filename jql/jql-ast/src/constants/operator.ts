...
export const EQUALS_OPERATORS: readonly ["=", "!="] = [OPERATOR_EQUALS, OPERATOR_NOT_EQUALS] as const;
...
export const WAS_IN_OPERATORS: readonly ["was in", "was not in"] = [OPERATOR_WAS_IN, OPERATOR_WAS_NOT_IN] as const;

export const CHANGED_OPERATORS: readonly ["changed"] = [OPERATOR_CHANGED] as const;

export const OPERATORS: readonly ["=", "!=", "~", "!~", "<", ">", "<=", ">=", "in", "not in", "is", "is not", "was", "was not", "was in", "was not in", "changed"] = [
	...EQUALS_OPERATORS,
	...LIKE_OPERATORS,
