...
ruleTester.run('use-primitives', rule, {
	...
	invalid: [
		...
		},
		{
			options: [
				{
					patterns: ['compiled-styled-object', 'multiple-properties', 'css-property-with-tokens'],
				},
			],
			code: outdent`
		...
		},
		{
			options: [
				{
					patterns: ['compiled-css-function', 'multiple-properties', 'css-property-with-tokens'],
				},
			],
			code: outdent`
