...
The image component can be used interchangeably with the native `img` element. The main difference is
the image component's awareness of themes, like dark mode.
