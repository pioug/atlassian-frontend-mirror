  ...
  <SectionMessage title="Integral to theming" appearance="info">
    {md`
      **\`Checkbox 10.0\`** introduced component tokens to Checkbox as its core theming api.
      ...
      For more details on theming @atlaskit/checkbox, please see the [theming guide](https://atlaskit.atlassian.com/packages/design-system/checkbox/docs/theming-guide).
    `}
  </SectionMessage>
)}
