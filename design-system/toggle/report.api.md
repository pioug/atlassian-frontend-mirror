...
declare type Size = 'regular' | 'large';

declare const Toggle: MemoExoticComponent<ForwardRefExoticComponent<
  Pick<
    ToggleProps,
    | 'size'
    | 'isDisabled'
...
declare interface ToggleProps extends WithAnalyticsEventsProps {
