The UI Styling Standard is a set of principles to guide styling UI code
...
For Atlassians, refer to the [internal UI Styling Standard policy](https://go.atlassian.com/ui-styling-standard-policy).
