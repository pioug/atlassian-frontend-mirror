...
export default {
  ...
  'fabric.linking.connect_unauthorised_account_description-appify':
    'Conecte sua conta {context} para colaborar no trabalho em todos os apps da Atlassian.',
  ...
  'fabric.linking.connect_unauthorised_account_description_no_provider-appify':
    'Conecte a conta para colaborar no trabalho em todos os apps da Atlassian.',
  ...
  'fabric.linking.follow_project_error-galaxia':
    'Foi encontrado um erro ao tentar seguir o espaço. Verifique a conexão ou atualize a página e tente de novo.',
  ...
  'fabric.linking.learn_more_about_connecting_account-appify':
    'Saiba mais sobre como conectar a conta aos apps da Atlassian.',
  ...
  'fabric.linking.unfollow_project_description-galaxia':
    'Pare de seguir para não receber mais notificações sobre o espaço',
  ...
  'fabric.linking.unfollow_project_error-galaxia':
    'Foi encontrado um erro ao tentar para de seguir o espaço. Verifique a conexão ou atualize a página e tente de novo.',
