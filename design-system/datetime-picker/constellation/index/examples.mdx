...
import DateTimePickerDefaultCompact from '../../examples/constellation/datetime-picker-default-compact';
import DateTimePickerForm from '../../examples/constellation/datetime-picker-form';
import DateTimePickerRequired from '../../examples/constellation/datetime-picker-required';
...
Date time picker used with the [form](/components/form) component includes a field label and helper
text.
...
<Example Component={DateTimePickerRequired} packageName="@atlaskit/datetime-picker" />
...
<Example Component={DateTimePickerDefaultCompact} packageName="@atlaskit/datetime-picker" />
