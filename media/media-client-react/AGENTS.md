...
**Unit doc:** `.agents/knowledge-index/domains/media/units/atlaskit-media-client-react.md`
**Standards page:** `.agents/knowledge-index/domains/media/units/atlaskit-media-client-react/standards-and-patterns.md`
