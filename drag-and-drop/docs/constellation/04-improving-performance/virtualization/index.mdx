...
description: How to be successful using Atlassian drag and drop with virtualized solutions.
---

Atlassian drag and drop works well with virtualization techniques. This page explains what you need to know about the underlying web platform to be successful with virtualization.
