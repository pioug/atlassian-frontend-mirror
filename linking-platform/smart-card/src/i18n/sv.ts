...
export default {
  ...
  "fabric.linking.connect_unauthorised_account_description": "Anslut till Atlassian för att se mer information om ditt arbete och samarbete på ett och samma ställe.",
  ...
  "fabric.linking.forbidden_description": "Du har inte behörighet för den här förhandsgranskningen. Kontakta webbplatsadministratören om du behöver åtkomst.",
  ...
  "fabric.linking.request_denied_description": "Din åtkomstförfrågan har nekats. Kontakta webbplatsadministratören om du fortfarande behöver åtkomst.",
