...
export default {
  ...
  'fabric.linking.connect_unauthorised_account_description-appify':
    'Подключите свой аккаунт {context} для совместной работы в приложениях Atlassian.',
  ...
  'fabric.linking.connect_unauthorised_account_description_no_provider-appify':
    'Подключите свой аккаунт для совместной работы в приложениях Atlassian.',
  ...
  'fabric.linking.follow_project_error-galaxia':
    'При попытке отслеживать пространство произошла ошибка. Проверьте подключение или обновите страницу и повторите попытку.',
  ...
  'fabric.linking.learn_more_about_connecting_account-appify':
    'Подробнее о подключении аккаунта к приложениям Atlassian',
  ...
  'fabric.linking.unfollow_project_description-galaxia':
    'Перестаньте отслеживать пространство, чтобы больше не получать уведомления о нем',
  ...
  'fabric.linking.unfollow_project_error-galaxia':
    'При попытке перестать отслеживать пространство произошла ошибка. Проверьте подключение или обновите страницу и повторите попытку.',
