...
<SectionMessage title="CustomThemeButton is deprecated" appearance="warning">
	<p>
		...
		deprecated. Use <a href="/components/primitives/pressable">Pressable</a> if you require a
		custom button to have an easier time with accessibility and consistency.
	</p>
</SectionMessage>
