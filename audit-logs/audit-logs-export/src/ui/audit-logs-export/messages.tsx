...
export const defaultMessages = defineMessages({
  ...
  modalDescription: {
    ...
    defaultMessage: 'We\'ll email you a CSV file of all activities {matchFilterText} is ready to download.',
  ...
  exportTermsDescription: {
    ...
    defaultMessage: 'I understand that if I share these audit logs with people that don\'t otherwise have access to them, any existing user permissions set in Atlassian Administration and other apps will no longer apply to them.',
  ...
  successFlagDescription: {
    ...
    defaultMessage: 'Check your email to download the CSV file. It might take a few minutes to arrive.',
