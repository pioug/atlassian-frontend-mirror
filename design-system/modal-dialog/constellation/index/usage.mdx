...
Although highly versatile, modal dialogs aren't fit for all purposes. Modal dialogs are invasive and should be used sparingly. Letting people access and view their own content is important for a good experience.
...
For existing code, you can continue to use [Atlassian User Interface (AUI)](https://aui.atlassian.com/). Primary buttons are left adjusted in [AUI modal dialogs](https://docs.atlassian.com/aui/latest/docs/dialog2.html).

## Related

- Use [popups](/components/popup/) for smaller amounts of information along with controls.
- To onboard or update people about new functionality, use the [benefits modal](/patterns/benefits-modal) or [spotlight](/patterns/spotlight) patterns.
- To alert people about important information, or an action that's required to complete a task, use [inline messages](/components/inline-message).
