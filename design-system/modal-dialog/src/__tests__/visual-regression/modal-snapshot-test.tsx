...
describe('Snapshot test', () => {
	...
	it('Body scroll should match (with both top and bottom keylines)', async () => {
		...
		await page.evaluate((selector) => document.querySelector(selector).scrollTo(0, 200), modalBody);
	...
	it('Multiple stacked modal example should match production', async () => {
		const url = getExampleUrl('design-system', 'modal-dialog', 'multiple', global.__BASEURL__);
	...
	it('Warning modal appearance should match production example', async () => {
		const url = getExampleUrl('design-system', 'modal-dialog', 'appearance', global.__BASEURL__);
	...
	it('Modal with a custom width should match production example', async () => {
		const url = getExampleUrl('design-system', 'modal-dialog', 'width', global.__BASEURL__);
