...
export default md`
  Occasionally you will need to asyncronously load some of your menus.
  ...
  For a more in-depth look at how to approach loading states have our _work in progress_ [Skeleton exploration](https://hello.atlassian.net/wiki/spaces/ADG/pages/598816601/Skeleton+-+exploration) (only Atlassians will be able to access this link unfortuntely).
