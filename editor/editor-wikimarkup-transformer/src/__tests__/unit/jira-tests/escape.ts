import { a as link, doc, p, hardBreak } from '@atlaskit/editor-test-helpers/doc-builder';
...
describe.skip('WikiMarkup Transformer', () => {
	...
	describe('escaping diffs', () => {
		...
		checkParseEncodeRoundTrips(
			...
			defaultSchema,
			WIKI_NOTATION,
			doc(p('This is not &#43;inserted&#43; neither this one &#45;deleted&#45;')),
		);
	});
	...
	describe('escaping mentions', () => {
		...
		checkParseEncodeRoundTrips(
			...
			defaultSchema,
			WIKI_NOTATION,
			doc(p('Not &#64;textbox&#64; and especially not an &#64;-sign by itself')),
		);
	});
	...
	describe('escaping pre-encoded strings', () => {
		...
		checkParseEncodeRoundTrips(
			...
			defaultSchema,
			WIKI_NOTATION,
			doc(p(`Already encoded &amp; &lt; &lt; &quot;&quot; must stay unchanged`)),
		);
	});
...
and the end!`;
	...
	describe('escaping non escape sequences', () => {
		...
		checkParseEncodeRoundTrips(WIKI_NOTATION, defaultSchema, WIKI_NOTATION, doc(p(`&amp;#xFC`)));
	});
});
