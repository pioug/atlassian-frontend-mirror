// NOTE: This is copied from @atlaskit/link-provider.
// This should be moved into @atlaskit/linking-common, to be done in
// https://product-fabric.atlassian.net/browse/EDM-6042
