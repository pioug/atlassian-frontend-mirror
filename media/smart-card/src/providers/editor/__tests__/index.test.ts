...
describe('providers > editor', () => {
  ...
  it('returns inlineCard when Slack message link inserted, calling /providers endpoint', async () => {
    const provider = new EditorCardProvider();
    mockFetch.mockImplementationOnce(async () => ({
      json: async () => mockProvidersResponse,
      ok: true,
  ...
  it('returns inlineCard when Slack message in thread link inserted, calling /providers endpoint', async () => {
    const provider = new EditorCardProvider();
    mockFetch.mockImplementationOnce(async () => ({
      json: async () => mockProvidersResponse,
      ok: true,
