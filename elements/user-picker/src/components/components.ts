 ...
 */
export const getComponents: MemoizedFn<(multi?: boolean, anchor?: React.ComponentType<any>, showClearIndicator?: boolean, customComponents?: SelectComponentsConfig<OptionData, boolean>) => {
...
export const getPopupComponents: MemoizedFn<(hasPopupTitle: boolean) => {
    ...
    SingleValue: (props: Props) => JSX.Element | null;
    ValueContainer: typeof SingleValueContainer;
}> = memoizeOne((hasPopupTitle: boolean): {
    ClearIndicator: typeof ClearIndicator;
    DropdownIndicator: null;
    Input: typeof PopupInput;
    Option: FC<OptionProps>;
