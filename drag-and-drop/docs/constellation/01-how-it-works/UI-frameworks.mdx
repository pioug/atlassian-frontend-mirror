...
Atlassian drag and drop has been designed to be used with any UI library or framework. This allows us to:
...
You can use this component pattern with Atlassian drag and drop:
...
For more details, see our [deferred loading guide](/components/drag-and-drop/improving-performance/deferred-loading/deferred-loading).
