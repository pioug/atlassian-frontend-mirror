...
permissions or promotional labels, use a [lozenge](/components/lozenge/lozenge) instead.
...
or product understanding, use [lozenge](/components/lozenge/lozenge).
...
- For status and other high importance attributes, use a [lozenge](/components/lozenge/lozenge).
