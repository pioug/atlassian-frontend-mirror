...
snapshotInformational(WithJiraIssuesModal, {
  ...
  description:
    'jira issues modal after selecting Inline link from the drop down',
  drawsOutsideBounds: true,
});
snapshotInformational(WithJiraIssuesModal, {
  prepare: async (page: Page, _component: Locator) => {
  ...
  description:
    'jira issues modal after selecting Inline link with open drop down',
  drawsOutsideBounds: true,
});
...
snapshotInformational(WithConfluenceSearchModal, {
  ...
  description:
    'confluence search modal after selecting Inline link from the drop down',
  drawsOutsideBounds: true,
});
snapshotInformational(WithConfluenceSearchModal, {
  prepare: async (page: Page, _component: Locator) => {
  ...
  description:
    'confluence search modal after selecting Inline link with open drop down',
  drawsOutsideBounds: true,
});
