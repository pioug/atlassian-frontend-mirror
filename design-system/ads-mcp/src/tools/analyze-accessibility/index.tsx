...
const accessibilityPatterns = [
	{
		...
		severity: 'error',
		suggestion:
			'Use the suggest-accessibility-fixes tool for ADS Button solutions. Describe the issue as "button missing label", "empty button", or "button needs text".',
	},
	{
		pattern: /<img[^>]*>(?!.*alt=)/g,
		...
		severity: 'error',
		suggestion:
			'Use the suggest-accessibility-fixes tool for ADS Image solutions. Describe the issue as "image missing alt", "missing alt text", or "image accessibility".',
	},
	{
		...
		severity: 'warning',
		suggestion:
			'Use the suggest-accessibility-fixes tool for ADS solutions. Describe the issue as "clickable div", "interactive div", or "div with click handler".',
	},
	{
		...
		severity: 'warning',
		suggestion:
			'Use the suggest-accessibility-fixes tool for design token solutions. Describe the issue as "hardcoded colors", "hex colors", or "design tokens".',
	},
	{
		pattern: /<input[^>]*>(?!.*id=)/g,
		...
		severity: 'error',
		suggestion:
			'Use the suggest-accessibility-fixes tool for ADS form solutions. Describe the issue as "input missing label", "form field without label", or "unlabeled input".',
	},
	{
		...
		severity: 'warning',
		suggestion:
			'Use the suggest-accessibility-fixes tool for ADS Button/Focusable solutions. Describe the issue as "custom button", "div with button role", or "interactive element".',
	},
	{
		...
		severity: 'warning',
		suggestion:
			'Use the suggest-accessibility-fixes tool for design token solutions. Describe the issue as "inline styles", "hardcoded colors", or "color tokens".',
	},
];
...
function generateADSFixForViolation(violation: any): any {
	...
	return {
		...
		adsFix,
		example:
			'The suggest-accessibility-fixes tool provides detailed code examples and ADS component solutions',
		violationId: id,
		axeHelp: help,
		tags,
		...
		recommendations: [
			...
			'Reference the suggest-accessibility-fixes tool for specific solutions',
