...
//Norwegian (Bokmål)
export default {
  '1M7iXg': 'Redigeringsmodul for JQL-forespørsel',
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource':
    'Sjekk tilkoblingen og oppdater, eller <a>åpne dette prosjektet i Confluence</a> for å gjennomgå.',
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Sjekk tilkoblingen og oppdater, eller <a>åpne dette Jira-området i Confluence</a> for å gjennomgå.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Koble til {providerName}-kontoen din for å samarbeide mellom flere Atlassian-apper.',
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    'Vent noen minutter og prøv på nytt. Sjekk områdeinnstillingene, eller kontakt støtte hvis dette vedvarer.',
  ...
  'linkDataSource.jira-issues.checkConnection.jira':
    'Sjekk tilkoblingen og oppdater, eller <a>åpne dette søket i Jira</a> for å gjennomgå.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv':
    'Sjekk tilkoblingen og oppdater, eller <a>åpne dette prosjektet i Jira</a> for å gjennomgå.',
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Sjekk tilkoblingen og oppdater, eller <a>åpne dette området i Jira</a> for å gjennomgå.',
  ...
  'linkDataSource.jira-issues.configmodal.insertIssuesTitleManySites-issue-term-refresh':
    'Sett inn Jira-arbeidsoppgaver fra',
  ...
  'linkDataSource.modal-initial-state.searchDescription-jql-issue-term-refresh':
    'Bruk JQL (Jira Query Language) for å søke etter arbeidsoppgaver.',
  ...
  'linkDataSource.search.configmodal.issueCountText-issue-term-refresh':
    '{searchCount, plural, one {{searchCount,number} arbeidsoppgave} other {{searchCount,number} arbeidsoppgaver}}',
