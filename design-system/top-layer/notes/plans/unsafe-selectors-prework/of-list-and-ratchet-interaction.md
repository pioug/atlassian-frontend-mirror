...
| top-layer CSS-length probe                | **exclude (transient)**                                            | `design-system/top-layer/src/internal/resolve-css-length-to-pixels.tsx:103-105` appends an `aria-hidden inert` div into a caller-supplied container and removes it in the same synchronous tick.                                                                                                                                                                                                                                                                                                                                                                                  |
