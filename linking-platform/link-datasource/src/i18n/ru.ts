...
export default {
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Проверьте подключение и обновите страницу или <a>откройте этот раздел Jira в Confluence</a> для проверки.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Подключите свой аккаунт {providerName} для совместной работы в приложениях Atlassian.',
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    'Подождите несколько минут и повторите попытку. Если проблема возникнет снова, проверьте настройки пространства или обратитесь в службу поддержки.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Проверьте подключение и обновите страницу или <a>откройте этот раздел в Jira</a> для проверки.',
