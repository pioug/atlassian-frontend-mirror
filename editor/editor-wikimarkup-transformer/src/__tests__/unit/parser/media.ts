...
describe('JIRA wiki markup - Images and attachments', () => {
	const testCases: Array<[string, string]> = [
		...
		['should find attachments with attributes', '!quicktime.mov|width=300,height=400!'],
		['should find attachments with percentage width attribute', '!fizzbuzz.txt|width=50%!'],
		['should clamp media with percentage width > 100%', '!fizzbuzz.txt|width=500%!'],
		[
...
yep`,
		...
		['[CS-1879] should parse media with alt text in quotes', '!foo.png|alt="hello world"!'],
		['[CS-1879] should parse media with alt text without quotes', '!foo.png|alt=hello world!'],
		[
		...
		['should transform attachment next to image', '[^document.pdf] !image.png!'],
		[
