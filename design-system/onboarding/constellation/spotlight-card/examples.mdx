...
[spotlight](/components/onboarding) does. Spotlight cards are generally more flexible, so you can
design more bespoke experiences as seen in the other examples below.

<Example
	Component={SpotlightCardDefault}
...
<Example
	Component={SpotlightCardRichText}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
Spotlight card actions work in a similar way to [spotlight](/components/onboarding). You can set the
appearance of action buttons to either default (primary), `subtle`, or `subtle-link`.

<Example
	Component={SpotlightCardActions}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightCardActionsBefore}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightCardHeading}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={SpotlightCardHeadingAfter}
	packageName="@atlaskit/onboarding"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
[illustration library](/foundations/illustrations) that you can make use of, please keep in mind
