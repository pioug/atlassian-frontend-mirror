...
Events will be fired on pieces (eg `draggable` and `dropTargets`) if they are relevant to the event. If you want to listen for _all_ events of a particular entity type (eg files), you can use a [monitor]('./monitors.md).
