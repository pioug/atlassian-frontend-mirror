...
describe('Snapshot Test: Media Border Mark', () => {
	...
	describe('full page editor', () => {
		beforeEach(async () => {
			await initEditor(Appearance.fullPage, { width: 800, height: 700 }, borderADF, {
		...
		describe('with link', () => {
			beforeEach(async () => {
				await initEditor(Appearance.fullPage, { width: 800, height: 700 }, borderADFWithLink, {
					allowBorderMark: true,
		...
		describe('within table', () => {
			beforeEach(async () => {
				await initEditor(Appearance.fullPage, { width: 800, height: 900 }, borderADFWithinTable, {
					allowBorderMark: true,
					media: { allowMediaSingle: true, allowLinking: true },
					allowTables: {
						advanced: true,
