...
const AsyncPopupSelect = ({
	...
	const [selectedOptions, setSelectedOptions] = useState<ValueType<SelectOption, true>>(selection);
	...
	const [handleDebouncedFetchFilterOptions] = useDebouncedCallback((searchString: string) => {
		fetchFilterOptions({
			searchString,
		});
	}, SEARCH_DEBOUNCE_MS);
