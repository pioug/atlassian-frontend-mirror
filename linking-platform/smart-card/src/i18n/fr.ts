...
export default {
  ...
  'fabric.linking.connect_unauthorised_account_description-appify':
    "Connectez votre compte {context} pour collaborer sur l'ensemble des apps Atlassian.",
  ...
  'fabric.linking.connect_unauthorised_account_description_no_provider-appify':
    'Connectez votre compte pour collaborer sur le travail dans les applications Atlassian.',
  ...
  'fabric.linking.follow_project_description-galaxia': 'Suivez cet espace pour obtenir des notifications à son sujet',
  ...
  'fabric.linking.follow_project_error-galaxia':
    "Nous avons rencontré une erreur lors de la tentative de suivi de l'espace. Vérifiez votre connexion ou actualisez la page, puis réessayez.",
  ...
  'fabric.linking.learn_more_about_connecting_account-appify':
    'En savoir plus sur la connexion de votre compte aux applications Atlassian.',
  ...
  'fabric.linking.unfollow_project_description-galaxia':
    'Arrêtez de suivre cet espace pour ne plus recevoir de notifications à son sujet',
  ...
  'fabric.linking.unfollow_project_error-galaxia':
    "Nous avons rencontré une erreur lors de la tentative d'annulation du suivi de l'espace. Vérifiez votre connexion ou actualisez la page, puis réessayez.",
