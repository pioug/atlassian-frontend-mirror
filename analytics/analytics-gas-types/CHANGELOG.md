...
- [#67410](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/67410)
  ...
  Migrate @atlaskit/analytics-gas-types to use declarative entry points
...
- [#22145](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/22145)
  [`fb671c594d3`](https://bitbucket.org/atlassian/atlassian-frontend/commits/fb671c594d3) - Fixing
  typo in docs
...
- [#5907](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/5907)
  [`fee301414d`](https://bitbucket.org/atlassian/atlassian-frontend/commits/fee301414d) - Updated
  Gasv3 operational event payload
...
- [minor] Update GasPayload to include proper format for screen events
...
- [minor] Allow sending of search queries in analytics events
  [e5f14e9](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/e5f14e9)
...
- [minor] Export individual event types as constants
  [9be1db0](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/9be1db0)

## 2.0.0

- [major] added new package analytics-gas-types
  [4d238a6](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/4d238a6)
