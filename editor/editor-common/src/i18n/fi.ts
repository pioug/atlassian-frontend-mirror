...
export default {
  ...
  'editor.extension.legacyContentHeader.contentHasLimitedFunctionality':
    'Tämä sisällön toiminnallisuutta on rajoitettu.',
  'editor.extension.legacyContentHeader.learnMore': 'Lue lisää',
  'editor.trackChanges.removed': 'Poistettu',
  'editor.trackChanges.toolbarIconLabel': 'Katso muutokset',
  'fablric.editor.viewAllInserts': 'Näytä kaikki lisäykset',
  'fabric.editor.accessToSyncedBlockRequested': 'Käyttöoikeutta pyydettiin',
  ...
  'fabric.editor.ai.config.item.changeTone.adjustLengthNestingParentShortTitle': 'Pituus',
  'fabric.editor.ai.config.item.changeTone.adjustLengthNestingParentTitle': 'Säädä pituus',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'Parantelee vastausta työstämäsi asian kanssa samankaltaisten asioiden perusteella',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': 'Ehdota vastausta',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint': 'Kirjoita Rovon avulla tai valitse alta',
  ...
  'fabric.editor.ai.experience.adfStreamingError': 'Emme valitettavasti saaneet vastausta.',
  'fabric.editor.ai.experience.aifcAdfStreamingError': 'Emme valitettavasti saaneet vastausta.',
  'fabric.editor.ai.experience.aifcApiError': 'Tapahtui tuntematon virhe.',
  'fabric.editor.ai.experience.aifcApiErrorRetry': 'Tapahtui tuntematon virhe. Lataa uudestaan ja yritä uudelleen.',
  'fabric.editor.ai.experience.aifcAupViolationMessage': 'Sisältö ei ole <link>käyttösääntöjemme</link> mukaista.',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    'Sisällössä on linkkejä HIPAA-rajoitettuun sisältöön. Poista linkit ja yritä uudelleen.',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    'Lisää sisältöä tarvitaan pyyntösi täyttämiseen. Valitse lisää sisältöä ja yritä uudelleen.',
  'fabric.editor.ai.experience.aifcInternalServerError':
    'Emme valitettavasti saaneet vastausta. Yritä uudelleen 5 minuutin kuluttua tai <link>tarkista Rovon tila</link>.',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    'Olet saavuttanut <link>pyyntöjen enimmäismäärän</link>. Yritä uudelleen 5 minuutin kuluttua.',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'Sisältöä on liikaa käsiteltäväksi. Valitse vähemmän sisältöä ja yritä uudelleen.',
  ...
  'fabric.editor.ai.experience.dialogAriaLabel': 'Atlassian Intelligence ‑valintaikkuna',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': 'Peruutetaanko pyyntö ja hylätäänkö vastaus?',
  ...
  'fabric.editor.ai.experience.noTextualContentError':
    'Pyyntösi täyttämiseen tarvitaan lisää sisältöä. Valitse lisää sisältöä ja yritä uudelleen.',
  ...
  'fabric.editor.ai.toolbar.DefineDropdownIconTitle.title': 'Määritä',
  'fabric.editor.ai.toolbar.adjustLength.title': 'Säädä pituus',
  ...
  'fabric.editor.block.menu.copy.content': 'Kopioi sisältö',
  'fabric.editor.block.menu.copy.link': 'Kopioi linkki',
  'fabric.editor.block.menu.copy.link.to.block': 'Kopioi estettävä linkki',
  'fabric.editor.block.menu.copy.synced.block': 'Kopioi synkronoitu lohko',
  'fabric.editor.block.menu.create.synced.block': 'Luo synkronisoitu lohko',
  'fabric.editor.block.menu.decision': 'Päätös',
  'fabric.editor.block.menu.delete.block': 'Poista',
  'fabric.editor.block.menu.layout': 'Asettelu',
  'fabric.editor.block.menu.link.copied.to.clipboard': 'Linkki kopioitu leikepöydälle',
  'fabric.editor.block.menu.move.down': 'Siirrä alas',
  'fabric.editor.block.menu.move.up': 'Siirrä ylös',
  'fabric.editor.block.menu.new.lozenge': 'Uusi',
  'fabric.editor.block.menu.paragraph': 'Kappale',
  'fabric.editor.block.menu.turn.into': 'Muuta elementiksi',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': 'Siirrä vetämällä {br} Avaa valikko napsauttamalla',
  ...
  'fabric.editor.breakout.resizeExpand': 'Muuta laajennuksen kokoa',
  'fabric.editor.breakout.resizeLayout': 'Muuta asettelun kokoa',
  'fabric.editor.breakoutFullWidthLabel': 'Täysi leveys',
  'fabric.editor.breakoutMaxWidthLabel': 'Enimmäisleveys',
  ...
  'fabric.editor.contextPanel.panelContentLabel': 'Vieritettävä kontekstipaneelin sisältö',
  ...
  'fabric.editor.copySyncBlockTooltip': 'Kopioi viittaus leikepöydälle',
  ...
  'fabric.editor.createSyncBlockLabel': 'Luo synkronisoitu lohko',
  ...
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, one {Tämän sisällön poistaminen poistaa myös synkronoidun lohkon. Viittaukset tähän lohkoon muissa paikoissa antavat virheen. Jatketaanko poistoa?} other {Tämän sisällön poistaminen poistaa myös {syncBlockCount,number} synkronoitua lohkoa. Viittaukset näihin lohkoihin muissa paikoissa antavat virheen. Jatketaanko poistoa?}}',
  'fabric.editor.deleteConfirmationModalTitle': 'Olet poistamassa synkronoitua sisältöä',
  ...
  'fabric.editor.dragHandleZone': 'Aktivoi vetokahvan alue',
  ...
  'fabric.editor.editSourceTooltip': 'Siirry synkronointilohkon lähdesivulle',
  ...
  'fabric.editor.embedToBlockCardWarning': 'Näkyy korttina pienissä näytöissä',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    'Vaikutat olevan offline-tilassa. Muodosta Internet-yhteys, jotta voit luoda synkronoitua sisältöä.',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    'Vaikutat olevan offline-tilassa. Muodosta Internet-yhteys, jotta voit poistaa synkronoitua sisältöä.',
  'fabric.editor.error.description.failToEditWhenOffline':
    'Vaikutat olevan offline-tilassa. Muodosta Internet-yhteys, jotta voit muokata synkronoitua sisältöä.',
  ...
  'fabric.editor.error.title.failToEdit': 'Synkronoitua sisältöä ei voi muokata offline-tilassa',
  ...
  'fabric.editor.feedbackDialog.description': 'Kerro meille pilvieditorin käyttökokemuksestasi',
  ...
  'fabric.editor.highlight.removeColor': 'Poista väri',
  ...
  'fabric.editor.limitedModeDescription':
    'Nopeuden ja vasteajan kasvattamista varten <learnMoreLink>osaa muokkausominaisuuksista on rajoitettu</learnMoreLink>.',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'Nopeuden ja vasteajan kasvattamista varten osaa muokkausominaisuuksista on rajoitettu.',
  'fabric.editor.limitedModeTitle': 'Nopeuden parannukset',
  ...
  'fabric.editor.longEmptyNodePlaceholderPrefix': 'Näppäile',
  ...
  'fabric.editor.quickinsert.new.lozenge': 'Uusi',
  ...
  'fabric.editor.requestAccessToSyncedBlock': 'Pyydä pääsyä',
  'fabric.editor.requestAccessToSyncedBlockError': 'Jokin meni vikaan. Yritä uudelleen napsauttamalla.',
  ...
  'fabric.editor.retrySyncedBlock': 'Yritä uudelleen',
  ...
  'fabric.editor.shortEmptyNodePlaceholderSuffix': 'lisäämistä varten',
  ...
  'fabric.editor.syncBlock.toolbar.newLozenge': 'Uusi',
  'fabric.editor.syncBlockGroup': 'Synkronointilohkon tyypit',
  'fabric.editor.syncBlockPlaceholderText':
    'Lisää sisältöä ja kopioi sitten tämä synkronisoitu lohko, jotta voit käyttää sitä eri työtiloissa.',
  'fabric.editor.syncedBlock': 'Luo synkronisoitu lohko',
  'fabric.editor.syncedBlock.description': 'Eri sijaintien välillä synkronisoitava sisältö',
  'fabric.editor.syncedBlockGeneralErrorDescription': 'Jotakin meni pieleen ladattaessa tätä synkronisoitua lohkoa.',
  'fabric.editor.syncedBlockNotFoundDescription': 'Tämän synkronisoidun lohkon lataus epäonnistui.',
  ...
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    'Tämän synkronoidun lohkon lähde on sisältökohde, johon sinulla ei ole käyttöoikeutta.',
  'fabric.editor.syncedBlockPermissionDeniedHeading': 'Sinulla ei ole oikeutta tarkastella tätä synkronisoitua lohkoa',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': 'Käyttöoikeus evätty.',
  ...
  'fabric.editor.tableScrollRegion': 'Taulukon vieritysalue',
  ...
  'fabric.editor.typeAheadErrorFallbackDescription': 'Ei tuloksia saatavilla. Yritä uudelleen.',
  'fabric.editor.typeAheadErrorFallbackHeading': 'Jotain meni pieleen',
