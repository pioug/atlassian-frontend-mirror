...
export default {
  ...
  'fabric.linking.connect_unauthorised_account_description-appify':
    'Підключіть свій обліковий запис {context}, щоб співпрацювати з іншими в додатках Atlassian.',
  ...
  'fabric.linking.connect_unauthorised_account_description_no_provider-appify':
    'Підключіть свій обліковий запис, щоб співпрацювати з іншими в застосунках Atlassian.',
  ...
  'fabric.linking.follow_project_description-galaxia': 'Підпишіться, щоб отримувати сповіщення про цей простір',
  ...
  'fabric.linking.follow_project_error-galaxia':
    'Сталася помилка під час спроби підписатися на простір. Перевірте підключення або оновіть сторінку й повторіть спробу.',
  ...
  'fabric.linking.join_to_view-issue-term-refresh':
    'Можна приєднатися до {context}, щоб переглянути цей елемент завдання',
  ...
  'fabric.linking.learn_more_about_connecting_account-appify':
    'Докладніше про підключення облікового запису до застосунків Atlassian.',
  ...
  'fabric.linking.request_access_to_view-issue-term-refresh':
    'Надішліть запит на доступ до {context}, щоб переглянути цей елемент завдання',
  ...
  'fabric.linking.unfollow_project_description-galaxia':
    'Відпишіться, щоб більше не отримувати сповіщення про цей простір',
  ...
  'fabric.linking.unfollow_project_error-galaxia':
    'Сталася помилка під час спроби відписатися від простору. Перевірте підключення або оновіть сторінку й повторіть спробу.',
