...
class Example extends Component<ComponentProps, ComponentState> {
	...
	getProcessingFailedFile = () => {
		this.getFile(videoProcessingFailedId.id, videoProcessingFailedId.collectionName);
	};
	...
	render() {
		return (
			<div>
				...
				<button onClick={this.getProcessingFailedFile}>Get processing failed file</button>
