...
When it comes to implementing assistive technology friendly mechanisms to achieve the same outcomes as a drag and drop operation ("alternative flows"), there are two important pieces you will need to add.

1. A control to allow users to trigger operations
