...
export default {
  ...
  "fabric.linking.connect_unauthorised_account_description": "Effettua la connessione ad Atlassian per visualizzare maggiori dettagli sul lavoro e collaborare da un'unica posizione.",
