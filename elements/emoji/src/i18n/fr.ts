...
export default {
  ...
  "fabric.emoji.choose.file.screenReaderDescription": "Sélectionnez un fichier pour l'emoji. JPG, PNG ou GIF. Taille max : 1 Mo.",
  ...
  "fabric.emoji.select.skin.tone.ariaLabel": "Sélectionnez le phototype, {selectedTone}"
};
