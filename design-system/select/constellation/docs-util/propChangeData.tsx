...
and ActionMeta is of the type object with the following shape
  ...
  },
  {
    ...
    content: md`
      ...
      Please see the following [example](examples#creatable-select) for usage, and the react-select [docs](https://deploy-preview-2289--react-select.netlify.com/props#creatable-props) for more detailed prop information.
    `,
    packages: ['multi'],
  },
  {
