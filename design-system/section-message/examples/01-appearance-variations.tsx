		...
		<Stack space="space.200">
			<SectionMessage appearance="information" title="More">
				<Stack space="space.100">
					<Text as="p">I count the steps from one end of my island to the other</Text>
					<Text as="p">It{"'"}s a hundred steps from where I sleep to the sea</Text>
				</Stack>
			</SectionMessage>
			...
			>
				<Stack space="space.100">
					<Text as="p">And when I say I{"'"}ve learned all there is to know</Text>
