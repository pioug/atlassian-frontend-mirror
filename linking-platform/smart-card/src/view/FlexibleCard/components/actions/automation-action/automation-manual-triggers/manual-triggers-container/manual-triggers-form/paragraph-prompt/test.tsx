...
describe('Paragraph field input prompt', () => {
  test('should render correct props', () => {
    ...
    expect(paragraphInputPrompt.getByRole('textbox')).toHaveAttribute("name", userInputPrompts.variableName);
    expect(paragraphInputPrompt.getByText(userInputPrompts.displayName)).toBeInTheDocument();
    expect(paragraphInputPrompt.getByText(userInputPrompts.displayName)).toHaveAttribute("id", "testUserInput-uid1-label");
