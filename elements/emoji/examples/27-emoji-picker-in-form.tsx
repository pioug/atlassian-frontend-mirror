...
import EmojiPicker, { EmojiId, OnEmojiEvent, ResourcedEmoji } from '../src';
        ...
        >
          {({ formProps }) => (
            <form name="submit-form" {...formProps}>
              <p>
                Press enter after search emoji, form should not be submitted
                automatically.
              </p>
              <Field
                testId="input-title"
              ...
              <Field
                name="emoji"
                label="emoji"
                defaultValue={selectedEmoji?.shortName}
              >
