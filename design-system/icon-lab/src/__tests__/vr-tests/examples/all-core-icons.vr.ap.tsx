 ...
 *
 * @codegen <<SignedSource::b0de0393303b0c43845437d774d51ea2>>
...
allMediumExamples.push(createIconGroupComponent([HardwareInsightsIcon, QuestionCircleFilledIcon]));
allSmallExamples.push(
	createIconGroupComponent([HardwareInsightsIcon, QuestionCircleFilledIcon], { size: 'small' }),
);
