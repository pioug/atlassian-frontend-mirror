...
/**
 * @deprecated The legacy icon "bitbucket/pullrequests" is deprecated in favour of "@atlaskit/icon/core/pull-request" and will be removed in an upcoming major release
 * 
