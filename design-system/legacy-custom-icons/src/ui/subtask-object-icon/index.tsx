...
const SubtaskObjectIconGlyph = (props: CustomGlyphProps) => (
	<svg
		width="14"
		height="14"
		viewBox="0 0 14 14"
...
/**
 * __SubtaskObjectIcon__
 */
const SubtaskObjectIcon = ({ label, primaryColor, secondaryColor, size, testId }: IconProps) => (
	<Icon
		label={label}
		...
		size={size}
		testId={testId}
		glyph={SubtaskObjectIconGlyph}
	/>
);

export default SubtaskObjectIcon;
