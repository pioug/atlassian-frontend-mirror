import { getExampleUrl, loadPage, type PuppeteerPage } from '@atlaskit/visual-regression/helper';
...
describe('Snapshot Test', () => {
	...
	it.each(['light', 'dark', 'none'] as const)(
		...
		async (theme) => {
			const url = getExampleUrl('design-system', 'flag', 'all-flags', global.__BASEURL__, theme);
	...
	it('shows up the focus ring on the button', async () => {
		const url = getExampleUrl('design-system', 'flag', 'all-flags', global.__BASEURL__);
	...
	it('Flag with long title should match production example', async () => {
		const url = getExampleUrl('design-system', 'flag', 'flag-long-title', global.__BASEURL__);
	...
	it('Flag with long content should match production example', async () => {
		const url = getExampleUrl('design-system', 'flag', 'flag-long-content', global.__BASEURL__);
