...
## Usage
Use a progress tracker to guide users through steps or actions across multiple screens, in order to complete a task. Progress tracker tasks must have 3 or more steps. The tracker shows users where they are in the process, and can be used to navigate through the process by selecting steps.

#### Use:
- use a progress tracker to guide users through steps or actions across multiple screens, in order to complete a task 
- progress tracker tasks must have 3 or more steps 
...
## Best practices
- use labels that clearly indicate the purpose of the step. When writing, keep options to a single line of text, be short and concise (1-2 words), and follow the [writing guidelines](https://atlassian.design/guidelines/product/foundations/writing-style)
...
## Related
Use a [progress indicator](https://atlassian.design/guidelines/product/components/progress-indicators) to shows the user where they are in a journey.