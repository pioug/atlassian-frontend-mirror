...
<SectionMessage
	...
	appearance="warning"
>
	The motion added into Popup is in Early Access. The motion updates are currently behind the feature flag: platform-dst-motion-uplift.
</SectionMessage>
...
<Example
	Component={PopupPlacementExample}
	packageName="@atlaskit/popup"
	featureFlagSwitchers={['motion']}
/>
...
<Example
	Component={PopupMultipleExample}
	packageName="@atlaskit/popup"
	featureFlagSwitchers={['motion']}
/>
...
<Example
	Component={PopupContentUpdateExample}
	packageName="@atlaskit/popup"
	featureFlagSwitchers={['motion']}
/>
...
<Example
	Component={PopupWithRoleExample}
	packageName="@atlaskit/popup"
	featureFlagSwitchers={['motion']}
/>
