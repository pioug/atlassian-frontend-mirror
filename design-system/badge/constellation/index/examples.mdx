...
import BadgeNewBold from '../../examples/constellation/badge-new-bold';
...
<Example
	Component={BadgeNewMaxValueDisabled}
	packageName="@atlaskit/badge"
	featureFlagDefaults={{ 'platform-dst-lozenge-tag-badge-visual-uplifts': true }}
/>
