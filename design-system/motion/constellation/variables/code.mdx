---
title: Variables
description: A set of legacy duration and curves variables to apply motion in your application.
order: 0
---
...
<table>
	...
	<tbody>
		...
		<tr style="vertical-align: top;">
			...
			<td>
				A user clicks an element, and that same element moves. <br />A drawer appears from off
				screen.
			</td>
			<td>
