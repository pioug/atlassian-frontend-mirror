      ...
      if (event.key === 'ArrowRight') {
        ...
        setSize(prevSize => {
          ...
          return {
            ...
            row: moveToNextRow
              ? (prevSize.row % prevSize.maxRow) + 1
              : prevSize.row,
            maxRow: getMaxRow(prevSize, event.key),
          };
        });
