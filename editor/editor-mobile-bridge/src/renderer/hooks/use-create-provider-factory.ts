...
import { type Providers, ProviderFactory } from '@atlaskit/editor-common/provider-factory';
...
export function useCreateProviderFactory(
	...
	const { current: taskDecisionProvider } = useRef(createTaskDecisionProvider(handleToggleTask));
