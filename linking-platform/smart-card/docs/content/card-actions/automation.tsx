...
Automation action is maintained by [#manual-triggers-in-smart-links](https://atlassian.enterprise.slack.com/archives/C06DZP552RL)

**Components:** [hover card](./hover-card), [flexible card](./flexible-card)
