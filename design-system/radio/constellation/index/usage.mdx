...
In most situations where you want to present a list of radio options, you'll use a [radio group](/components/radio/radio-group/examples).
...
- Long lists of options. If you have a large number of options to choose from, use the [select component](/components/select/examples).
...
- For a list of options where people can select multiple answers, use [checkbox](/components/checkbox).
