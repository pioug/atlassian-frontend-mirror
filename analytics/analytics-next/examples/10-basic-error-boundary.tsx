	...
	return (
		<AnalyticsListener channel="atlaskit" onEvent={handleEvent}>
			...
			>
				<>
					<p>
						This example simulates a JS error in one of the children components of
						`AnalyticsErrorBoundary`. To check that in action, please open your DevTools, click in
						the button and check the console for the event track.
					</p>
