...
import badgeDo2BoldLight from './images/badge-do-2-bold-light.png';
import badgeDo2BoldDark from './images/badge-do-2-bold-dark.png';
import badgeDont2BoldLight from './images/badge-dont-2-bold-light.png';
import badgeDont2BoldDark from './images/badge-dont-2-bold-dark.png';
...
<DoDontGrid>
	<DoDont
		type="do"
		image={{
			url: badgeDo2BoldLight,
			urlDarkMode: badgeDo2BoldDark,
			alt: 'A bold danger badge showing a notification count of 3 in a top navigation bar, where high visual prominence is needed',
		}}
	>
	...
	<DoDont
		type="dont"
		image={{
			url: badgeDont2BoldLight,
			urlDarkMode: badgeDont2BoldDark,
			alt: 'Bold badges used on secondary elements alongside lozenges in a list, where the added prominence is unnecessary',
		}}
	>
...
- For non-numeric information such as status and other high importance attributes with dropdown
  interactivity, use a [lozenge dropdown trigger](/components/lozenge/lozenge-dropdown-trigger).
- To descriptive metadata and information, use a [tag](/components/tag).
