...
![A drag preview of a list item with an offset](/images/design-drag-preview-offset.png)

Cards are to be dragged from the point they're grabbed from (no offset).

![A drag preview of a card with no offset](/images/design-drag-preview-no-offset.png)
...
A background color change is used to communicate that an item will be placed within a particular droppable area. Background color changes should be used when there are multiple possible areas of the page a draggable item can be dropped on.
...
Be sure to see our [accessibility guide](/pragmatic-drag-and-drop/accessibility/)
...
- [Accessibility guide](/pragmatic-drag-and-drop/accessibility/)]
