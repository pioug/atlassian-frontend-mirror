...
- **Drag source**: The entity that is dragging. These can be internal to a page (eg a `draggable` from the [element adapter]('./element-adapter.md)) or external (eg a [file]('./file-adapter.md'))
