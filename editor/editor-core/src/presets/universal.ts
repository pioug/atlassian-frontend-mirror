...
export default function createUniversalPreset(
  ...
  const finalPreset = defaultPreset
    ...
    .maybeAdd(
      [textColorPlugin, props.allowTextColor],
      Boolean(props.allowTextColor),
    )
    .add(listPlugin)
    ...
    .maybeAdd(
      [helpDialogPlugin, !!props.legacyImageUploadProvider],
      Boolean(props.allowHelpDialog),
    )
    .maybeAdd(
      [saveOnEnterPlugin, props.onSave],
      Boolean(props.saveOnEnter && props.onSave),
    )
      ...
      [
        collabEditPlugin,
        {
          ...
          EXPERIMENTAL_allowInternalErrorAnalytics:
            props.collabEdit?.EXPERIMENTAL_allowInternalErrorAnalytics ??
            shouldForceTracking(),
        },
      ],
    ...
    .maybeAdd(
      [maxContentSizePlugin, props.maxContentSize],
      Boolean(props.maxContentSize),
    )
    .maybeAdd(
      [
        panelPlugin,
        {
          useLongPressSelection: false,
          allowCustomPanel:
            typeof props.allowPanel === 'object'
              ? props.allowPanel.allowCustomPanel
              : false,
          allowCustomPanelEdit:
            typeof props.allowPanel === 'object'
              ? props.allowPanel.allowCustomPanelEdit
              : false,
        },
      ],
    ...
    .maybeAdd(
      [
        ...
        {
          weekStartDay:
            typeof props.allowDate === 'object'
              ? props.allowDate.weekStartDay
              : undefined,
        },
      ],
