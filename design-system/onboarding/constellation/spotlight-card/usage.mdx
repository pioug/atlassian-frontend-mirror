...
- For an onboarding modal, see [benefits modal](/components/onboarding/benefits-modal/examples).
- See more in our
  [first impressions patterns](/components/onboarding/usage#first-impressions-patterns).
