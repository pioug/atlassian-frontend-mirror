...
export default {
  ...
  'feedback-collector.can-be-contacted.label-appify-without-link':
    'Kyllä, Atlassian-tiimit voivat ottaa minuun yhteyttä ja pyytää lisätietoja kokemuksistani Atlassian-sovellusten ja ‑palveluiden parantamista varten. Hyväksyn Atlassianin tietosuojakäytännön.',
  'feedback-collector.can-be-contacted.label-without-link':
    'Kyllä, Atlassian-tiimit voivat ottaa minuun yhteyttä ja pyytää lisätietoja kokemuksistani Atlassian-tuotteiden ja ‑palveluiden parantamista varten. Hyväksyn Atlassianin tietosuojakäytännön.',
  ...
  'feedback-collector.privacy-policy': 'Atlassianin tietosuojakäytäntö',
