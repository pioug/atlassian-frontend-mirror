...
<SectionMessage appearance="discovery" title="New" icon={PremiumIcon}>
	Small icons are now available, providing a fully downscaled set of icons. <strong>These replace utility icons</strong>, which will soon be deprecated.
</SectionMessage>

Icons are also available at a smaller size for visual alignment in small spaces. Because the
size is smaller and harder to read, they should be used sparingly, such as for chevrons in buttons and menus.
...
<SectionMessage appearance="warning" title="Soon to be deprecated">
	Utility icons are being deprecated in favor of core icons, which will now support a new <inlineCode>size</inlineCode> prop set to <inlineCode>small</inlineCode>. This change aligns with design requirements for a greater variety of smaller-sized icons. Consequently, <strong>all icons will now be available in this smaller size</strong> instead of a limited selection.
</SectionMessage>
