...
The `CURRENT_SURFACE_CSS_VAR` constant is the CSS custom property name for accessing the 'current surface' value. This is exported to enable the current surface CSS custom property to be set.
