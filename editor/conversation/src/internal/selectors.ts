...
export const getComments = (state: State, conversationId: string, parentId?: string): Comment[] => {
...
export const getHighlighted = (state: State): string | undefined => state.highlighted;
