...
export default {
  ...
  'linkDataSource.basic-filter.project.searchPlaceholder-galaxia': 'Pretražite prostore',
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Proverite svoju vezu i osvežite ili <a>otvorite ovaj Jira prostor u Confluence</a> radi pregleda.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Povežite svoj {providerName} nalog da biste sarađivali na radu u svim Atlassian aplikacijama.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Proverite svoju vezu i osvežite ili <a>otvorite ovaj prostor u Jira</a> radi pregleda.',
