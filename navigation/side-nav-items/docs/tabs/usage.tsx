...
${(
		<DoDontGrid>
			...
			>
				Use{' '}
				<Link href="/packages/navigation/side-nav-items?tab=code#containeravatar">ContainerAvatar</Link>{' '}
			...
			>
				Don't use <Link href="https://atlassian.design/components/avatar">regular avatar</Link> in side
				nav menu items.
			</DoDont>
		</DoDontGrid>
	)}
