...
const { svgCar, svgOpenWeb, svgAjDigitalCamera, svgAtom } =
...
const Example = ({ identifiers }: { identifiers: FileIdentifier[] }) => {
  const { options, defaultOption, identifier, setIdentifier } =
    useSelectOptions(identifiers);
...
export default function () {
  const [{ MockedMediaClientProvider }, identifiers] =
