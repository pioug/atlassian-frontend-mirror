...
export default {
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Tarkista yhteys ja päivitä sivu tai <a>avaa tämä Jira-työtila Confluencessa</a> tarkastelua varten.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Yhdistä palvelun {providerName} tilisi ja tee yhteistyötä eri Atlassian-sovelluksissa.',
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    'Yritä hetken päästä uudelleen. Tarkista tila-asetukset tai ota yhteyttä tukeen, jos ongelma jatkuu.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Tarkista yhteys ja päivitä sivu tai <a>avaa tämä työtila Jirassa</a> tarkastelua varten.',
