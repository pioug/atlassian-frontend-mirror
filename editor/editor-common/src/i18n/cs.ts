...
export default {
  ...
  'editor.trackChanges.removed': 'Odstraněno',
  'editor.trackChanges.toolbarIconLabel': 'Zobrazit změny',
  'fablric.editor.viewAllInserts': 'Zobrazit všechny vložky',
  'fabric.editor.accessToSyncedBlockRequested': 'Bylo požádáno o přístup',
  ...
  'fabric.editor.ai.config.item.changeTone.adjustLengthNestingParentShortTitle': 'Délka',
  'fabric.editor.ai.config.item.changeTone.adjustLengthNestingParentTitle': 'Upravit délku',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'Vylepší odpověď na základě požadavků podobných tomu, na kterém právě pracujete.',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': 'Navrhnout odpověď',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint': 'Napište pomocí Rovo nebo vyberte níže.',
  'fabric.editor.ai.config.item.generateEscalationNotes.description':
    'Vygeneruje poznámky k eskalaci na základě kontextu požadavku.',
  'fabric.editor.ai.config.item.generateEscalationNotes.title': 'Vygenerovat poznámky k eskalaci',
  ...
  'fabric.editor.ai.experience.adfStreamingError': 'Omlouváme se, ale nepodařilo se získat odpověď.',
  'fabric.editor.ai.experience.aifcAdfStreamingError': 'Omlouváme se, ale nepodařilo se získat odpověď.',
  'fabric.editor.ai.experience.aifcApiError': 'Došlo k neznámé chybě.',
  'fabric.editor.ai.experience.aifcApiErrorRetry': 'Došlo k neznámé chybě. Znovu načtěte stránku a opakujte akci.',
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    'Obsah zřejmě nedodržuje <link>zásady přijatelného používání</link>.',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    'Váš obsah obsahuje odkazy na obsah, který podléhá omezením HIPAA. Odeberte odkazy a zkuste to znovu.',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    'K dokončení vaší žádosti je potřeba více obsahu. Vyberte více obsahu a zkuste to znovu.',
  'fabric.editor.ai.experience.aifcInternalServerError':
    'Omlouváme se, ale nepodařilo se získat odpověď. Zkuste to znovu za 5 minut nebo <link>zkontrolujte stav Rovo</link>.',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    'Dosáhli jste <link>maximálního počtu žádostí</link>. Zkuste to znovu za 5 minut.',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'Příliš mnoho obsahu na zpracování. Vyberte méně obsahu a zkuste to znovu.',
  ...
  'fabric.editor.ai.experience.dialogAriaLabel': 'Dialog Atlassian Intelligence',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': 'Zrušit žádost a zahodit odpověď?',
  ...
  'fabric.editor.ai.toolbar.DefineDropdownIconTitle.title': 'Definovat',
  ...
  'fabric.editor.block.menu.copy.content': 'Kopírovat obsah',
  'fabric.editor.block.menu.copy.link': 'Kopírovat odkaz',
  'fabric.editor.block.menu.copy.link.to.block': 'Zkopírovat odkaz na blok',
  'fabric.editor.block.menu.copy.synced.block': 'Kopírovat synchronizovaný blok',
  'fabric.editor.block.menu.create.synced.block': 'Vytvořit synchronizovaný blok',
  'fabric.editor.block.menu.decision': 'Rozhodnutí',
  'fabric.editor.block.menu.delete.block': 'Odstranit',
  'fabric.editor.block.menu.layout': 'Rozvržení',
  'fabric.editor.block.menu.link.copied.to.clipboard': 'Odkaz zkopírován do schránky',
  'fabric.editor.block.menu.move.down': 'Posunout dolů',
  'fabric.editor.block.menu.move.up': 'Posunout nahoru',
  'fabric.editor.block.menu.new.lozenge': 'Nové',
  'fabric.editor.block.menu.paragraph': 'Odstavec',
  'fabric.editor.block.menu.turn.into': 'Proměnit na',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': 'Přetažením přesuňte {br} Kliknutím otevřete nabídku',
  ...
  'fabric.editor.breakoutMaxWidthLabel': 'Maximální šířka',
  ...
  'fabric.editor.contextPanel.panelContentLabel': 'Posouvatelný obsah kontextového panelu',
  ...
  'fabric.editor.copySyncBlockTooltip': 'Kopírovat odkaz do schránky',
  ...
  'fabric.editor.createSyncBlockLabel': 'Vytvořit synchronizovaný blok',
  ...
  'fabric.editor.datePickerOpenedAlert':
    'Bylo otevřeno vyskakovací okno editoru kalendářního data, stisknutím klávesy Tab k němu přejdete.',
  ...
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, one {Odstranění tohoto obsahu odebere také synchronizovaný blok. Odkazy na tento blok v jiných umístěních zobrazí chybu. Pokračovat v odstranění?} few {Odstranění tohoto obsahu odebere také {syncBlockCount,number} synchronizované bloky. Odkazy na tyto bloky v jiných umístěních zobrazí chybu. Pokračovat v odstranění?} many {Odstranění tohoto obsahu odebere také {syncBlockCount,number} synchronizovaného bloku. Odkazy na tyto bloky v jiných umístěních zobrazí chybu. Pokračovat v odstranění?} other {Odstranění tohoto obsahu odebere také {syncBlockCount,number} synchronizovaných bloků. Odkazy na tyto bloky v jiných umístěních zobrazí chybu. Pokračovat v odstranění?}}',
  'fabric.editor.deleteConfirmationModalTitle': 'Chystáte se odstranit synchronizovaný obsah',
  ...
  'fabric.editor.dragHandleZone': 'Aktivovat zónu úchytu k přetažení',
  ...
  'fabric.editor.editSourceTooltip': 'Přejít na zdrojovou stránku bloku synchronizace',
  ...
  'fabric.editor.embedToBlockCardWarning': 'Zobrazuje se jako karta na malých obrazovkách',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    'Zdá se, že jste offline. Chcete-li vytvořit synchronizovaný obsah, připojte se k internetu.',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    'Zdá se, že jste offline. Chcete-li odstranit synchronizovaný obsah, připojte se k internetu.',
  'fabric.editor.error.description.failToEditWhenOffline':
    'Zdá se, že jste offline. Chcete-li upravit synchronizovaný obsah, připojte se k internetu.',
  ...
  'fabric.editor.error.title.failToEdit': 'Synchronizovaný obsah nelze upravit offline',
  ...
  'fabric.editor.limitedModeDescription':
    'Pro zvýšení rychlosti a doby odezvy <learnMoreLink>jsou některé funkce úprav omezené</learnMoreLink>.',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'Pro zvýšení rychlosti a doby odezvy jsou některé funkce úprav omezené.',
  'fabric.editor.limitedModeTitle': 'Vylepšení rychlosti',
  ...
  'fabric.editor.quickinsert.new.lozenge': 'Nové',
  ...
  'fabric.editor.requestAccessToSyncedBlock': 'Požádat o přístup',
  'fabric.editor.requestAccessToSyncedBlockError': 'Něco se pokazilo. Zkuste kliknout znovu.',
  ...
  'fabric.editor.retrySyncedBlock': 'Zkusit znovu',
  ...
  'fabric.editor.shortEmptyNodePlaceholderSuffix': 'k vložení',
  ...
  'fabric.editor.statusPickerOpenedAlert':
    'Bylo otevřeno vyskakovací okno editoru stavu, stisknutím klávesy Tab k němu přejdete.',
  ...
  'fabric.editor.syncBlock.toolbar.newLozenge': 'Nové',
  'fabric.editor.syncBlockGroup': 'Typy bloků synchronizace',
  'fabric.editor.syncBlockPlaceholderText':
    'Přidejte obsah a poté zkopírujte tento synchronizovaný blok, abyste k němu měli přístup napříč prostory.',
  'fabric.editor.syncedBlock': 'Vytvořit synchronizovaný blok',
  'fabric.editor.syncedBlock.description': 'Synchronizace obsahu na více místech',
  'fabric.editor.syncedBlockGeneralErrorDescription': 'Při načítání tohoto synchronizovaného bloku se vyskytl problém.',
  'fabric.editor.syncedBlockNotFoundDescription': 'Načtení tohoto synchronizovaného bloku se nezdařilo.',
  ...
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    'Zdrojem tohoto synchronizovaného bloku je položka obsahu, ke které nemáte přístup.',
  'fabric.editor.syncedBlockPermissionDeniedHeading': 'K zobrazení tohoto synchronizovaného bloku nemáte oprávnění',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': 'Oprávnění bylo zamítnuto.',
  ...
  'fabric.editor.tableScrollRegion': 'Oblast posouvání tabulky',
  ...
  'fabric.editor.taskList': 'Seznam úloh',
  ...
  'fabric.editor.typeAheadErrorFallbackDescription': 'Nejsou k dispozici žádné výsledky. Zkuste to znovu.',
