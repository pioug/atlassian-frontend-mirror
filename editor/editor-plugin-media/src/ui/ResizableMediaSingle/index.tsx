...
export default class ResizableMediaSingle extends React.Component<Props, State> {
	...
	private displayGrid = (visible: boolean, gridType: GridType, highlight: number[] | string[]) => {
	...
	calcNewSize = (newWidth: number, stop: boolean) => {
		...
		let newLayout: MediaSingleLayout = hasParentNodeOfType(state.schema.nodes.table)(
			state.selection,
		)
			? layout
