...
import { ContextualSurvey, type OnDismissArgs, SurveyMarshal } from '../src/new';
			...
			<SurveyMarshal shouldShow={showSurvey}>
				{() => (
					<ContextualSurvey
						...
						question="How much do you love using Confluence?"
						onDismiss={onDismiss}
						scoreSubtext={['Strongly disagree', 'Neutral', 'Strongly agree']}
