...
export default {
  ...
  'fabric.editor.colorPicker.menuLabel': 'Menu del selettore colori',
  ...
  'fabric.editor.datePickerOpenedAlert':
    "Finestra a comparsa dell'editor della data aperta; premi Tab per accedere alla finestra a comparsa",
  ...
  'fabric.editor.imageBorderColor.dropdownAriaLabel': "Menu a discesa Colore nelle opzioni per il bordo dell'immagine",
  ...
  'fabric.editor.imageBorderSize.dropdownAriaLabel':
    "Menu a discesa Dimensioni nelle opzioni per il bordo dell'immagine",
