 ...
 */
export { AddContainerCard } from './ui/team-containers/add-container-card';
/**
 * @deprecated Use `import { TeamLinkCard } from '@atlaskit/teams-public/next/team-link-card'` instead.
 */
