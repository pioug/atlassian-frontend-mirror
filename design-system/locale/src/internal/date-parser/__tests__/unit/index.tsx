...
describe('date-parser', () => {
	describe('Invalid Dates', () => {
		...
		it.each([['potato'], ['13/'], ['13/1'], ['2/30']])('parseDate(%s)', (dateString) => {
	...
	describe('Localization', () => {
		...
		it.each([
		...
		])('createDateParser(%s)(%s)', (locale, inputDateString, formatDateString) => {
			// @ts-ignore
			Intl = {
				DateTimeFormat: () => {
					return {
			...
			expect(createDateParser(locale)(inputDateString)).toEqual(DATE_INVARIANT);
		});
	});
});
