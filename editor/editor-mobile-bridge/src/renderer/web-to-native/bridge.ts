...
export interface AnnotationBridge {
	onAnnotationClick(annotationClickPayload?: Serialized<AnnotationPayloadsByType[]>): void;

	onAnnotationClickWithRect(
		annotationClickWithGeometryPayload?: Serialized<AnnotationWithRectPayloadsByType[]>,
	): void;

	fetchAnnotationStates(annotations: Serialized<AnnotationPayloadsByType[]>): void;
