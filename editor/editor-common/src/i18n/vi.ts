...
export default {
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'Nâng cao câu trả lời dựa trên các vấn đề tương tự với vấn đề bạn đang gặp phải',
  ...
  'fabric.editor.ai.config.item.generateEscalationNotes.description':
    'Tạo ghi chú báo cáo lên trên dựa trên bối cảnh vấn đề',
  ...
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    'Nội dung không tuân thủ <link>Chính sách sử dụng được chấp nhận</link> của chúng tôi.',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    'Nội dung của bạn chứa các liên kết đến nội dung bị hạn chế theo HIPAA. Hãy xóa các liên kết và thử lại.',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    'Cần thêm nội dung để hoàn tất yêu cầu của bạn. Vui lòng chọn thêm nội dung và thử lại.',
  'fabric.editor.ai.experience.aifcInternalServerError':
    'Rất tiếc, chúng tôi không nhận được phản hồi. Hãy thử lại sau 5 phút hoặc <link>kiểm tra trạng thái của Rovo</link>.',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    'Bạn đã đạt <link>số lượng yêu cầu tối đa</link>. Hãy thử lại sau 5 phút.',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'Có quá nhiều nội dung cần xử lý. Hãy chọn ít nội dung hơn và thử lại.',
  ...
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, other {Việc xóa nội dung này sẽ xóa cả {syncBlockCount,number} khối đã đồng bộ. Thông tin tham chiếu đến các khối này ở vị trí khác sẽ hiển thị lỗi. Bạn có tiếp tục xóa không?}}',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    'Có vẻ như bạn đang ngoại tuyến. Vui lòng kết nối với Internet để tạo nội dung đồng bộ.',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    'Có vẻ như bạn đang ngoại tuyến. Vui lòng kết nối với Internet để xóa nội dung đồng bộ.',
  'fabric.editor.error.description.failToEditWhenOffline':
    'Có vẻ như bạn đang ngoại tuyến. Vui lòng kết nối với Internet để sửa nội dung đồng bộ.',
  ...
  'fabric.editor.limitedModeDescription':
    'Để tăng tốc độ và thời gian phản hồi, <learnMoreLink>một số tính năng chỉnh sửa sẽ bị hạn chế</learnMoreLink>.',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'Để tăng tốc độ và thời gian phản hồi, một số tính năng chỉnh sửa sẽ bị hạn chế.',
  ...
  'fabric.editor.syncBlockPlaceholderText':
    'Thêm nội dung sau đó sao chép khối được đồng bộ hóa này để truy cập trên các không gian',
  ...
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    'Nguồn của khối đã đồng bộ này là một mục nội dung mà bạn không có quyền truy cập.',
