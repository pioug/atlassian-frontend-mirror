...
Time picker is commonly used in [forms](/components/form).
...
- If you need to specify date and time, see [date time picker](/components/datetime-picker).
- If you need to specify date only, see [date picker](/components/datetime-picker/date-picker).
