...
-   [#24004](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/24004)
    [`8d2ea17980d`](https://bitbucket.org/atlassian/atlassian-frontend/commits/8d2ea17980d) -
...
-   [#16651](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/16651)
    ...
    removes the preventDefault functionality (reverts it back to the previous version of inline
    dialog where event listeners were added in the capture phase). It also refactors
    handleClickOutside so that it is now triggered by a ref.
...
-   [#15105](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/15105)
    ...
    while the click event was still happening. This meant that if the open state was outside of
    inline dialog, there were instances where it failed to open.
...
-   [#14723](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/14723)
    ...
    issue where enzyme is unable to access component name in snapshot tests. There should be no UI
    or UX change.
...
-   [#14608](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/14608)
    [`0e89e593547`](https://bitbucket.org/atlassian/atlassian-frontend/commits/0e89e593547) - Fixes
    a bug where the dialog was retaining its window click event listener even after the dialog was
    closed.
...
-   [`caec2cee6e0`](https://bitbucket.org/atlassian/atlassian-frontend/commits/caec2cee6e0) -
    Removes `styled-components` dependency from the package. Also uses ThemeV2 API now. There should
    be no visual or UX change.
...
-   [patch][d296df8](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/d296df8" d):
    ...
    -   Inline-dialog now has useCapture: true for the outside click event listeners to avoid
        closing when clicking on child content that might disappear, such as a select or
        dropdown-menu
