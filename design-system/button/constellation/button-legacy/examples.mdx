...
Use a `primary` button to call attention to an action on a [form](/components/form) or to highlight
the strongest call to action on a page. Primary buttons should only appear once per container (not
including the application header or in a [modal dialog](/components/modal-dialog)). Not every screen
requires a primary button.

<Example
	Component={LegacyButtonPrimary}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LegacyButtonSubtleLink}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
[usage guidelines](/components/button/button-legacy/usage#do-not-put-tooltips-on-disabled-buttons).

<Example
	Component={LegacyButtonDisabled}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LegacyButtonSelected}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LegacyButtonFullWidth}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LegacyButtonWithIconAfter}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LegacyButtonWithIconOnly}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
