...
differentiate links from regular text, which makes them more accessible. Using color alone isn't
clear to some users, especially if links are surrounded by other text.
