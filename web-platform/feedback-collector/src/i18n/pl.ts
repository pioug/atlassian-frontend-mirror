...
export default {
  ...
  'feedback-collector.can-be-contacted.label-appify-without-link':
    'Tak, zespoły Atlassian mogą się ze mną kontaktować, aby poznać moją opinię i na jej podstawie ulepszać aplikacje oraz usługi Atlassian. Potwierdzam, że znam Politykę prywatności Atlassian.',
  'feedback-collector.can-be-contacted.label-without-link':
    'Tak, zespoły Atlassian mogą się ze mną kontaktować, aby poznać moją opinię i na jej podstawie ulepszać produkty oraz usługi Atlassian. Potwierdzam, że znam Politykę prywatności Atlassian.',
  ...
  'feedback-collector.privacy-policy': 'Polityka prywatności Atlassian',
