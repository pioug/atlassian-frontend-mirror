 ...
 *
 * @codegen <<SignedSource::2051f9cb45b4577c00070804cb54a9a6>>
...
export default {
	...
	'rovo.background.brand.bold': 'inverse',
	'rovo.background.brand.bold.hovered': 'inverse',
	'rovo.background.brand.bold.pressed': 'inverse',
} as const;
