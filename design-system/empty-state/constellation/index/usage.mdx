...
[grid](/foundations/grid-beta) and [typography](/foundations/typography) foundations for more
guidelines.
...
[Atlassian voice and tone principles for empty states](/foundations/content/designing-messages/empty-state).
...
- See all writing guidelines on
  [empty state CTAs](/foundations/content/designing-messages/empty-state#call-to-action-cta).

## Related

- For more empty state guidelines and examples, see
  [empty state messaging](/foundations/content/designing-messages/empty-state).
- For very small spaces or situations where this component doesn’t fit, you may consider designing
  an empty state from scratch. See our [grid](/foundations/grid-beta) and
...
- Some error messages, such as not found errors, may also fit this component layout. If you use this
  ...
  [error message guidelines](/foundations/content/designing-messages/error-messages) and use an
