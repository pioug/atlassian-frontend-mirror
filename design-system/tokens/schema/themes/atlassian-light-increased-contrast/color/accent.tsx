...
const color: ExtendedValueSchema<AccentColorTokenSchema<BaseToken>> = {
	color: {
		...
		border: {
			accent: {
				blue: { '[default]': { value: 'Blue800' } },
				red: { '[default]': { value: 'Red800' } },
				orange: { '[default]': { value: 'Orange800' } },
				yellow: { '[default]': { value: 'Yellow800' } },
				green: { '[default]': { value: 'Green800' } },
				purple: { '[default]': { value: 'Purple800' } },
				teal: { '[default]': { value: 'Teal800' } },
				magenta: { '[default]': { value: 'Magenta800' } },
				lime: { '[default]': { value: 'Lime800' } },
				gray: { '[default]': { value: 'Neutral800' } },
			},
		},
		background: {
			accent: {
