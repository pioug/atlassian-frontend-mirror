...
- Internal dependencies: `@atlaskit/icon-file-type`, `@atlaskit/media-client`, `@atlaskit/media-client-react`, `@atlaskit/media-common`, `@atlaskit/media-state`
- 2 feature flags: `platform_media_resume_video_on_token_expiry`, `should-render-to-parent-should-be-true-media-exif`
