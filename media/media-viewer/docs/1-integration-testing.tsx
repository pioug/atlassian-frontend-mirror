...
useful to use in integration/e2e tests available in media-viewer:
...
- \`[data-testid="media-viewer-error"]\`: When media viewer can't show preview of a file, this
  component present
...
- \`[data-testid="media-viewer-image-content"]\`: Content element for image document
  - \`[data-testid="media-viewer-image"]\`: \`<img />\` with image itself. Can be found inside
    'media-viewer-image-content'
