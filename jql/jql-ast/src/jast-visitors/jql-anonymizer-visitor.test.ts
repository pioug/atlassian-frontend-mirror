...
const queries = [
  ...
  },
  {
    ...
    anonymized:
      'project = "?" and assignee = currentUser() and reporter = currentUser()',
  },
  {
    raw: 'project = jsw and assignee = currentUser() or reporter = currentUser()',
    anonymized:
      '(project = "?" and assignee = currentUser()) or reporter = currentUser()',
  },
  {
    raw: 'project = jsw and (assignee = currentUser() or reporter = currentUser())',
    anonymized:
  ...
  },
  {
    ...
    anonymized:
      'project = "?" and assignee = currentUser() ORDER BY created DESC',
  },
  {
...
describe('JQL Anonymizer', () => {
  queries.forEach(query => {
    it(query.raw, () => {
      ...
      const anonymized = ast.query
        ? ast.query.accept(jqlAnonymizer)
        : undefined;
