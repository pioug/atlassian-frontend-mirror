...
When the radio group has focus, the selection can be changed with the arrow keys. If it is `disabled`, the cursor will indicate that the user can't make a selection.
