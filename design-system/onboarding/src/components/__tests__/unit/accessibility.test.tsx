...
it('BenefitsModal should pass basic axe audit', async () => {
  const { container } = render(
    <ModalTransition>
      ...
      >
        <p>
          Check out our restructured interface and a bold, colorful design that
          reflects the vibrance of your team. Try it out early and get a chance
          to influence how we build the next generation of Atlassian.
        </p>
      </Modal>
    </ModalTransition>,
  );
