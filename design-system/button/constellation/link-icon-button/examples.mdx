...
<Example
	Component={LinkIconButtonTooltip}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LinkIconButtonPrimary}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LinkIconButtonSubtle}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LinkIconButtonSpacing}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LinkIconButtonCircle}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LinkIconButtonDisabled}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
<Example
	Component={LinkIconButtonSelected}
	packageName="@atlaskit/button"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
