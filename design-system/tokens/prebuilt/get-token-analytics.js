...
var recordTokenCall = (exports.recordTokenCall = /*#__PURE__*/ (function () {
	var _ref = (0, _asyncToGenerator2.default)(
		/*#__PURE__*/ _regenerator.default.mark(function _callee(token, fallback) {
			...
			return _regenerator.default.wrap(function _callee$(_context) {
				while (1)
					switch ((_context.prev = _context.next)) {
						case 0:
							try {
								// TODO: window.analyticsWebClient is a property specific to Jira. It is not available in the other apps. We might consider to register a dedicated analytics client for logging token calls for each app to enable cohesive experience across different apps.
								analyticsClient =
									(_window = window) === null || _window === void 0
										? void 0
										: _window.analyticsWebClient;
								if (analyticsClient) {
