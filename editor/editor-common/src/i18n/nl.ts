...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Instructies',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Specificeer de taak, instructies en regels',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Creativiteit',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Hoog',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Laag',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Bijvoorbeeld: 1. Begin het document met een kort overzicht van onze bedrijfsdoelen. 2. Maak een lijst met de belangrijkste teamleden waarmee de nieuwe werknemer in de eerste week kennis moet maken.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Geef instructies voor taken zodat er specifieke resultaten worden gegenereerd.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Bijvoorbeeld: de resultaten moeten de stijlrichtlijnen van het bedrijf volgen en mogen geen gegevens gebruiken die niet zijn geverifieerd.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Regels',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Geef een overzicht van regels die nageleefd moeten worden.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Geef een taak op',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Bijvoorbeeld: maak onboardingdocumentatie aan voor nieuwe werknemers die het team komen versterken.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Taak',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Beschrijf de taak die moet worden voltooid.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Toon',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Informeel',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Educatief',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Empathisch',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Neutraal',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Professioneel',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Maak een geavanceerde prompt',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Maak een geavanceerde prompt',
