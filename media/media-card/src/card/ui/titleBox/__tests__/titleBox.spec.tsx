...
import { asMockFunction, expectFunctionToHaveBeenCalledWith } from '@atlaskit/media-test-helpers';
import {
	TitleBoxFooter,
	TitleBoxHeader,
	TitleBoxIcon,
...
describe('TitleBox', () => {
	...
	it('should not render the footer if date is not provided', () => {
		const name = 'roberto.jpg';
		const component = shallow(<TitleBox name={name} breakpoint={Breakpoint.SMALL} />);
