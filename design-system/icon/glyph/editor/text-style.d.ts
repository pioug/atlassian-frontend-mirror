...
/**
 * @deprecated The legacy icon "editor/text-style" is deprecated in favour of "@atlaskit/icon/core/text-style" and will be removed in an upcoming major release
 * 
