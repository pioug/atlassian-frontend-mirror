...
export default {
  ...
  'fabric.editor.ai.config.item.addPolish.description':
    '⁣⁢Polishes the content to make it more polished⁮؜⁪⁠‍⁪⁭⁪‍⁪⁠⁪⁫⁪⁬⁠⁭⁮⁫⁡؜⁫⁡⁠⁡⁪⁣⁤',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint':
    '⁣⁢Write with Rovo or select from below⁫⁫⁯⁠‌؜‍‍‌‌⁫⁪⁭⁭‍⁭⁫⁯⁭⁣⁤',
  ...
  'fabric.editor.ai.experience.aifcAdfStreamingError':
    '⁣⁢Our apologies, we couldn’t get a response.⁠⁬⁭⁠‍؜⁫⁯⁠‍⁪⁮⁮⁫⁯⁯‌‌⁮⁮⁬⁡⁮‌⁡⁣⁤',
  ...
  'fabric.editor.ai.proactive.enableSuggestionsState.title.non-final':
  ...
  'fabric.editor.ai.proactive.error.unhandledErrorMessage':
    "⁣⁢We're having trouble. Close the dialog and try again.⁯⁠⁠‌⁭‍⁯؜⁠⁫⁭⁫⁠‌⁠⁮؜⁪‍⁮⁣⁤",
  'fabric.editor.ai.proactive.findingMoreSuggestionsLoadingLabel.non-final':
    '⁣⁢Finding more suggestions⁬⁠‍‍⁯⁪⁭⁡⁮⁡⁯⁮⁯‍⁡⁬⁠⁯⁯⁠⁪⁮⁣⁤',
  'fabric.editor.ai.proactive.findingSuggestionsLabel.non-final': '⁣⁢Finding suggestions⁪⁠⁬⁠⁪⁭؜⁡⁠⁮⁠‌‌⁮‍⁮⁪‌⁪⁡⁫⁭⁣⁤',
  'fabric.editor.ai.proactive.findingSuggestionsLoadingLabel.non-final':
    '⁣⁢Finding suggestions؜⁬⁬‌‍؜⁡‍⁭⁮⁮⁠‌⁪؜⁮‌‌‌‍⁯⁠⁮⁭‌؜⁣⁤',
  ...
  'fabric.editor.ai.proactive.moreMenu.manageSuggestionsTitle.non-final':
    '⁣⁢Manage suggestions⁠⁯‍⁬‌⁠‍⁮⁬⁫؜⁪⁮⁬⁮⁭؜⁯؜⁡⁯⁡⁣⁤',
  ...
  'fabric.editor.ai.proactive.moreMenu.toggleAllSuggestionsTitle.non-final':
    '⁣⁢All suggestions⁠⁪⁯⁯⁠⁬‌⁫‍⁪⁠‌⁬؜⁡⁭⁭؜⁭⁭⁡⁫⁡⁣⁤',
  'fabric.editor.ai.proactive.moreMenu.toggleErrorPanelDescription.non-final':
    '⁣⁢Transform text into a red error panel.⁬⁭⁮⁡⁬⁡⁯⁭⁯⁡⁬⁫⁠⁫؜⁭⁬⁣⁤',
  ...
  'fabric.editor.ai.proactive.moreMenu.toggleFormatParagraphTitle.non-final':
    '⁣⁢Enhance content⁯⁮‌؜⁮⁠‌‌؜⁫‌⁠⁫‍⁮⁬⁫⁯⁭⁪‌⁣⁤',
  ...
  'fabric.editor.ai.proactive.moreMenu.toggleSplitParagraphTitle.non-final':
    '⁣⁢Paragraph break؜⁬⁪⁯⁪⁭⁬‍⁮⁪‍‍‍⁫⁠‌⁯⁡؜⁬‌‍⁡⁣⁤',
  ...
  'fabric.editor.ai.proactive.moreMenu.toggleWarningPanelTitle.non-final':
    '⁣⁢Warning panel⁠⁯‌‍؜⁬⁭⁮⁮⁯⁫⁬⁫⁫⁪؜⁭⁭⁫⁫⁬⁬⁭⁭‌⁠⁣⁤',
  ...
  'fabric.editor.ai.proactive.noSuggestionsState.title.non-final':
    '⁣⁢Suggestions will appear here⁭⁯‌⁮‍⁬؜؜⁡⁮⁡‌⁯⁭⁬⁬⁫⁡⁫؜⁣⁤',
  'fabric.editor.ai.proactive.preview.dismissProactiveRecommendation.non-final':
    '⁣⁢Dismiss⁮⁭⁡‌⁡⁫⁡⁮‍‌⁫؜⁮؜⁪‌؜؜‍⁯‍⁪⁫‌⁬⁮⁠⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.convertToErrorPanel.title.non-final':
    '⁣⁢Frame with error panel‍⁮⁮⁯‍⁬⁭⁡⁯⁭⁮‍⁯⁮⁡⁭؜⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.convertToInfoPanel.title.non-final':
  ...
  'fabric.editor.ai.proactive.recommendation.convertToNotePanel.title.non-final':
    '⁣⁢Frame with note panel⁠⁫⁡⁭⁫⁬⁮⁭⁯⁯⁯⁡⁪⁫؜⁡⁮⁡⁬⁪⁭⁡⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.convertToSuccessPanel.title.non-final':
    '⁣⁢Frame with success panel⁫‍‌⁯⁪؜؜⁪⁮‌⁭⁭‌⁬⁡⁭‍⁬⁯⁬⁣⁤',
  'fabric.editor.ai.proactive.recommendation.convertToTable.description.non-final':
    '⁣⁢Format content in a table to improve readability.⁬‍⁮⁡⁪؜؜⁭؜⁪⁯؜⁡⁫⁡⁪؜⁮‌؜⁫⁮⁠⁣⁤',
  'fabric.editor.ai.proactive.recommendation.convertToTable.title.non-final':
    '⁣⁢Format in table⁬⁠⁭⁪⁭⁪⁭⁠⁯⁮⁬‌⁪‌؜⁮⁬⁮؜⁭⁯؜⁡‌⁫⁫⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.convertToWarnPanel.title.non-final':
    '⁣⁢Frame with warning panel⁯⁪⁡⁪⁭؜⁪⁫⁬⁯⁡‌⁡⁯؜‌⁮⁠‍⁡⁪⁯؜⁠⁠⁣⁤',
  'fabric.editor.ai.proactive.recommendation.default.description.non-final':
    '⁣⁢A suggestion to improve the content.؜‍⁡⁯⁬⁠؜‌⁮⁮⁮؜‍⁫⁯⁫⁯⁮⁪⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.formatParagraphClarity.title.non-final':
    '⁣⁢Clarify writing⁭⁭⁫⁮⁬⁡⁬⁬‍⁭⁪⁭‌⁪⁭⁡⁣⁤',
  'fabric.editor.ai.proactive.recommendation.formatParagraphList.description.non-final':
    '⁣⁢Turn content into a scannable list.‍⁪⁮⁬⁫⁠⁪⁮‍⁮‌‍؜⁫⁯؜‌‌⁣⁤',
  'fabric.editor.ai.proactive.recommendation.formatParagraphList.title.non-final':
    '⁣⁢Create list⁭⁫‍⁠⁪⁬⁡⁭⁫؜⁭⁬⁮‍⁮⁫⁠؜⁪⁬⁬⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.formatParagraphSpellcheck.title.non-final':
    '⁣⁢Fix spelling⁯⁭⁮⁡⁡⁯؜⁯‍⁪⁡⁮⁮⁬؜⁯؜⁬⁡⁭⁯⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.formatParagraphStructure.title.non-final':
    '⁣⁢Improve structure⁠‌؜‌⁪⁫⁮⁭⁭⁪⁫⁬‌⁡‌⁭⁣⁤',
  ...
  'fabric.editor.ai.proactive.recommendation.splitParagraph.description.non-final':
    '⁣⁢Add paragraph breaks to separate key ideas.⁡⁡⁪⁯⁪⁯⁯‍⁫‍‍⁭‌‍⁯⁯⁠⁯⁫⁣⁤',
  'fabric.editor.ai.proactive.recommendation.splitParagraph.title.non-final':
    '⁣⁢Divide paragraph⁯⁬؜‍⁫⁮⁫‍‌⁪⁮⁯؜⁠⁫⁡⁠⁪⁯⁠‍⁪‌⁯⁪⁣⁤',
  'fabric.editor.ai.proactive.reloadSuggestionsButtonLabel.non-final': '⁣⁢View past suggestions؜⁪⁮⁡⁫؜⁠⁡⁡⁬⁠⁭⁪⁪⁯‍⁡⁬⁭⁠⁬⁣⁤',
  'fabric.editor.ai.proactive.reloadSuggestionsState.description.non-final':
    '⁣⁢Any new suggestions will appear here.⁡⁯⁮⁠؜⁡‌⁪‌⁬⁡⁮؜⁪⁬⁡‍‍⁮؜⁮⁬⁡⁯⁫‍⁣⁤',
  'fabric.editor.ai.proactive.reloadSuggestionsState.title.non-final':
  ...
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, one {⁣⁢Deleting this content will also remove a synced block. References to this block in other locations will show an error. Continue with deletion?⁬‍⁬⁡⁠⁬⁫⁪؜⁫‍‌⁡⁯⁪‍⁫؜⁬⁯؜⁬⁣⁤} other {⁣⁢Deleting this content will also remove {syncBlockCount,number} synced blocks. References to these blocks in other locations will show an error. Continue with deletion?⁬‍⁬⁡⁠⁬⁫⁪؜⁫‍‌⁡⁯⁪‍⁫؜⁬⁯؜⁬⁣⁤}}',
  ...
  'fabric.editor.imageBorderColor.dropdownAriaLabel':
    '⁣⁢Image border options Color dropdown؜‌⁡‍⁫⁭⁫⁯؜⁠⁫‌⁪⁮⁭⁪⁪‍‍‌⁠⁮⁮⁯؜⁫⁡؜⁣⁤',
  ...
  'fabric.editor.media.insert.localFileNetworkErrorMessage':
    '⁣⁢File upload error. Check file path or network.⁭⁡⁭⁯⁪⁮⁪‌؜⁯⁫‍⁠⁭⁡؜‌؜⁪⁫⁪⁠‌‍⁡⁣⁤',
  ...
  'fabric.editor.requestToEditDescription':
    '⁣⁢When you request access, the page owner will receive a notification.⁯؜‍⁬⁪‌‌⁬⁬⁯⁪⁭⁠⁯⁫⁪⁠⁠⁫⁭؜⁣⁤',
  ...
  'fabric.editor.statusPickerOpenedAlert':
    '⁣⁢Status editor popup opened, press Tab to access popup⁫‌⁡⁬‌⁪‍؜⁠⁬⁪⁡؜⁭⁯⁪⁬⁯‍‌⁮⁬⁬‍⁣⁤',
  ...
  'fabric.editor.syncBlockPlaceholderText':
    '⁣⁢Add content then copy this synced block to access it across spaces⁮⁠⁬⁭⁯⁯⁡⁡⁯⁮⁪⁫⁡⁭؜⁫‍⁫⁮؜⁫⁯‌⁡⁣⁤',
  ...
  'fabric.editor.syncedBlockGeneralErrorDescription':
    '⁣⁢Something went wrong while loading this synced block.⁯⁫‌‍‌‌⁯‍‍⁬⁭؜⁮⁡⁫⁯‌⁬⁫؜⁮‍⁪⁬⁠⁣⁤',
  ...
  'fabric.editor.syncedBlockPermissionDeniedHeading':
    "⁣⁢You don't have permission to view this synced block⁪⁪⁬؜⁮⁪⁯⁫⁫⁫‍⁭؜⁯؜⁠‌⁬⁠⁡⁭⁠⁫⁣⁤",
