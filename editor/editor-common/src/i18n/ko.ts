...
export default {
  ...
  'fabric.editor.datasourceAppearanceTitle': '표',
  ...
  'fabric.editor.recordVideo.description': 'Loom을 사용하여 동영상 녹화',
  ...
  'fabric.editor.replaceSuccess':
    '{numberOfMatches, plural, other {{numberOfMatches,number}개의 일치 항목을 대체했습니다}}',
