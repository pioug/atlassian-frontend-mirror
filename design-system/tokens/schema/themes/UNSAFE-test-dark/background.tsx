...
const color: ValueSchema<BackgroundColorTokenSchema<BaseToken>> = {
	color: {
		blanket: {
			...
			// @ts-ignore temporary value (Purple500 10% opacity)
			selected: { value: '#8F7EE71A' },
		...
		background: {
			...
			brand: {
				subtlest: {
					...
					hovered: { value: 'Magenta900' },
					pressed: { value: 'Magenta850' },
				},
				bold: {
					'[default]': { value: 'Magenta400' },
					hovered: { value: 'Magenta300' },
					pressed: { value: 'Magenta250' },
				},
				boldest: {
					'[default]': { value: 'Magenta100' },
					hovered: { value: 'Magenta200' },
					pressed: { value: 'Magenta250' },
				},
			},
			selected: {
