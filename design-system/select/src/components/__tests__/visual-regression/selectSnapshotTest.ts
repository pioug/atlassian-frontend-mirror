...
describe('Snapshot Test', () => {
	it('Default select example should match production example', async () => {
		const url = getExampleUrl('design-system', 'select', 'single-select', global.__BASEURL__);
		const { page } = global;
	...
	it('Single Select with disabled options example should match production example', async () => {
		const url = getExampleUrl('design-system', 'select', 'disabled', global.__BASEURL__);
		const { page } = global;

		const selectSelector = '.react-select-single-disabled-options__value-container';
	...
	it('Multi Select with disabled options example should match production example', async () => {
		...
		const selectSelector = '.react-select-multi-disabled-options__value-container';
	...
	it('Checkbox Select example should match production example', async () => {
		const url = getExampleUrl('design-system', 'select', 'checkbox-select', global.__BASEURL__);
		const { page } = global;
	...
	it.skip('Select validation example should match production example', async () => {
		const url = getExampleUrl('design-system', 'select', 'validation', global.__BASEURL__);
		const { page } = global;
	...
	it('Appearances example should match production example', async () => {
		const url = getExampleUrl('design-system', 'select', 'appearance', global.__BASEURL__);
		const { page } = global;
