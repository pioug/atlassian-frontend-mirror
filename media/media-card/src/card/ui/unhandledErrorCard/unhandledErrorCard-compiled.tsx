...
export class UnhandledErrorCard extends Component<UnhandledErrorCardProps, {}> {
	render() {
		...
		return (
			// eslint-disable-next-line jsx-a11y/no-static-element-interactions, @atlaskit/ui-styling-standard/enforce-style-prop, @atlassian/a11y/interactive-element-not-keyboard-focusable, @atlassian/a11y/click-events-have-key-events
