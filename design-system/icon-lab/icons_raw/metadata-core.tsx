...
const metadata: IconMetadata = {
	...
	'ai-filter': {
		...
		createdAt: '2026-09-14T22:14:11.203Z',
	},
	...
	'arrow-up-circle': {
		...
		createdAt: '2026-05-26T05:11:35.134Z',
	},
	...
	atlassian: {
		...
		createdAt: '2026-05-25T23:18:58.901Z',
	},
	atom: {
	...
	'block-quote': {
		keywords: ['quote', 'block', 'blockquote', 'quotation'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
		...
		createdAt: '2026-08-17T04:35:11.142Z',
	},
	'block-synced': {
	...
	'calendar-unavailable': {
		keywords: ['leave', 'holiday', 'ooo', 'time off', 'out of office', 'calendar'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		...
		createdAt: '2026-07-20T21:57:03.085Z',
	},
	capability: {
	...
	carousel: {
		keywords: ['Carousel', 'Images', 'Slider'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'cloud-fortified': {
		keywords: ['Cloud fortified', 'trust', 'program', 'security', 'badge'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
	...
	'curve-ease-in': {
		keywords: ['ease in', 'ease in curve', 'motion', 'curve', 'slow start'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		...
		createdAt: '2026-08-03T22:58:21.459Z',
	},
	'curve-ease-out': {
		keywords: ['ease out', 'ease out curve', 'motion', 'curve', 'fast start'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Goals and Projects',
		status: 'published',
	...
	'curve-linear': {
		keywords: ['linear curve', 'motion', 'easing', 'curve'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Goals and Projects',
		status: 'published',
	...
	'end-call': {
		keywords: ['hang-up', 'end call', 'phone', 'call'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'CSM',
		status: 'published',
	...
	'enterprise-certified': {
		keywords: ['check', 'certified', 'marketplace', 'badge', 'AEC'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
	...
	'fire-alarm': {
		keywords: ['fire alarm', 'alert', 'klaxon'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Design System Team',
		status: 'published',
	...
	guitar: {
		keywords: ['music', 'rock and roll', 'sound', 'hold-music'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'CSM',
		status: 'published',
	...
	'hand-wave': {
		keywords: ['wave', 'hand', 'greeting', 'welcome', 'hi'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'CSM',
		status: 'published',
	...
	'hardware-assignment': {
		keywords: ['assignment', 'assigned', 'hardware', 'assign', 'display'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
	...
	'hardware-cleanse': {
		keywords: ['cleanse', 'cleanup', 'clean', 'hardware', 'display', 'tidy up'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
	...
	'hardware-insights': {
		keywords: ['device', 'insights', 'HAM', 'ITAM'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'JSM',
		status: 'published',
		...
		createdAt: '2026-09-01T10:45:35.731Z',
	},
	'hardware-new': {
	...
	headset: {
		keywords: ['voice', 'support', 'microphone', 'headphone'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'CSM',
		status: 'published',
	...
	'image-ratio-auto': {
		keywords: ['automatic ratio', 'ratio', 'ratio auto'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'image-ratio-narrow': {
		keywords: ['narrow', 'ratio narrow', 'rectangle'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'image-ratio-portrait': {
		keywords: ['portrait', 'rectangle', 'ratio portrait'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'image-ratio-wide': {
		keywords: ['wide', 'ratio wide', 'wide ratio', 'rectangle'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	lasso: {
		keywords: ['lasso', 'lassoo', 'rope', 'selection'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Design System Team',
		status: 'published',
	...
	piano: {
		keywords: ['music', 'classical', 'orchestra', 'grand', 'hold-music', 'sound'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'CSM',
		status: 'published',
	...
	'pull-quote': {
		keywords: ['quote', 'pull', 'quotation', 'pullquote'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'question-circle-filled': {
		keywords: ['help', 'question mark', 'input required', 'waiting input'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
	...
	'rovo-chat-dashed': {
		keywords: ['AI', 'temporary', 'temp chat', 'chat'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Rovo chat',
		status: 'published',
	...
	'rovo-digest': {
		keywords: ['Digest', 'Your digest', 'newspaper', 'insights', 'brief'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Rovo Growth',
		status: 'published',
	...
	'sine-wave': {
		keywords: ['audio', 'ambient', 'hold-music', 'sound', 'music'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'CSM',
		status: 'published',
	...
	'speedometer-left-down': {
		keywords: ['speed', 'performance', 'dial', 'slowest', 'risk likelihood', 'low risk'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Focus',
		status: 'published',
	...
	'speedometer-left-up': {
		keywords: ['speed', 'performance', 'dial', 'slow', 'risk likelihood', 'medium low risk'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Loom',
		status: 'published',
	...
	'speedometer-right-down': {
		keywords: ['speed', 'performance', 'dial', 'fastest', 'risk likelihood', 'high risk'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Focus',
		status: 'published',
	...
	'speedometer-right-up': {
		keywords: ['speed', 'performance', 'dial', 'fast', 'risk likelihood', 'medium high risk'],
		categorization: 'multi-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Loom',
		status: 'published',
	...
	'step-through': {
		keywords: ['Step through', 'Step', 'Line', 'AI changes'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'table-of-content': {
		keywords: ['TOC', 'Table of contents', 'index', 'contents'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
	...
	'text-review': {
		keywords: ['examine', 'text', 'review', 'AI', 'generative'],
		categorization: 'single-purpose',
		location: '@atlaskit/icon-lab',
		team: 'Editor',
		status: 'published',
		...
		createdAt: '2026-06-23T03:31:09.228Z',
	},
	'text-small': {
