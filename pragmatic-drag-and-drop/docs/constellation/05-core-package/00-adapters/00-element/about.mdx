...
- [dropTargetForElements](#drop-target-for-elements): marking an element as a valid [drop target](TODO)
- [monitorForElements](#monitor-for-elements): create a [monitor](TODO) to listen for element drag operation events anywhere.
