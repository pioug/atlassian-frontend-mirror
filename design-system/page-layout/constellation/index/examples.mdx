...
<Example Component={PageLayoutInteractive} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutIntegration} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutResizeSidebar} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutLockedSidebar} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={ExpandLeftSidebarKeyboardShortcut} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutLeftSidebarWithKeyboardExpand} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutCustomSkipLinks} appearance="source-only" packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutServerRendered} appearance="source-only" packageName="@atlaskit/page-layout" />
