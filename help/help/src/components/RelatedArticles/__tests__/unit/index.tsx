...
const relativeArticlesPromise: (numberOfItems: number) => Promise<ArticleItem[]> = (
	numberOfItems = 0,
) =>
...
const mockOnGetRelatedArticles = jest.fn().mockImplementation(relativeArticlesPromise);
