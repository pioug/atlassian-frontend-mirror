...
Modals must have a title or label available for users to understand what the modal is for. There are three ways you can ensure you have an accessible name for your modal:
