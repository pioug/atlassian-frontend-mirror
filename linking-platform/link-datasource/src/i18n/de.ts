...
//German (Germany)
export default {
  '1M7iXg': 'Editor für JQL-Abfragen',
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Überprüfen Sie Ihre Verbindung und laden Sie die Seite neu oder <a>öffnen Sie diesen Jira-Bereich in Confluence</a>, um sie zu überprüfen.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Verbinden Sie Ihr {providerName}-Konto, um an Aufgaben in sämtlichen Atlassian-Apps mitarbeiten zu können.',
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    'Bitte warten Sie ein paar Minuten und versuchen Sie es erneut. Überprüfen Sie Ihre Space-Einstellungen oder wenden Sie sich an den Support, wenn das Problem weiterhin besteht.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Überprüfen Sie Ihre Verbindung und laden Sie die Seite neu oder <a>öffnen Sie diesen Bereich in Jira</a>, um sie zu überprüfen.',
