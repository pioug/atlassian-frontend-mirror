...
- Don't use a range if choosing a _specific_ value is important. The slider interaction isn't as precise as explicitly typing or choosing an option from a list.
