...
[Button](/components/button/examples) component, add button motion tokens to the background-color
transition:
...
For a custom list item built with Pressable, use list-item motion tokens for the interactive state
transitions:
...
<PrimitivesEventTrackingHeaderSnippet componentName="pressable" />

<Example Component={PressableAnalytics} packageName="@atlaskit/primitives/compiled/pressable" />

<PrimitivesEventTrackingGasv3Snippet />
...
<PrimitivesEventTrackingUfoSnippet componentName="pressable" />
