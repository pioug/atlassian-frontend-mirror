...
Onboarding to the new Figma libraries that support design tokens is currently limited to certain Atlassian teams.
...
Atlassians employees can install the [Chrome extension](http://go/dst-theming-extension/) and 
...
- Learn how to set up and use design tokens by going to [getting started with code](/components/tokens/getting-started-in-code).
