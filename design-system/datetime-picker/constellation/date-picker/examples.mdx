...
When using the date picker with the form component, include a field label and helper text. For more information, see the [form component](/components/form/examples).
