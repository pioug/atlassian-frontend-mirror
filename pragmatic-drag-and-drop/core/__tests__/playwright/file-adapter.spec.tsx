...
test.describe('file adapter', () => {
  test('should support dropping of many files at once', async ({
    browserName,
    page,
  }) => {
    ...
    await page.visitExample('pragmatic-drag-and-drop', 'core', 'file-adapter');
    ...
    await page
      .locator('[data-drop-target-for-file]')
    ...
    await page
      .locator('[data-testid="dropped-files"]')
      .waitFor({ state: 'visible' });
