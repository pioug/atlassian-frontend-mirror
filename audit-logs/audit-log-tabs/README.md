...
`import AuditLogTabs from '@atlaskit/audit-log-tabs';`

Detailed docs and example usage can be found [here](https://atlaskit.atlassian.com/packages/audit-logs/audit-log-tabs).
