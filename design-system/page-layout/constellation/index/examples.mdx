...
<Example Component={ExpandLeftSidebarKeyboardShortcut} showcaseVisible={false} packageName="@atlaskit/page-layout" />
...
<Example Component={PageLayoutLeftSidebarWithKeyboardExpand} showcaseVisible={false} packageName="@atlaskit/page-layout" />
