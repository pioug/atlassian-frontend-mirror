...
export default {
  ...
  'fabric.media.or_select_default_avatars':
    'Загрузите фотографию или выберите элемент среди некоторых вариантов по умолчанию',
  ...
  'fabric.media.select_an_avatar_from_all_defaults': 'Выберите элемент среди всех вариантов по умолчанию',
