...
describe('isTeamsAppRoute', () => {
	test.each([
		...
		['project route on home.atlassian.com', 'https://home.atlassian.com/o/my-org/project/abc', false],
		...
		['route under /o/ without /people', 'https://home.atlassian.com/o/my-org/unknown-app/123', false],
	])('%s', (_, url, expected) => {
