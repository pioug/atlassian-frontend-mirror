...
// @public (undocumented)
type AllowedBlockTypes = 'heading' | 'blockquote' | 'hardBreak' | 'codeBlock';
...
// @public (undocumented)
type EditorProduct = 'bitbucket' | 'jira' | 'confluence' | 'stride' | undefined;
...
// @public (undocumented)
type LinkToolbarState = EditState | EditInsertedState | InsertState | undefined;
...
// @public (undocumented)
type TaskDecisionListType = 'taskList' | 'decisionList';
