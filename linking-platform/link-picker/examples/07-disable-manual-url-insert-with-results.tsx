...
/**
 * This example demonstrates `disableManualUrlInsert` and `hideDisplayText` with
 * populated search results (same as the basic example).
 *
 ...
 * list to proceed. When a result is selected, the Insert button becomes active.
 *
 * `hideDisplayText` removes the "Display text (optional)" field.
 * The custom messages update the label and placeholder to reflect that only
 * result-based links can be inserted.
 */
function DisableManualUrlInsertWithResults() {
	...
	return (
		<Fragment>
			...
			<LinkPicker
				...
				customMessages={{
					linkLabel: {
						id: 'link-picker-example.disable-manual-url-insert-with-results.link-label',
						defaultMessage: 'Search',
						description: 'Label for the search input when external link insertion is disabled',
					},
					linkPlaceholder: {
						id: 'link-picker-example.disable-manual-url-insert-with-results.link-placeholder',
						defaultMessage: 'Find recent links',
						description:
							'Placeholder for the search input when external link insertion is disabled',
					},
				}}
			/>
		</Fragment>
...
export default function DisableManualUrlInsertWithResultsWrapper(): React.JSX.Element {
	return (
		<PageWrapper>
			<DisableManualUrlInsertWithResults />
		</PageWrapper>
	);
}
