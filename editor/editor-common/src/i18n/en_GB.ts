...
export default {
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'Enhances the reply based on issues similar to the one you’re working on',
  ...
  'fabric.editor.ai.experience-application.cmdPaletteUnhandledErrorMessage':
    "We're having issues and can't generate a response right now. Try again later.",
  ...
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    'Content does not comply with our <link>Acceptable Use Policy</link>.',
  ...
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'There’s too much content to process. Select less content and try again.',
  ...
  'fabric.editor.ai.toolbar.summarize.title': 'Summarise',
  ...
  'fabric.editor.extensions.config-panel.loading-error.non-final':
  ...
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'To increase speed and response time some editing features are limited.',
  ...
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    "The source of this synced block is a content item you don't have access to.",
  ...
  'fabric.editor.textColorHighlightTooltip': 'Text and Highlight colour',
  'fabric.editor.textColorTooltip': 'Text colour',
  'companyHub.editor.textColor.pickerTitle': 'Text colour',
