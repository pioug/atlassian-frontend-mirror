...
export default {
  ...
  'fabric.reactions.error.unexpected':
    'Le reazioni non sono temporaneamente disponibili',
  ...
  'reactions.dialog.reactions.count':
    '{count, plural, one {{count,number} reazione} other {{count,number} reazioni}}',
  ...
  'reactions.dialog.viewall.tooltip':
    'Visualizza tutte le reazioni degli utenti',
};
