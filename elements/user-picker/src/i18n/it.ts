...
export default {
  ...
  'fabric.elements.user-picker.group.byline.admin-managed': 'Gruppo di amministratori {verifiedIcon}',
  ...
  'fabric.elements.user-picker.source.other-atlassian-appify': 'Altre app Atlassian',
  'fabric.elements.user-picker.team.byline': 'Team',
  'fabric.elements.user-picker.team.byline.official': 'Team ufficiale {verifiedIcon}',
  ...
  'fabric.elements.user-picker.team.member.50plus.official': 'Team ufficiale {verifiedIcon} • Oltre 50 membri',
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'Team ufficiale {verifiedIcon} • Oltre 50 membri, te compreso',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {Team ufficiale {verifiedIcon} • {count} membro} other {Team ufficiale {verifiedIcon} • {count} membri}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {Team ufficiale {verifiedIcon} • {count} membro, te compreso} other {Team ufficiale {verifiedIcon} • {count} membri, te compreso}}',
