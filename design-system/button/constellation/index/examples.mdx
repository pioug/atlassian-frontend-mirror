...
import LegacyButtonWithIconOnly from '../../examples/constellation/legacy-button/button-with-icon-only';
...
<SectionMessage>
  <p>
    ...
    <a href="/components/button/migration-guide">Migrate to new buttons</a>
  </p>
</SectionMessage>
...
<Example Component={LegacyButtonWithIconOnly} packageName="@atlaskit/button" />
