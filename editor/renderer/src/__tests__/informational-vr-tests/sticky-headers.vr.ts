...
snapshotInformational(StickyHeaderUnResizedTableWithoutHeaderRowRenderer, {
  description:
    'should have the header not stick for an unresized-table with no header row',
  prepare: async (page: Page, component: Locator) => {
...
snapshotInformational(StickyHeaderRowWithOnlyHeader, {
  description:
    'should have the header not stick for an table with only header row',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 120);
  },
});
...
snapshotInformational(StickyHeaderRowWithOnlyNonHeader, {
  description:
    'should have the header not stick for a table with only regular row',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 120);
  },
});
...
snapshotInformational(StickyHeaderRowWithResizedColumns, {
  description:
    'should have the header not stick for an table with resized columns',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 120);
  },
});
...
snapshotInformational(StickyHeadersBrokenOutTableNoResize, {
  description:
    'should have the header stick for a broken out table with no resized columns',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 80);
  },
});
...
snapshotInformational(StickyHeadersBrokenOutTableResized, {
  description:
    'should have the header stick for a broken out table no resized columns',
  prepare: async (page: Page, component: Locator) => {
...
snapshotInformational(StickyHeadersTableOverflowingNumberedColumn, {
  description:
    'should have the header stick for an table with overflow and numbered column',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 120);
  },
});
...
snapshotInformational(StickyHeadersTableInsideLayoutBrokenOut, {
  description:
    'should have the header stick for an table within layout and brokenout',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 120);
  },
});
...
snapshotInformational(StickyHeadersTableMultipleHeaderRows, {
  description:
    'should have both headers stick for an table with multiple headers 1',
  prepare: async (page: Page, component: Locator) => {
...
snapshotInformational(StickyHeadersTableMultipleHeaderRows, {
  description:
    'should have both headers stick for an table with multiple headers 2',
  prepare: async (page: Page, component: Locator) => {
...
snapshotInformational(StickyHeadersTableMergedRows, {
  description:
    'should have the headers not stick for an table with merged cells',
  prepare: async (page: Page, component: Locator) => {
    await scrollToPos(page, 90);
  },
});
