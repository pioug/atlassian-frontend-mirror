...
import { mockAnalytics, mockByUrl } from '../../../../utils/mocks';
...
describe('useInvokeClientAction', () => {
	...
	ffTest.off('platform-smart-card-migrate-embed-modal-analytics', 'with analytics object', () => {
	...
	ffTest.on(
		...
		'with SmartLinkAnalyticsContext',
		() => {
