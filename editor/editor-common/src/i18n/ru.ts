...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Инструкции',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Определите задачу, инструкции и правила',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Креативность',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Высокая',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Низкая',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Средняя',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Например: 1. Начни документ с краткого описания целей компании. 2. Создай список ключевых участников команды, с которыми нужно познакомиться в первую неделю работы.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Дайте инструкции для выполнения задачи, чтобы получить конкретные результаты.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Например: «Материал должен быть оформлен в соответствии с руководством по стилю компании и не должны содержать непроверенных данных».',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Правила',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Опишите правила, которые необходимо соблюдать.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Опишите задачу',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Например: «Создай документацию для адаптации новых сотрудников, присоединившихся к команде».',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Задание',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Опишите задачу, которую нужно выполнить.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Стиль изложения',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Непринужденный',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Обучающий',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Сочувственный',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Нейтральный',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Профессиональный',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Создать расширенный запрос',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Создать расширенный запрос',
