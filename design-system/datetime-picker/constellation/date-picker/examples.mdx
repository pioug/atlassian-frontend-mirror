...
import DatePickerRequired from '../../examples/constellation/date-picker-required';
...
information, see the [form component](/components/form/examples).
...
<Example Component={DatePickerRequired} packageName="@atlaskit/datetime-picker" />

### Validation

This is how date picker behaves within [forms](/components/form/examples).
...
in a new browser tab. Use the [messaging guidelines](/foundations/content/designing-messages) for more help.
