...
export default {
  ...
  'linkDataSource.modal-initial-state.learnMoreLink': 'Další informace o vyhledávání pomocí JQL',
  'linkDataSource.modal-initial-state.searchDescription': 'Chcete-li vyhledávat, začněte psát nebo použijte dotaz JQL.',
