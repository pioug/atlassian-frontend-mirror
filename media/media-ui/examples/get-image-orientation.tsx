...
class Example extends React.Component<{}, ExampleState> {
				...
				<Grid>
					<GridColumn>
						...
						<p>
							async Example:
							<br />
							<Code>const orientation: number = await getOrientation(file);</Code>
						</p>
						<p>
							Select a local image to see it's Exif orientation (if available).
							<br />
							Currently only supports Exif / XMP tags in <b>JPEG</b> and <b>PNG</b> formats.
						</p>
					</GridColumn>
				</Grid>
				<Grid>
	...
	renderPreviews() {
		...
		return previews.map((preview, i) => {
			...
			const orientation = forcedOrientation === 0 ? preview.orientation : forcedOrientation;
			return (
