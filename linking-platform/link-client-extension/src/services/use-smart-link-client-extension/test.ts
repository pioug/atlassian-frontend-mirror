...
describe('useSmartLinkClientExtension', () => {
  ...
  describe('related-urls', () => {
    ...
    it.each([
      201, 202, 203, 204, 205, 206, 207, 208, 226, 400, 401, 402, 403, 404, 405,
      406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417, 421, 422, 423,
      ...
      await expect(result.current.relatedUrls(url)).rejects.toBe(
        expectedResponse,
      );
    });
  });
