...
export default {
  ...
  'fabric.media.video_captions_delete_captions_confirmation_description':
    'Bekræft, at du vil slette denne billedtekst.',
  ...
  'media.media-avatar-picker.image-cropper.arrow-keys.label':
    'Flytbart billede. Sørg for, at din skærmlæser ikke er i browsertilstand. Brug piletaster til at flytte og beskære billedet',
