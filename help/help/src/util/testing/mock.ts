...
export const getMockArticleItemList = (numberOfItems: number): ArticleItem[] => {
...
export const getMockWhatsNewArticleItemList = (numberOfItems: number): WhatsNewArticleItem[] => {
