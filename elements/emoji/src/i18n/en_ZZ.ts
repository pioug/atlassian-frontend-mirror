...
export default {
  ...
  'fabric.emoji.categories.search.results':
    '⁣⁢Search results⁡⁫⁬⁬⁮⁫⁭⁬⁬؜⁡‌‌⁯⁫⁬؜‍⁬⁣⁤',
  ...
  'fabric.emoji.category.productivity':
    '⁣⁢Productivity⁡⁫⁬⁯‌‌⁯⁠⁬‌⁯⁭⁬‌⁠⁡‌؜⁭⁪⁫⁯⁯⁠⁣⁤',
  'fabric.emoji.category.symbols': '⁣⁢Symbols⁯‍⁪⁫⁮⁫‍⁡⁮⁪‌⁫⁮⁮⁭⁠⁭⁬⁡⁪⁯⁯⁣⁤',
  'fabric.emoji.category.user.uploads':
    '⁣⁢Your uploads⁪⁫⁭⁪⁬؜؜⁬‌⁡⁪⁭⁫⁠؜‌⁯⁪⁡⁠⁮⁫⁪⁣⁤',
  ...
  'fabric.emoji.error.invalid.image':
  ...
  'fabric.emoji.name.ariaLabel':
    '⁣⁢Enter a name for the new emoji‌⁪؜؜‌⁭⁪⁮⁡⁬⁡⁠⁡⁪⁫⁭‍⁮⁡⁯⁣⁤',
  'fabric.emoji.placeholder': '⁣⁢Emoji name⁫‍⁭⁯⁮⁮‍‍⁮‌⁠؜⁮⁬⁭⁡⁫⁮⁠⁯‌⁯⁣⁤',
  'fabric.emoji.preview':
    '⁣⁢Your new emoji {emoji} looks great⁠؜‌‌⁪⁮؜⁪⁯‍‌⁮⁡⁡⁠⁪⁠⁪⁮⁣⁤',
