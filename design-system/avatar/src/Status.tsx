...
const ApprovedIndicator = (
  <Fragment>
    <circle fill={token('color.icon.success', G400)} cx="4" cy="4" r="4" />
    <path
      fill={token('elevation.surface.overlay', background())}
...
const DeclinedIndicator = (
  <Fragment>
    <circle fill={token('color.icon.danger', R400)} cx="4" cy="4" r="4" />
    <path
      fill={token('elevation.surface.overlay', background())}
...
const LockedIndicator = (
  <Fragment>
    <circle fill={token('color.text.subtlest', N40)} cx="4" cy="4" r="4" />
    <path
      fill={token('elevation.surface.overlay', N500)}
