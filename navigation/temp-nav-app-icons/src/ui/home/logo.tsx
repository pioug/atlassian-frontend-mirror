 ...
 * @codegen <<SignedSource::772fb4439381a6f568a87f6a60cc131b>>
 ...
 */
export function HomeLogo({ label, testId }: AppLogoProps) {
	return <LogoWrapper svg={svg} label={label || 'Home'} testId={testId} />;
}
