...
interface ButtonProps extends WithAnalyticsEventsProps {
	children: ReactNode;
	onClick: (event: MouseEvent<HTMLButtonElement>, analyticsEvent?: UIAnalyticsEvent) => void;
}

const Button = ({ createAnalyticsEvent, ...props }: ButtonProps) => <button {...props} />;
...
const App = (): React.JSX.Element => {
	...
	return (
		<div>
			{hasUnmounted ? <div>Everything has unmounted!</div> : <Everything onClick={handleClick} />}
		</div>
	);
};
