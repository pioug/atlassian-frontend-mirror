...
import { type MediaClientConfig, globalMediaEventEmitter } from '@atlaskit/media-client';
		...
		it('should lazy load by default', async () => {
			...
			render(
				<MockedMediaClientProvider mockedMediaApi={mediaApi}>
					<CardV2Loader mediaClientConfig={dummyMediaClientConfig} identifier={identifier} />
		...
		describe('should render SVG natively when the overlay is disbled', () => {
			ffTest(
				...
				async () => {
					...
					const elem = await findAllByTestId('media-card-svg', undefined, {
						timeout: 10000,
					});
