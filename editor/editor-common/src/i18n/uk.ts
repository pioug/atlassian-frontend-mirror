...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Інструкції',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Укажіть задачу, інструкції та правила',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Рівень креативності',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Високий',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Низький',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Середній',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Наприклад: 1. Почніть документ із короткого огляду цілей компанії. 2. Складіть список провідних учасників команди, з якими новачкам потрібно зустрітися впродовж першого робочого тижня.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Надайте вказівки щодо задачі, щоб допомогти згенерувати конкретні результати.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Наприклад: інструкції мають узгоджуватися з указівками компанії щодо стилю корпоративної документації та містити лише перевірені дані.',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Окресліть правила, яких необхідно дотримуватися.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Укажіть задачу',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Наприклад: створити документацію для адаптації нових співробітників, які приєднуються до команди.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Задача',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Опишіть задачу, яку потрібно виконати.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Тон',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Буденний',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Освітній',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Емпатичний',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Нейтральний',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Професійний',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Створіть розширений запит',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Створіть розширений запит',
