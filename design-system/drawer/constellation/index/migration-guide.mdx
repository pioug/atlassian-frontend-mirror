...
import DrawerDefaultExample from '../../examples/constellation/drawer-composition-default';
import DrawerXcssExample from '../../examples/constellation/drawer-composition-xcss';
import DrawerCustomCompositionExample from '../../examples/constellation/drawer-composition-custom';
...
The new components are available via the `@atlaskit/drawer/compiled` entry point. There are three
new sub-components available:
...
+import { Drawer, DrawerContent, DrawerCloseButton } from '@atlaskit/drawer/compiled';
