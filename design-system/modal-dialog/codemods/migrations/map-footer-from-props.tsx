...
export const mapFooterFromProps = (j: core.JSCodeshift, source: Collection<Node>) => {
	...
	source.findJSXElements(defaultSpecifier).forEach((element: ASTPath<JSXElement>) => {
		const footerFromIndividualProp = getOverrideFromIndividualProp(j, element, FOOTER_PROP_NAME);
