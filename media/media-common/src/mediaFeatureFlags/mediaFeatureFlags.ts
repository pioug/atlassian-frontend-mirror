...
export const filterFeatureFlagNames = (
	...
	const pairs = Object.entries(flags) as Array<[keyof RequiredMediaFeatureFlags, boolean]>;
...
export function getMediaFeatureFlag<T = boolean>(
	...
	return getGenericFeatureFlag<T, keyof MediaFeatureFlags, Required<MediaFeatureFlags>>(
		flagName,
