 ...
 *
 * @example
 * localhost under root: yarn start:webpack emoji --proxy ./packages/elements/reactions/proxy.ts
 * staging under root: PROXY_TARGET_ENV=stg yarn start:webpack emoji --proxy ./packages/elements/reactions/proxy.ts
