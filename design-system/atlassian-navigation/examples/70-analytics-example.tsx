...
const NavigationButton = ({ name, ...props }: PrimaryButtonProps & { name: string }) => {
...
const SearchAnalytics = () => {
	...
	return <Search onClick={onClick} placeholder="Search..." tooltip="Search" label="Search" />;
};
...
const NotificationsAnalytics = () => {
	...
	return <Notifications onClick={onClick} tooltip="Notifications" badge={badge} />;
};
