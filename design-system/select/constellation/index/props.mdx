...
import NativeReactPopperProps from '!!extract-react-types-loader!../../src/extract-react-types/react-popper-props';
...
<SectionMessage>
  <p>
    <Snippet>@atlaskit/select</Snippet> extends the functionality of React Select v5.4.0.
...
#### PopperProps
<PropsTable heading="" props={NativeReactPopperProps} />
