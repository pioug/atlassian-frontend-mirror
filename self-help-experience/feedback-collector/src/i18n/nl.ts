...
export default {
  'feedback-collector.can-be-contacted.label':
    'Atlassian mag contact met me opnemen over deze feedback',
  'feedback-collector.cancel-button.label': 'Annuleren',
  'feedback-collector.enrol-in-research.label':
    'Ik wil graag meewerken aan productonderzoek',
  ...
  'feedback-collector.form.suggestion.label':
    'Laat ons weten wat je zou willen verbeteren',
  ...
  'feedback-collector.success-flag.description':
    'Met jouw feedback kunnen we onze producten steeds verder verbeteren.',
