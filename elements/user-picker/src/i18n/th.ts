...
export default {
  ...
  'fabric.elements.user-picker.group.byline.admin-managed': 'กลุ่มผู้ดูแล {verifiedIcon}',
  ...
  'fabric.elements.user-picker.source.other-atlassian-appify': 'แอป Atlassian อื่น ๆ',
  'fabric.elements.user-picker.team.byline': 'ทีม',
  'fabric.elements.user-picker.team.byline.official': 'ทีมอย่างเป็นทางการ {verifiedIcon}',
  ...
  'fabric.elements.user-picker.team.member.50plus.official': 'ทีมอย่างเป็นทางการ {verifiedIcon} • สมาชิกมากกว่า 50 คน',
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'ทีมอย่างเป็นทางการ {verifiedIcon} • สมาชิกมากกว่า 50 คน รวมคุณด้วย',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, other {ทีมอย่างเป็นทางการ {verifiedIcon} • สมาชิก {count} คน}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, other {ทีมอย่างเป็นทางการ {verifiedIcon} • สมาชิก {count} คน <em><em><em></em></em></em>รวมคุณด้วย}}',
