...
/** @deprecated Use @atlaskit/smart-card/hook/use-smart-link-actions */
/**
...
/**
 * @deprecated Use `import { useSmartLinkReload } from '@atlaskit/smart-card/hook/use-smart-link-reload'` instead.
 */
