...
Both <a href="/components/icon/icon-tile/examples">Icon tile</a> and

<a href="/components/object/object-tile/examples">Object tile</a> inherit properties of tile
ensuring a consistent and cohesive tile system across various applications.
