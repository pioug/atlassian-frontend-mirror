...
export class MediaViewerPageObject {
	...
	constructor(readonly page: Page) {
		this.nextButton = page.locator('[data-testid="media-viewer-navigation-next"]');
		this.prevButton = page.locator('[data-testid="media-viewer-navigation-prev"]');
		this.closeButton = page.locator('[data-testid="media-viewer-close-button"]');
		this.sidebarButton = page.locator('[data-testid="media-viewer-sidebar-button"]');
		this.sidepannelContent = page.locator('[data-testid="media-viewer-sidebar-content"]');
		this.fileName = page.locator(`[data-testid="media-viewer-file-name"]`);
		this.fileType = page.locator(`[data-testid="media-viewer-file-metadata-text"] span`);
