...
/**
 * @deprecated Use `import { mockDatasourceDataNoActionsResponse } from '@atlaskit/link-client-extension'` instead.
 */
...
/**
 * @deprecated Use `import { mockDatasourceDataResponse } from '@atlaskit/link-client-extension'` instead.
 */
export { mockDatasourceDataResponse } from '../services/use-data-source-client-extension/mockDatasourceDataResponse';
/**
 * @deprecated Use `import { mockDatasourceResponse, mockDatasourceDetailsResponse } from '@atlaskit/link-client-extension'` instead.
 */
export {
...
/**
 * @deprecated Use `import { mockDatasourceDataResponseWithSchema } from '@atlaskit/link-client-extension'` instead.
 */
