...
<SectionMessage>
  <p>
    <Snippet>@atlaskit/popper</Snippet> extends the render props functionality
    of react-popper@2.2.5. To view the full set of available props for each
...
The _prevent overflow_ modifier prevents the popper from being cut off by moving it so that it stays visible within its boundary area.
