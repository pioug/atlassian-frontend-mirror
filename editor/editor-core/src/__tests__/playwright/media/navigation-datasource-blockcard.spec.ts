import { fixTest, editorTestCase as test } from '@af/editor-libra';

test.describe(`navigation: datasource-blockcard`, () => {
  // eslint-disable-next-line playwright/expect-expect
  test(`TODO`, () => {
    fixTest({
      jiraIssueId: 'ED-20809',
      reason: 'Tests require migration from webdriver',
    });
  });
});

// Migrated from webdriver
