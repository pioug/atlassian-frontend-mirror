...
export default {
  ...
  "fabric.linking.connect_unauthorised_account_description": "Подключитесь к Atlassian, чтобы получать более подробную информацию о работе и совместно работать в единой среде.",
  ...
  "fabric.linking.forbidden_description": "У вас нет доступа к предварительному просмотру. Если вам требуется доступ, обратитесь к администратору сайта.",
  ...
  "fabric.linking.request_denied_description": "Ваш запрос на доступ отклонен. Если вам требуется доступ, обратитесь к администратору сайта.",
