...
/**
 * @deprecated The legacy icon "editor/task" is deprecated in favour of "@atlaskit/icon/core/checkbox-checked" and will be removed in an upcoming major release
 * 
