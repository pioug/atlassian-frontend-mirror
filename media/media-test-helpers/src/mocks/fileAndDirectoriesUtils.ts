...
const createDataTransferItemList = (itemsArray: DataTransferItem[]): DataTransferItemList =>
...
const createDataTransfer = (files: FileList, items: DataTransferItemList): DataTransfer => {
