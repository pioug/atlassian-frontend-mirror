...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Instrukcje',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Określ zadanie, instrukcje i reguły',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Kreatywność',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Wysoka',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Niska',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Średnia',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Przykładowo: 1. Zacznij dokument od krótkiego przeglądu celów naszej firmy. 2. Utwórz listę kluczowych członków zespołu, z którymi mają się spotkać w pierwszym tygodniu.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Podaj instrukcje dotyczące wykonania zadania, aby pomóc w generowaniu określonych danych wyjściowych.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Przykładowo: Dane wyjściowe muszą być zgodne z wytycznymi dotyczącymi stylu firmy i nie mogą opierać się na niezweryfikowanych danych.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Reguły',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Określ wszelkie reguły, które mają być przestrzegane.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Podaj zadanie',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Przykładowo: Utwórz dokumentację onboardingu dla nowych pracowników dołączających do zespołu.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Zadanie',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Opisz zadanie, które wymaga wykonania.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Ton',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Swobodny',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Edukacyjny',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Empatyczny',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Neutralny',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Profesjonalny',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Tworzenie zaawansowanego polecenia',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Tworzenie zaawansowanego polecenia',
