...
import ModalFullScreen from '../../examples/constellation/modal-full-screen';
...
[modal dialog props](/components/modal-dialog/code#modal-dialog-props).
...
<Example Component={ModalFullScreen} packageName="@atlaskit/modal-dialog" />
