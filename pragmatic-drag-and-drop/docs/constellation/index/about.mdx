...
We have created optional visual outputs (eg our drop indicator) make it super fast for us to build consistent Atlassian user experiences. Non Atlassian consumers are welcome to use these outputs, create their own that copy the visual styling, or go a totally different direction.
...
Head on over to our [getting started page](/components/pragmatic-drag-and-drop/how-it-works/how-it-works)
