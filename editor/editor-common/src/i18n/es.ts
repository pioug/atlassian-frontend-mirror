...
export default {
  ...
  'editor.trackChanges.removed': 'Eliminado',
  'fablric.editor.viewAllInserts': 'Ver los elementos insertados',
  'fabric.editor.accessToSyncedBlockRequested': 'Acceso solicitado',
  ...
  'fabric.editor.ai.config.item.addPolish.description': 'Pule el contenido para mejorarlo',
  'fabric.editor.ai.config.item.addPolish.title': 'Pulir',
  ...
  'fabric.editor.ai.config.item.changeTone.adjustLengthNestingParentShortTitle': 'Duración',
  'fabric.editor.ai.config.item.changeTone.adjustLengthNestingParentTitle': 'Ajustar longitud',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'Mejora la respuesta basada en incidencias similares a la incidencia en la que estás trabajando',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': 'Sugerir respuesta',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint':
    'Escribe con Rovo o selecciona una de las siguientes acciones',
  'fabric.editor.ai.config.item.generateEscalationNotes.description':
    'Genera notas de derivación según el contexto de la incidencia',
  'fabric.editor.ai.config.item.generateEscalationNotes.title': 'Generar notas de derivación',
  ...
  'fabric.editor.ai.experience-application.cmdPaletteUnhandledErrorMessage':
    'Tenemos problemas y no podemos generar una respuesta en este momento. Vuelve a intentarlo más tarde.',
  ...
  'fabric.editor.ai.experience.adfStreamingError': 'Lo sentimos, no hemos recibido respuesta.',
  'fabric.editor.ai.experience.aifcAdfStreamingError': 'Lo sentimos, no hemos recibido respuesta.',
  'fabric.editor.ai.experience.aifcApiError': 'Se ha producido un error desconocido.',
  'fabric.editor.ai.experience.aifcApiErrorRetry':
    'Se ha producido un error desconocido. Vuelve a cargar e inténtalo de nuevo.',
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    'El contenido no cumple con nuestra <link>Política de uso aceptable</link>.',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    'Tu contenido contiene enlaces a contenido restringido por la HIPAA. Elimina los enlaces e inténtalo de nuevo.',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    'Se necesita más contenido para completar tu solicitud. Selecciona más contenido e inténtalo de nuevo.',
  'fabric.editor.ai.experience.aifcInternalServerError':
    'Lo sentimos, no hemos recibido respuesta. Vuelve a intentarlo en 5 minutos o <link>comprueba el estado de Rovo</link>.',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    'Has alcanzado el <link>número máximo de solicitudes</link>. Inténtalo de nuevo dentro de 5 minutos.',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'Hay demasiado contenido que procesar. Selecciona menos contenido e inténtalo de nuevo.',
  ...
  'fabric.editor.ai.experience.dialogAriaLabel': 'Cuadro de diálogo de Atlassian Intelligence',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': '¿Quieres cancelar la solicitud y descartar la respuesta?',
  ...
  'fabric.editor.ai.toolbar.adjustLength.title': 'Ajustar longitud',
  ...
  'fabric.editor.block.menu.copy.content': 'Copia contenido',
  ...
  'fabric.editor.block.menu.layout': 'Diseño',
  'fabric.editor.block.menu.link.copied.to.clipboard': 'Enlace copiado en el portapapeles',
  'fabric.editor.block.menu.move.down': 'Bajar',
  'fabric.editor.block.menu.move.up': 'Subir',
  'fabric.editor.block.menu.new.lozenge': 'Novedad',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': 'Arrastra para mover {br} Haz clic para abrir el menú',
  ...
  'fabric.editor.contextPanel.panelContentLabel': 'Contenido del panel contextual desplazable',
  ...
  'fabric.editor.copySyncBlockTooltip': 'Copiar referencia al portapapeles',
  ...
  'fabric.editor.createSyncBlockLabel': 'Crear un bloque sincronizado',
  ...
  'fabric.editor.dragHandleZone': 'Activar zona de tirador para arrastrar',
  ...
  'fabric.editor.editSourceTooltip': 'Ir a la página de origen del bloque de sincronización',
  ...
  'fabric.editor.elementbrowser.featured.whiteboard.description':
    'Usa una pizarra para añadir elementos visuales a tu página',
  ...
  'fabric.editor.embedToBlockCardWarning': 'Se muestra como una tarjeta en pantallas pequeñas',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    'Parece que estás sin conexión. Conéctate a Internet para crear contenido sincronizado.',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    'Parece que estás sin conexión. Conéctate a Internet para eliminar contenido sincronizado.',
  'fabric.editor.error.description.failToEditWhenOffline':
    'Parece que estás sin conexión. Conéctate a Internet para editar contenido sincronizado.',
  ...
  'fabric.editor.error.title.failToEdit': 'No se puede editar contenido sincronizado sin conexión',
  ...
  'fabric.editor.highlight.removeColor': 'Quitar el color',
  ...
  'fabric.editor.limitedModeDescription':
    'Para aumentar la velocidad y el tiempo de respuesta, <learnMoreLink>algunas funciones de edición están limitadas</learnMoreLink>.',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'Para aumentar la velocidad y el tiempo de respuesta, algunas funciones de edición están limitadas.',
  'fabric.editor.limitedModeTitle': 'Mejoras en la velocidad',
  ...
  'fabric.editor.noPermissionToAddComment':
    '{contentType, select, blogpost {No tienes permiso para añadir comentarios en esta entrada de blog} page {No tienes permiso para añadir comentarios en esta página} other {No tienes permiso para añadir comentarios en esta página}}',
  ...
  'fabric.editor.openPreviewPanel': 'Abrir panel de vista previa',
  ...
  'fabric.editor.previewButtonTitle': 'Vista previa',
  'fabric.editor.quickInsert': 'Inserción rápida',
  'fabric.editor.quickinsert.new.lozenge': 'Novedad',
  ...
  'fabric.editor.requestAccessToSyncedBlock': 'Solicitar acceso',
  'fabric.editor.requestAccessToSyncedBlockError': 'Algo ha ido mal. Haz clic para volver a intentarlo',
  ...
  'fabric.editor.retrySyncedBlock': 'Reintentar',
  ...
  'fabric.editor.selectionToolbarOverflowMenuTooltip': 'Más opciones',
  'fabric.editor.settingsLinks': 'Ir a Preferencias de enlaces',
  'fabric.editor.shortEmptyNodePlaceholderSlash': '/',
  'fabric.editor.shortEmptyNodePlaceholderSuffix': 'para insertar',
  ...
  'fabric.editor.syncBlockPlaceholderText':
    'Añade contenido y copia este bloque sincronizado para acceder a él en todos los espacios',
  ...
  'fabric.editor.syncedBlockGeneralErrorDescription': 'Se ha producido un error al cargar este bloque sincronizado.',
  'fabric.editor.syncedBlockNotFoundDescription': 'No podemos cargar este bloque sincronizado.',
  ...
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    'La fuente de este bloque sincronizado es un elemento de contenido al que no tienes acceso.',
  'fabric.editor.syncedBlockPermissionDeniedHeading': 'No tienes permiso para ver este bloque sincronizado',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': 'Se ha denegado el permiso.',
  ...
  'fabric.editor.tableScrollRegion': 'Región de desplazamiento de la tabla',
  ...
  'fabric.editor.taskList': 'Lista de tareas',
  ...
  'fabric.editor.textColorHighlightTooltip': 'Color de texto y resaltado',
  'fabric.editor.textColorTooltip': 'Color del texto',
  'companyHub.editor.textColor.pickerTitle': 'Color del texto',
  ...
  'fabric.editor.toolbarPositionUnpinnedConcise': 'Anclar la barra de herramientas en la parte superior',
  ...
  'fabric.editor.typeAheadErrorFallbackDescription': 'No hay resultados disponibles. Vuelve a intentarlo.',
  'fabric.editor.typeAheadErrorFallbackHeading': 'Se ha producido un error',
