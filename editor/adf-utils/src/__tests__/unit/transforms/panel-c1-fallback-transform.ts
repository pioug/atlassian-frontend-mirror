...
describe('panelC1FallbackTransform', () => {
	eeTest.describe('platform_editor_nest_table_in_panel', 'isEnabled').variant(false, () => {
		...
		describe('when panel_c1 is not supported (experiment off)', () => {
	...
	eeTest.describe('platform_editor_nest_table_in_panel', 'isEnabled').variant(true, () => {
		describe('when panel_c1 is supported (experiment on)', () => {
