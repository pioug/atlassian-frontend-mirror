...
describe('getCSSCustomProperty', () => {
	...
	it('should parse to a shortened value with camel case parts', () => {
		const actual = getCSSCustomProperty(['color', 'backgroundSubtleBorderedNeutral', 'resting']);

		expect(actual).toEqual(`--${CSS_PREFIX}-backgroundSubtleBorderedNeutral-resting`);
	});
	...
	it('should omit the [default] keyword', () => {
		const actual = getCSSCustomProperty(['color', '[default]', 'border', 'focus']);
...
describe('getTokenId', () => {
	...
	it('should parse to a shortened value with camel case parts', () => {
		const actual = getTokenId(['color', 'backgroundSubtleBorderedNeutral', 'resting']);
...
describe('getFullyQualifiedTokenId', () => {
	...
	it('should not omit the [default] keyword', () => {
		const actual = getFullyQualifiedTokenId(['color', '[default]', 'border', 'focus']);
