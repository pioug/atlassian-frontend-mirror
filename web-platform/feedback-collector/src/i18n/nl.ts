...
export default {
  ...
  'feedback-collector.can-be-contacted.label-appify-without-link':
    'Ja, Atlassian-teams mogen contact met me opnemen om te vragen naar mijn ervaringen, zodat Atlassian-apps en -services kunnen worden verbeterd. Ik stem in met het Privacybeleid van Atlassian.',
  'feedback-collector.can-be-contacted.label-without-link':
    'Ja, Atlassian-teams mogen contact met me opnemen om te vragen naar mijn ervaringen, zodat Atlassian-producten en -diensten kunnen worden verbeterd. Ik stem in met het Privacybeleid van Atlassian.',
  ...
  'feedback-collector.privacy-policy': 'Privacybeleid van Atlassian',
