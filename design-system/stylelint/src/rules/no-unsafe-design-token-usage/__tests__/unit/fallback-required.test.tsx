...
testRule({
	...
	reject: [
      ...
      `,
			description: 'should not allow tokens used without a fallback inside a function',
			warnings: [{ message: messages.missingFallback }, { message: messages.missingFallback }],
		},
	],
});
