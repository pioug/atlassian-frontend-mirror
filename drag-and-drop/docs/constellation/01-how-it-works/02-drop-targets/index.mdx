...
- During a drag operation:
  ...
  - You can _remount_ a _drop targets_ (see [reconciliation](/components/drag-and-drop/how-it-works/reconciliation))
...
- [Visual affordances for drop targets](/components/drag-and-drop/design-guidelines/visual-affordances#moving-items-between-drop-targets)
