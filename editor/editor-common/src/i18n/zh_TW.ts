...
export default {
  ...
  'fabric.editor.accessToSyncedBlockRequested': '已要求存取權',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription': '根據與您正在處理的議題類似的議題增強回覆',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': '建議回覆',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint': '透過 Rovo 撰寫或從下方選取',
  ...
  'fabric.editor.ai.experience.aifcAdfStreamingError': '很抱歉，我們無法取得回應。',
  'fabric.editor.ai.experience.aifcApiError': '發生未知的錯誤。',
  'fabric.editor.ai.experience.aifcApiErrorRetry': '發生未知的錯誤。請重新載入，然後再試一次。',
  'fabric.editor.ai.experience.aifcAupViolationMessage': '內容可能不符合我們的<link>《可接受使用政策》</link>。',
  'fabric.editor.ai.experience.aifcHipaaContentError': '內容包含 HIPAA 限制內容的連結。請移除連結，然後再試一次。',
  'fabric.editor.ai.experience.aifcInputTooShortError': '若要完成要求，需要更多內容。請選取更多內容，然後再試一次。',
  'fabric.editor.ai.experience.aifcInternalServerError':
    '很抱歉，我們無法取得回應。5 分鐘後再試一次，或<link>檢查 Rovo 狀態</link>。',
  'fabric.editor.ai.experience.aifcRateLimitEnforced': '您已達到<link>要求的數量上限</link>。5 分鐘後再試一次。',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded': '需要處理的內容太多。請選取較少的內容，然後再試一次。',
  'fabric.editor.ai.experience.apiError': '我們無法收到回覆，請再試一次。',
  'fabric.editor.ai.experience.aupViolationMessage':
    '您的提示或內容可能不符合我們的《可接受使用政策》。請檢閱提示和內容，並視需要參閱我們的<link>《可接受使用政策》</link>。如果問題仍然存在，請考慮嘗試不同的提示或內容。',
  'fabric.editor.ai.experience.browseMore.agents': '瀏覽客服人員',
  'fabric.editor.ai.experience.dialogAriaLabel': 'Atlassian Intelligence 對話框',
  ...
  'fabric.editor.ai.experience.internalServerError':
    'Atlassian Intelligence (AI) 沒有回應。請稍後再試一次，或<link>檢查 AI 的狀態</link>。',
  ...
  'fabric.editor.ai.experience.noTextualContentError': '若要完成要求，需要更多內容。請選取更多內容，然後再試一次。',
  'fabric.editor.ai.experience.responseTooSimilarMessage':
    'Atlassian Intelligence 目前沒有建議。歡迎嘗試不同的提示或內容。',
  ...
  'fabric.editor.block.menu.copy.content': '複製內容',
  'fabric.editor.block.menu.copy.link': '複製連結',
  'fabric.editor.block.menu.copy.link.to.block': '將連結複製至區塊',
  'fabric.editor.block.menu.copy.synced.block': '複製同步區塊',
  'fabric.editor.block.menu.create.synced.block': '建立同步區塊',
  'fabric.editor.block.menu.delete.block': '刪除',
  'fabric.editor.block.menu.layout': '版面配置',
  'fabric.editor.block.menu.link.copied.to.clipboard': '已將連結複製到剪貼簿',
  'fabric.editor.block.menu.move.down': '向下移動',
  'fabric.editor.block.menu.move.up': '向上移動',
  'fabric.editor.block.menu.new.lozenge': '新增',
  'fabric.editor.block.menu.paragraph': '段落',
  'fabric.editor.block.menu.turn.into': '轉變成',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': '拖動以移動 {br} 按一下即可開啟選單',
  ...
  'fabric.editor.columns.advanced.layout.description':
    '{numberOfColumns, plural, other {插入 {numberOfColumns} 個相等的欄}}',
  ...
  'fabric.editor.createSyncBlockLabel': '建立同步區塊',
  ...
  'fabric.editor.datasource.jiraIssue.description.issue-term-refresh':
    '透過增強的搜尋、篩選和組態，從 Jira Cloud 插入 Jira 工作項目。',
  ...
  'fabric.editor.deleteConfirmationModalDeleteButton': '刪除',
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, other {刪除此內容也會移除 {syncBlockCount,number} 個同步區塊。在其他位置參照這些區塊將會顯示錯誤。要繼續刪除嗎？}}',
  'fabric.editor.deleteConfirmationModalTitle': '您即將刪除已同步的內容',
  ...
  'fabric.editor.editSourceLabel': '編輯來源',
  'fabric.editor.editSourceTooltip': '瀏覽至同步區塊的來源頁面',
  'fabric.editor.editSourceTooltipDisabled': '目前無法使用來源連結',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline': '您似乎處於離線狀態。請連線到網際網路，以建立同步的內容。',
  'fabric.editor.error.description.failToDeleteWhenOffline': '您似乎處於離線狀態。請連線到網際網路，以刪除同步的內容。',
  ...
  'fabric.editor.error.title.failToDelete': '無法刪除',
  'fabric.editor.error.title.failToEdit': '無法離線編輯已同步的內容',
  ...
  'fabric.editor.limitedModeDescription':
    '為加快速度和回應時間，<learnMoreLink>某些編輯功能會受到限制</learnMoreLink>。',
  'fabric.editor.limitedModeDescriptionWithoutLink': '為加快速度和回應時間，某些編輯功能會受到限制。',
  ...
  'fabric.editor.longEmptyNodePlaceholderPrefix': '輸入',
  ...
  'fabric.editor.noPermissionToAddComment':
    '{contentType, select, blogpost {您沒有將留言新增至此部落格貼文的權限} page {您沒有將留言新增至此頁面的權限} other {您沒有將留言新增至此頁面的權限}}',
  ...
  'fabric.editor.quickinsert.new.lozenge': '新增',
  ...
  'fabric.editor.requestAccessToSyncedBlock': '要求存取權',
  'fabric.editor.requestAccessToSyncedBlockError': '發生錯誤。請按一下按鈕以便重試',
  ...
  'fabric.editor.retrySyncedBlock': '重試',
  ...
  'fabric.editor.syncBlock.toolbar.newLozenge': '新增',
  'fabric.editor.syncBlockGroup': '同步區塊類型',
  'fabric.editor.syncBlockPlaceholderText': '新增內容，然後複製這個已同步的區塊以進行跨空間存取',
  'fabric.editor.syncedBlock': '建立同步區塊',
  'fabric.editor.syncedBlock.description': '跨多個位置同步內容',
  'fabric.editor.syncedBlockGeneralErrorDescription': '載入此同步區塊時發生錯誤。',
  'fabric.editor.syncedBlockNotFoundDescription': '我們無法載入此同步區塊。',
  'fabric.editor.syncedBlockNotFoundIconAltText': '找不到同步區塊。',
  'fabric.editor.syncedBlockPermissionDeniedDescription': '此同步區塊的來源是您無法存取的內容項目。',
  'fabric.editor.syncedBlockPermissionDeniedHeading': '您沒有檢視此同步區塊的權限',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': '權限已遭拒絕。',
