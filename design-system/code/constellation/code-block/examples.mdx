...
import CodeBlockStartingLineNumber from '../../examples/constellation/code-block-starting-line-number';
...
<Example Component={CodeBlockStartingLineNumber} packageName="@atlaskit/code" />
