...
import Snippet from '@atlaskit/gatsby-theme-brisk/src/components/snippet';

## Theming

<SectionMessage title="This theming approach has performance issues" appearance="warning">
  If possible, don’t use this theming approach. It has performance problems that we are working to improve in future.
  If you need to do some minor customization to button we recommend using inline styles. <Snippet>CustomThemeButton</Snippet> supports the theming approach outlined on this page.
</SectionMessage>
