 ...
 * @codegen <<SignedSource::a212fa101c3ea73fc9f91ee34c1e7983>>
...
const svg = `<svg height="100%" viewBox="0 0 372 32">
    ...
    <defs>
        <clipPath id="clip0_95164_15661">
            <path fill="var(--icon-color, white)" d="M0 0h371.333v32H0z"/>
        </clipPath>
        <clipPath id="clip1_95164_15661">
            <path fill="var(--icon-color, white)" d="M6.792 5.167h18.352v21.45H6.792z"/>
        </clipPath>
    </defs>
</svg>
`;
