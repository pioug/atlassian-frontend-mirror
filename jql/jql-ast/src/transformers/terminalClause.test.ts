...
const getTerminalClauseWithOperand = (operand?: Operand) =>
	creators.terminalClause(creators.field('field'), creators.operator(OPERATOR_EQUALS), operand);
...
describe('TerminalClause transformer', () => {
	...
	describe('setOperator', () => {
		it('update value operator and assign parent', () => {
			const terminalClause = getTerminalClauseWithOperand(creators.valueOperand('bug'));
