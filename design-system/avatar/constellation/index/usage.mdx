...
- Use square avatars to identify app entities like projects, spaces, groups, rooms, or repositories.
- Use hexagon avatars to identify agent entities such as Rovodev or other AI-powered entities.
