...
export default {
  ...
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Indiquez des tâches, des instructions et des règles',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Créativité',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Élevée',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Faible',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Moyenne',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    "Par exemple : 1. Commencer le document par une rapide vue d'ensemble des objectifs de notre entreprise. 2. Créer une liste des membres de l'équipe clés à rencontrer au cours de la première semaine.",
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Donnez des instructions pour la tâche afin de générer des résultats spécifiques.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    "Par exemple : Le résultat doit appliquer les consignes de style de l'entreprise et ne pas utiliser de données non vérifiées.",
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Règles',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': 'Présentez les règles à suivre.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Veuillez indiquer une tâche',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    "Par exemple : Créer une documentation d'intégration pour les nouveaux employés qui rejoignent l'équipe.",
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Tâche',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Décrivez la tâche à réaliser.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Style',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Décontracté',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Pédagogique',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Empathique',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Neutre',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Professionnel',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Créer un prompt avancé',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Créer un prompt avancé',
