...
describe('getBrowserMetadata', () => {
	...
	describe('webdriver field', () => {
		it('should include webdriver field when navigator.webdriver is true', () => {
		...
		it('should include webdriver field when navigator.webdriver is false', () => {
			Object.defineProperty(global, 'navigator', {
				value: {
					userAgent: 'test',
					webdriver: false,
