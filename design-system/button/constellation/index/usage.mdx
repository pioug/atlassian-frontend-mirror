...
- Avoid using disabled buttons, epsecially in forms. Disabled buttons provide no feedback, making it hard to know why the button isn't usable. Instead, use validation and errors to show what needs to be done.
