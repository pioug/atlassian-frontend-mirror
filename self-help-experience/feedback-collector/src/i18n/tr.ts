...
export default {
  'feedback-collector.can-be-contacted.label':
    'Atlassian bu geri bildirim hakkında benimle iletişime geçebilir',
  'feedback-collector.cancel-button.label': 'İptal',
  'feedback-collector.enrol-in-research.label':
    'Ürün araştırmasına katılmak istiyorum',
  ...
  'feedback-collector.form.question.label':
    'Hangi konuda bilgi almak istiyorsunuz?',
  'feedback-collector.form.suggestion.label':
    'Neyin iyileştirilmesini istediğinizi bizimle paylaşın',
