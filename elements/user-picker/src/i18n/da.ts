...
export default {
  ...
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'Officielt team {verifiedIcon} • over 50 medlemmer, inklusive dig',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {Officielt team {verifiedIcon} • {count} medlem} other {Officielt team {verifiedIcon} • {count} medlemmer}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {Officielt team {verifiedIcon} • {count} medlem, inklusive dig} other {Officielt team {verifiedIcon} • {count} medlemmer, inklusive dig}}',
