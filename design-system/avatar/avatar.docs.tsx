	...
	components: [
		{
			...
			usageGuidelines: [
				...
				'Use `xxsmall` for new 16px avatars. In the current major, legacy `xsmall` is also 16px and should migrate to `xxsmall` with the Avatar codemod; `xsmall` will become 20px in a future major',
				'Do not use 16px or 20px sizes with AvatarGroup',
