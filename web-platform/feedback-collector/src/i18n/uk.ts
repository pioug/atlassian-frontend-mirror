...
export default {
  ...
  'feedback-collector.can-be-contacted.label-appify':
    'Так, команди Atlassian можуть зв’язуватися зі мною щодо моєї роботи з додатками й службами Atlassian із метою їх удосконалення. Я погоджуюся з <a>Політикою конфіденційності Atlassian</a>.',
  'feedback-collector.can-be-contacted.label-appify-without-link':
    'Так, команди Atlassian можуть зв’язуватися зі мною щодо моєї роботи з додатками й службами Atlassian із метою їх удосконалення. Я погоджуюся з Політикою конфіденційності Atlassian.',
  'feedback-collector.can-be-contacted.label-without-link':
    'Так, команди Atlassian можуть зв’язуватися зі мною щодо моєї роботи з продуктами й службами Atlassian із метою вдосконалення їх. Я погоджуюся з Політикою конфіденційності Atlassian.',
  ...
  'feedback-collector.success-flag.description-appify':
    'Ваші цінні відгуки допомагають нам постійно вдосконалювати додатки.',
