...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'Talimatlar',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'Görevi, talimatları ve kuralları belirtin',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'Yaratıcılık',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'Yüksek',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'Düşük',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'Orta',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Örneğin: 1. Belgeye şirket amaçlarınızı kısaca özetleyerek başlayın. 2. İlk hafta tanışılacak önemli takım üyelerinin listesini oluşturun.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Belirli çıktılar oluşturmanıza yardımcı olacak görev talimatları sağlayın.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Örneğin: Çıktı şirket stil kılavuzlarına uymalı ve doğrulanmamış veriler kullanmamalı.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'Kurallar',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Uyulması gereken kuralları ana hatlarıyla belirtin.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'Lütfen görevi girin',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Örneğin: Takıma katılan yeni çalışanlar için işe alma belgeleri oluşturun.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'Görev',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'Tamamlanması gereken görevi açıklayın.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'Üslup',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'Günlük',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'Eğitici',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'Empati kuran',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'Nötr',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'Profesyonel',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'Gelişmiş bir istek oluşturun',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'Gelişmiş bir istem oluşturun',
