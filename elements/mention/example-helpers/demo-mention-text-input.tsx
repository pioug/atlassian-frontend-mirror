...
export default class MentionTextInput extends React.Component<Props, State> {
	...
	private handleInputUp = () => this.mentionPickerRef && this.mentionPickerRef.selectPrevious();
	private handleInputDown = () => this.mentionPickerRef && this.mentionPickerRef.selectNext();
