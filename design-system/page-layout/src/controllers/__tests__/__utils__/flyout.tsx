...
export const expectThatFlyoutIsOpenAndValid = (leftSidebar: HTMLElement): void => {
	 ...
	 */
	expect(getDimension('leftSidebarWidth')).toEqual(`${COLLAPSED_LEFT_SIDEBAR_WIDTH}px`);
	...
	expect(
		getComputedStyle(document.documentElement).getPropertyValue(`--${VAR_LEFT_SIDEBAR_FLYOUT}`),
	 ...
	 */
	expect(document.documentElement.hasAttribute(IS_SIDEBAR_COLLAPSING)).toBe(false);
};
