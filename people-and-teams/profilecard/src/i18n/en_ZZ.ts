...
export default {
  ...
  'profilecard.agent-profile-card.delete-agent-success-flag-description':
    '⁣⁢You deleted {agentName}⁠⁪⁭⁮⁭‍‍⁪⁯⁠⁪‌⁮‌⁮⁯⁯⁭⁡‍⁯⁭⁯⁫‌⁣⁤',
  ...
  'profilecard.agent-profile.delete-agent-error.agent-in-use':
    '⁣⁢Agent is currently in use. Try again later.⁭⁬⁭⁡‍⁮⁪‍؜⁯⁬⁪؜⁡⁭⁪⁯⁡؜⁣⁤',
  'profilecard.agent-profile.delete-agent-error.agent-not-found':
