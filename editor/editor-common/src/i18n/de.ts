...
export default {
  ...
  'fabric.editor.accessToSyncedBlockRequested': 'Zugriff angefordert',
  ...
  'fabric.editor.ai.config.item.draftReply.heroPromptDescription':
    'Verbessert die Antwort, die auf ähnlichen Vorgängen basiert wie dem, an dem Sie gerade arbeiten.',
  'fabric.editor.ai.config.item.draftReply.heroPromptTitle': 'Antwort vorschlagen',
  ...
  'fabric.editor.ai.config.item.generateContent.rovoPromptHint': 'Mit Rovo schreiben oder von unten auswählen',
  ...
  'fabric.editor.ai.experience.adfStreamingError': 'Es konnte leider keine Antwort abgerufen werden.',
  'fabric.editor.ai.experience.aifcAdfStreamingError': 'Es konnte leider keine Antwort abgerufen werden.',
  'fabric.editor.ai.experience.aifcApiError': 'Ein unbekannter Fehler ist aufgetreten.',
  'fabric.editor.ai.experience.aifcApiErrorRetry':
    'Ein unbekannter Fehler ist aufgetreten. Bitte laden Sie die Seite neu und versuchen Sie es noch einmal.',
  'fabric.editor.ai.experience.aifcAupViolationMessage':
    'Der Inhalt entspricht nicht unserer <link>Richtlinie zur akzeptablen Nutzung</link>.',
  'fabric.editor.ai.experience.aifcHipaaContentError':
    'Ihr Inhalt enthält Links zu HIPAA-beschränkten Inhalten. Entfernen Sie die Links und versuchen Sie es dann erneut.',
  'fabric.editor.ai.experience.aifcInputTooShortError':
    'Zum Abschließen Ihrer Anfrage sind weitere Inhalte erforderlich. Wählen Sie weitere Inhalte aus und versuchen Sie es dann erneut.',
  'fabric.editor.ai.experience.aifcInternalServerError':
    'Es konnte leider keine Antwort abgerufen werden. Versuchen Sie es in fünf Minuten erneut oder <link>überprüfen Sie den Status von Rovo</link>.',
  'fabric.editor.ai.experience.aifcRateLimitEnforced':
    'Sie haben die <link>maximale Anzahl Anfragen</link> erreicht. Versuchen Sie es in fünf Minuten erneut.',
  'fabric.editor.ai.experience.aifcTokenLimitExceeded':
    'Der Inhalt ist zu umfangreich und kann daher nicht verarbeitet werden. Wählen Sie weniger Inhalte aus und versuchen Sie es erneut.',
  ...
  'fabric.editor.ai.experience.discardStreamingInDocumennt': 'Anfrage abbrechen und Antwort verwerfen?',
  ...
  'fabric.editor.ai.toolbar.DefineDropdownIconTitle.title': 'Definieren',
  'fabric.editor.ai.toolbar.adjustLength.title': 'Länge anpassen',
  ...
  'fabric.editor.block.menu.copy.content': 'Inhalt kopieren',
  'fabric.editor.block.menu.copy.link': 'Link kopieren',
  'fabric.editor.block.menu.copy.link.to.block': 'Link in Block kopieren',
  'fabric.editor.block.menu.copy.synced.block': 'Synchronisierten Block kopieren',
  'fabric.editor.block.menu.create.synced.block': 'Synchronisierten Block erstellen',
  'fabric.editor.block.menu.decision': 'Entscheidung',
  'fabric.editor.block.menu.delete.block': 'Löschen',
  'fabric.editor.block.menu.layout': 'Layout',
  'fabric.editor.block.menu.link.copied.to.clipboard': 'Link in Zwischenablage kopiert',
  'fabric.editor.block.menu.move.down': 'Nach unten verschieben',
  'fabric.editor.block.menu.move.up': 'Nach oben verschieben',
  'fabric.editor.block.menu.new.lozenge': 'Neu',
  'fabric.editor.block.menu.paragraph': 'Absatz',
  'fabric.editor.block.menu.turn.into': 'Umwandeln in',
  ...
  'fabric.editor.blockControlDragHandleMoveOrOpen': 'Zum Verschieben ziehen {br} Zum Öffnen des Menüs klicken',
  ...
  'fabric.editor.breakoutMaxWidthLabel': 'Maximale Breite',
  ...
  'fabric.editor.contextPanel.panelContentLabel': 'Scrollbarer Inhalt des Kontext-Panels',
  ...
  'fabric.editor.copySyncBlockTooltip': 'Referenz in Zwischenablage kopieren',
  ...
  'fabric.editor.createSyncBlockLabel': 'Synchronisierten Block erstellen',
  ...
  'fabric.editor.deleteConfirmationModalDescriptionSingle':
    '{syncBlockCount, plural, one {Wenn Sie diesen Inhalt löschen, wird auch ein synchronisierter Block entfernt. Referenzen zu diesem Block an anderen Speicherorten werden einen Fehler anzeigen. Möchten Sie mit dem Löschen fortfahren?} other {Wenn Sie diesen Inhalt löschen, werden auch {syncBlockCount,number} synchronisierte Blöcke entfernt. Referenzen zu diesen Blöcken an anderen Speicherorten werden einen Fehler anzeigen. Möchten Sie mit dem Löschen fortfahren?}}',
  'fabric.editor.deleteConfirmationModalTitle': 'Sie sind im Begriff, synchronisierte Inhalte zu löschen',
  ...
  'fabric.editor.editSourceTooltip': 'Zur Quellseite des Synchronisierungsblocks navigieren',
  ...
  'fabric.editor.elementbrowser.featured.whiteboard.description':
    'Verwenden Sie ein Whiteboard, um Ihrer Seite Grafiken hinzuzufügen.',
  ...
  'fabric.editor.error.description.failToCreateWhenOffline':
    'Sie sind anscheinend offline. Verbinden Sie sich bitte mit dem Internet, um synchronisierten Inhalt zu erstellen.',
  'fabric.editor.error.description.failToDeleteWhenOffline':
    'Sie sind anscheinend offline. Verbinden Sie sich bitte mit dem Internet, um synchronisierten Inhalt zu löschen.',
  'fabric.editor.error.description.failToEditWhenOffline':
    'Sie sind anscheinend offline. Verbinden Sie sich bitte mit dem Internet, um synchronisierten Inhalt zu bearbeiten.',
  ...
  'fabric.editor.error.title.failToEdit': 'Synchronisierter Inhalt kann nicht offline bearbeitet werden',
  ...
  'fabric.editor.limitedModeDescription':
    'Um die Geschwindigkeit zu erhöhen und die Antwortzeit zu reduzieren, <learnMoreLink>wurden einige Bearbeitungsfunktionen eingeschränkt</learnMoreLink>.',
  'fabric.editor.limitedModeDescriptionWithoutLink':
    'Um die Geschwindigkeit zu erhöhen und die Antwortzeit zu reduzieren, wurden einige Bearbeitungsfunktionen eingeschränkt.',
  'fabric.editor.limitedModeTitle': 'Geschwindigkeitsoptimierung',
  ...
  'fabric.editor.longEmptyNodePlaceholderPrefix': 'Geben Sie',
  ...
  'fabric.editor.quickinsert.new.lozenge': 'Neu',
  ...
  'fabric.editor.referenceSyncBlockTooltip': 'Synchronisiert von: {title}',
  ...
  'fabric.editor.requestAccessToSyncedBlock': 'Zugriff anfordern',
  'fabric.editor.requestAccessToSyncedBlockError': 'Etwas ist schiefgelaufen. Klicken Sie, um es erneut zu versuchen.',
  ...
  'fabric.editor.shortEmptyNodePlaceholderSuffix': 'ein, um etwas einzufügen',
  ...
  'fabric.editor.syncBlock.toolbar.newLozenge': 'Neu',
  'fabric.editor.syncBlockGroup': 'Synchronisierungsblock-Typen',
  'fabric.editor.syncBlockPlaceholderText':
    'Fügen Sie Inhalte hinzu und kopieren Sie diesen synchronisierten Block anschließend, um in Bereichen darauf zugreifen zu können.',
  'fabric.editor.syncedBlock': 'Synchronisierten Block erstellen',
  'fabric.editor.syncedBlock.description': 'Synchronisieren Sie Inhalte an mehreren Speicherorten.',
  'fabric.editor.syncedBlockGeneralErrorDescription':
    'Beim Laden dieses synchronisierten Blocks ist ein Fehler aufgetreten.',
  'fabric.editor.syncedBlockNotFoundDescription': 'Dieser synchronisierte Block kann nicht geladen werden.',
  ...
  'fabric.editor.syncedBlockPermissionDeniedDescription':
    'Die Quelle dieses synchronisierten Blocks ist ein Inhaltselement, auf das Sie keinen Zugriff haben.',
  'fabric.editor.syncedBlockPermissionDeniedHeading':
    'Sie sind nicht berechtigt, sich diesen synchronisierten Block anzusehen',
  'fabric.editor.syncedBlockPermissionDeniedIconAltText': 'Berechtigung verweigert.',
  ...
  'companyHub.editor.textColor.pickerTitle': 'Textfarbe',
