...
export default {
  ...
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchTitleOld': 'ค้นหาวัตถุ',
  ...
  'linkDataSource.jira-issues.accessRequiredWithSiteOld': 'คุณไม่มีสิทธิ์เข้าถึงเว็บไซต์ต่อไปนี้:',
  ...
  'linkDataSource.jira-issues.configmodal.chooseSiteOld': 'เลือกเว็บไซต์',
  ...
  'linkDataSource.jira-issues.noResultsFoundOld': 'ไม่พบผลลัพธ์',
  ...
  'linkDataSource.jira-issues.unableToLoadResults.visual-refresh-sllv': 'เราพบปัญหาในการพยายามดึงผลลัพธ์',
  'linkDataSource.jira-issues.unableToLoadResultsOld': 'ไม่สามารถโหลดผลลัพธ์ได้',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic.visualRefreshSllv': 'เริ่มพิมพ์หรือใช้ JQL ในการค้นหา',
