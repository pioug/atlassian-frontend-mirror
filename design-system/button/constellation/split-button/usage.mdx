...
1. **Main action button:** The default action that most users will take. Make sure button labels follow the [button content guidelines](/components/button/split-button/usage#content-guidelines). This button can optionally include an icon.
1. **Dropdown menu icon button:** A dropdown button attached to the main action button, separated by a visual divider. This opens a menu of related actions. Requires an accessible name for assistive technologies.
...
<DoDont
  ...
  image={{
    url: repeatDo,
    alt: 'A link issue button with a menu of related link options, such as Link page and Link URL.',
  }}
>
...
<DoDont
  ...
  image={{
    url: repeatDont,
    alt: 'A link issue button with a menu of related link options. The link issue option is repeated in the menu and the button.',
  }}
>
