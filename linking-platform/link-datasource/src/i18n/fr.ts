...
export default {
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Vérifiez votre connexion et actualisez, ou <a>ouvrez cet espace Jira dans Confluence</a> pour examen.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    "Connectez votre compte {providerName} pour collaborer sur l'ensemble des apps Atlassian.",
  ...
  'linkDataSource.issue-line-table.fetch-action-error-generic-description-galaxia':
    'Patientez quelques minutes, puis réessayez. Vérifiez les paramètres de votre espace ou contactez le support si le problème persiste.',
  ...
  'linkDataSource.issueLikeTable.renderType.dateRange.quarterRange': 'De {startMonth} à {endMonth} {year}',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Vérifiez votre connexion et actualisez, ou <a>ouvrez cet espace dans Jira</a> pour examen.',
