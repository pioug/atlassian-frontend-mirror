...
declare const Breadcrumbs: React_2.MemoExoticComponent<React_2.ForwardRefExoticComponent<
  Pick<
    BreadcrumbsProps,
    | 'testId'
    | 'label'
...
export declare const BreadcrumbsItem: MemoExoticComponent<(
  props: BreadcrumbsItemProps,
) => jsx.JSX.Element>;

declare interface BreadcrumbsItemProps extends WithAnalyticsEventsProps {
  /**
...
declare interface BreadcrumbsProps extends WithAnalyticsEventsProps {
