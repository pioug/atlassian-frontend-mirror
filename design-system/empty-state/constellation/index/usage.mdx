...
[Atlassian voice and tone principles for empty states](/content/writing-guidelines/empty-state/).
...
- See all writing guidelines on
  [empty state CTAs](/content/writing-guidelines/empty-state/#call-to-action-cta).

## Related

- For more empty state guidelines and examples, see
  [empty state messaging](/content/writing-guidelines/empty-state/).
...
- Some error messages, such as not found errors, may also fit this component layout. If you use this
  ...
  [error message guidelines](/content/writing-guidelines/writing-error-messages/) and use an
