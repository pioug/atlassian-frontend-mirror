...
1. **Description (optional)**: A short message describing the reason for the state and what to do next. See content guidelines below for details.
1. **Buttons (optional)**: Next steps or a way to dismiss the message. Can be a primary button, secondary button, or link-styled button.
...
When crafting your message, see the [Atlassian voice and tone principles for empty states](/content/writing-guidelines/empty-state/).
