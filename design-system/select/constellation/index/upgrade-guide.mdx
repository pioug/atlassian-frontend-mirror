...
import SelectValidation from '../../examples/constellation/select-validation';
import SelectElementBefore from '../../examples/constellation/select-element-before';
import SelectTooltip from '../../examples/constellation/select-tooltip';
import SelectFilterValues from '../../examples/constellation/select-filter-values';
import SelectOptionWithDesc from '../../examples/constellation/select-options-with-description';
...
Validation messages are now a concern of the @atlaskit/form package.
...
However `@atlaskit/select` provides you with a series of props to augment this behaviour at multiple levels of use,
please see the **custom data structures** section of our [api docs](./code) for more details.
...
<Example
  packageName="@atlaskit/select"
  Component={SelectElementBefore}
  title="Element Before example"
/>

For more information on how to customise filtering and displaying options/values please see the custom data structures section of our [api docs](./code).
...
However, with the **component customisation api** section of our [api docs](./code) wrapping your options in an `@atlaskit/tooltip` instance
...
The intention behind this was to allow you to pass through a series of string values through which the internal filtering logic would be able to reduce search results on.
...
For a more detailed explanation of these configurations, please see the 'Custom Filter' section of the [api page](./code).

If you do however want to use this pattern, below is how you could enable that in `@atlaskit/select`.

<Example
  packageName="@atlaskit/select"
  Component={SelectFilterValues}
...
<Example
  packageName="@atlaskit/select"
  Component={SelectOptionWithDesc}
