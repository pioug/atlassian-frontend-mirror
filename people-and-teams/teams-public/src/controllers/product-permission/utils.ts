 ...
 */
export { getProductPermissionRequestBody } from './getProductPermissionRequestBody';
/**
 * @deprecated Use `import { hasProductPermission } from '@atlaskit/teams-public/product-permission/has-product-permission'` instead.
 */
export { hasProductPermission } from './hasProductPermission';
