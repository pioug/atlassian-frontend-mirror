 ...
 */
export { isCodeViewerItem } from './isCodeViewerItem';
/**
 * @deprecated Use `import { getLanguageType } from '@atlaskit/media-ui/getLanguageType'` instead.
 */
export { getLanguageType } from './getLanguageType';
