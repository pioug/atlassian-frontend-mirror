...
const i18n = defineMessages({
  ...
  modalFooterAutomateButton: {
    ...
    description:
      'The text for an automate button, which executes an automation rule.',
  },
...
export const AutomationModalFooter = ({
  ...
  const sendFooterAnalyticsEvent = (
  ...
  const automateButton = (
    <Button
      ...
      onClick={() => {
        if (selectedRule) {
          sendFooterAnalyticsEvent(
            'executeManualTriggerAutomation',
