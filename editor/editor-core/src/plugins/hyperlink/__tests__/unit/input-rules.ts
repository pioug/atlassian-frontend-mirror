  ...
  describe('input rules', () => {
    ...
    describe('when there is space before the selection', () => {
      it('should not convert "gnu.org" to hyperlink', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(p('loko gnu.org  ')));
      });
    });
    ...
    describe('when there is content before', () => {
      ...
      it('should not create a hyperlink if link is part of a windows filepath', () => {
        const { editorView, sel } = editor(
      ...
      it('should not create a hyperlink if link is part of a windows network filepath', () => {
        const { editorView, sel } = editor(
      ...
      it('should not create a hyperlink if link is part of a unix filepath or network filepath', () => {
        const { editorView, sel } = editor(
      ...
      it('should convert "gnu.org" to hyperlink', () => {
        ...
        const a = link({ href: 'http://gnu.org' })('gnu.org');
        expect(editorView.state.doc).toEqualDocument(doc(p('loko ', a, ' ')));
      });
