...
export const isEqualsOperator = (
  operator: string,
): operator is EqualsOperatorValue =>
  EQUALS_OPERATORS.includes(operator as EqualsOperatorValue);

export const isLikeOperator = (
  operator: string,
): operator is LikeOperatorValue =>
  LIKE_OPERATORS.includes(operator as LikeOperatorValue);

export const isComparisonOperator = (
  operator: string,
): operator is ComparisonOperatorValue =>
