...
<SectionMessage appearance="discovery" title="New" icon={PremiumIcon}>
	...
	<strong>These replace utility icons</strong>, which will soon be deprecated.
</SectionMessage>
...
<SectionMessage appearance="warning" title="Soon to be deprecated">
	Utility icons are being deprecated in favor of core icons, which will now support a new{' '}
