...
const BasicExample = () => {
	...
	const onBlanketClicked = useCallback(() => {
		setOnEventResult('onBlanketClicked called with shouldAllowClickThrough: true');
	...
	return (
		<div>
			...
			<p>Click "Show blanket" button to open the blanket & click the blanket to dismiss it.</p>
			<Blanket
