		...
		<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g clipPath="url(#clip0_503_53432)">
				...
				<path
					...
					stroke="#C1C7D0"
				/>
				<rect x="10" y="14" width="6" height="6" rx="1" fill="#FF5230" />
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					...
					fill="white"
				/>
				<rect x="10" y="24" width="6" height="6" rx="1" fill="#36B37E" />
				<path
					fillRule="evenodd"
					clipRule="evenodd"
					...
					fill="white"
				/>
				<rect x="22" y="16" width="19" height="2" rx="1" fill="#C1C7D0" />
				<rect x="22" y="26" width="19" height="2" rx="1" fill="#C1C7D0" />
			</g>
			<defs>
				<clipPath id="clip0_503_53432">
