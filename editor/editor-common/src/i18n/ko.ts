...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': '안내',
  'fabric.editor.ai.config.item.advancedPrompt.description': '작업, 안내 및 규칙을 구체적으로 입력하세요',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': '창의성',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': '높음',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': '낮음',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': '보통',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    '예: 1. 회사 목표에 대한 개요로 문서를 시작합니다. 2. 첫 주에 만날 주요 팀원의 목록을 만듭니다.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    '특정 산출물을 생성하는 데 도움이 되는 작업 안내를 제공합니다.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    '예: 산출물은 회사 스타일 가이드라인을 따라야 하며 확인되지 않은 데이터는 사용하면 안 됩니다.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': '규칙',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': '따르려는 규칙을 설명하세요.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': '작업을 입력하세요',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    '예: 팀에 합류하는 신규 직원을 위한 온보딩 문서를 만듭니다.',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': '작업',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': '완료해야 하는 작업을 설명하세요.',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': '어조',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': '편안하게',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': '교육적',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': '공감적',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': '중립적',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': '전문적',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': '고급 프롬프트 만들기',
  'fabric.editor.ai.config.item.advancedPrompt.title': '고급 프롬프트 만들기',
