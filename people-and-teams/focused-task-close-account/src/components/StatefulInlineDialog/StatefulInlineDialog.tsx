	...
	render() {
		...
		return (
			<InlineDialog content={content} placement={placement} isOpen={this.state.isOpen}>
				{/* eslint-disable-next-line jsx-a11y/no-static-element-interactions, jsx-a11y/mouse-events-have-key-events, @atlassian/a11y/mouse-events-have-key-events, @atlassian/a11y/mouse-events-have-key-events */}
