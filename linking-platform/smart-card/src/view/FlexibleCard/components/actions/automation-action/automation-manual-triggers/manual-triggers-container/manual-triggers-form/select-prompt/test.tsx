...
describe('Text field input prompt', () => {
  test('should render correct props', () => {
    ...
    expect(selectInputPrompt.getByText(userInputPrompts.displayName)).toHaveAttribute("id", "testUserInput-uid1-label");
    expect(selectInputPrompt.container.querySelector('input[name="testUserInput"]')).toBeInTheDocument();
  });
