...
- [major][ea4b2d1895](https://bitbucket.org/atlassian/atlassian-frontend/commits/ea4b2d1895):

  @atlaskit/nps has been converted to TypeScript to provide static typing. Flow types are no longer provided. No API or bahavioural changes.
