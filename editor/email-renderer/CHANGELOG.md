...
-   [#10124](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/10124)
    [`63b16140520`](https://bitbucket.org/atlassian/atlassian-frontend/commits/63b16140520) -
    ADFS-70 Allow marks on media single. This is to allow media items to be used as links in the
    email renderer
...
-   [#9027](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/9027)
    [`985d30e44ef`](https://bitbucket.org/atlassian/atlassian-frontend/commits/985d30e44ef) -
    Upgraded dependency 'juice' to ^7.0.0 to remove vulnerable transitive dependency 'request'
...
-   [minor][22af1d9ddd](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/22af1d9ddd):
    ...
    FS-4032 - Remove background styling from actions and decisions in email. Unable to support
    hover.
