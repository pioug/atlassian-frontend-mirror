...
const descriptionKeys: DescKey[] = ['None', 'Short', 'Medium', 'Long', 'Overlong'];
...
export function TeamCustomizer({ setTeam }: { setTeam: (team: Team) => void }): React.JSX.Element {
	...
	return (
		<div>
			Header
			<Radios label="header" options={[true, false]} setter={setHeader} currentValue={useHeader} />
			Team name
			<Radios label="team-name" options={nameKeys} setter={setName} currentValue={name} />
			Members
			<Radios
				label="members"
