...
class StatusInternal extends PureComponent<Props, any> {
	...
	render() {
		...
		return (
			// eslint-disable-next-line @atlassian/a11y/no-static-element-interactions, @atlassian/a11y/interactive-element-not-keyboard-focusable, @atlassian/a11y/click-events-have-key-events
			<span
