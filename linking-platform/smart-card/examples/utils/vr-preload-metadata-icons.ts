// Preload badge icons from getLazyIcons()
// These icons are flaky on the build pipelines.
// Adding this file to the vr test file to preload the icon packages.

import '@atlaskit/icon/core/task'; // IconType.CheckItem
...
import '@atlaskit/icon/core/subtasks'; // IconType.SubTasksProgress
