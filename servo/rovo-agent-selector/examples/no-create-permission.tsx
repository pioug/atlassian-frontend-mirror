...
import type { noCreatePermissionRovoAgentSelectorQuery } from './__generated__/noCreatePermissionRovoAgentSelectorQuery.graphql';
...
const TestRenderer = () => {
	const data = useLazyLoadQuery<noCreatePermissionRovoAgentSelectorQuery>(
		graphql`
			query noCreatePermissionRovoAgentSelectorQuery($cloudId: ID!, $cloudIdString: String!) {
