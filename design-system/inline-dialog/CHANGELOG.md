...
- [`3fe62800cf49a`](https://bitbucket.org/atlassian/atlassian-frontend-monorepo/commits/3fe62800cf49a) -
  Experimental React 19 support: widen the peer dependency range and fix the placement example's
  missing React key. Test coverage remains partial.
- Updated dependencies
