...
import { monitorForElements } from '@atlaskit/pragmatic-drag-and-drop/adapter/elements';
...
[Learn more about event ordering](/components/pragmatic-drag-and-drop/how-it-works/events)
