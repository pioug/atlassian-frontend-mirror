import { createRenameJSXFunc, createTransformer } from '../utils';

const renamethemeTokensImport = createRenameJSXFunc(
	'@atlaskit/textfield',
	'themeTokens',
	'TextFieldColors',
	'DSTextFieldColors',
...
const renameThemeAppearanceImport = createRenameJSXFunc(
	'@atlaskit/textfield',
	'ThemeAppearance',
	'Appearance',
...
const transformer = createTransformer([renamethemeTokensImport, renameThemeAppearanceImport]);
