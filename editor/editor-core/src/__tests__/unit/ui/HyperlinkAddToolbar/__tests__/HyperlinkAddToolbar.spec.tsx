...
import { ActivityError, ActivityProvider } from '@atlaskit/activity-provider';
import { CreateUIAnalyticsEvent } from '@atlaskit/analytics-next';
import { INPUT_METHOD } from '@atlaskit/editor-common/analytics';
import {
  HyperlinkLinkAddToolbarProps as HyperlinkAddToolbarProps,
...
import { hideLinkToolbar as cardHideLinkToolbar } from '../../../../../plugins/card/pm-plugins/actions';
...
import {
  ...
  onClickAwayCallback,
  onEscapeCallback,
} from '@atlaskit/editor-plugin-hyperlink/src/commands';

// eslint-disable-next-line @atlassian/tangerine/import/entry-points
import { stateKey as hyperlinkStateKey } from '@atlaskit/editor-plugin-hyperlink/src/pm-plugins/main';
...
describe('HyperlinkLinkAddToolbar', () => {
  ...
  describe('others', () => {
    it('should call card hideLinkToolbar when mousedown outside element', async () => {
      const { eventListenerMap, editorView } = await setup();
    ...
    it('should not call card hideLinkToolbar when mousedown inside element', async () => {
      const { eventListenerMap, component, editorView } = await setup();
