...
const sortByRelevance: ReactionSummarySortFunction = (a: ReactionSummary, b: ReactionSummary) => {
	if (a.count > b.count) {
		return -1;
...
const sortByPreviousPosition = (reactions: ReactionSummary[]): ReactionSummarySortFunction => {
...
export const readyState = (reactions: ReactionSummary[]): ReactionsReadyState => ({
