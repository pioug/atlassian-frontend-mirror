...
## Anatomy
![Inline Dialog Anatomy](images/anatomy.png)
...
- Inline dialogs should be used to alert users about further information or actions needed within a section of a screen. They shouldn’t be used for information that relates to the page as a whole

- This is a focused component, so only one dialog can be open at a time

- A great use for inline dialogs is feature discovery

## Content guidelines

Text in an inline dialogs should be concise to get the point across as quickly as possible.
...
- See [flags](/components/flags) for messages containing confirmations, alerts, and acknowledgments that require minimal user interaction
