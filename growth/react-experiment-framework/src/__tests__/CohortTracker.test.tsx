...
describe('CohortTracker', () => {
	...
	it('should call onExposure when mounted', () => {
		...
		expect(mockOnExposure).toBeCalledWith(mockExposureDetails, mockEnrollmentOptions);
	});

	it('should not have a presence in the dom', () => {
		const wrapper = shallow(
			<CohortTracker exposureDetails={mockExposureDetails} onExposure={mockOnExposure} />,
		);
