const messages = {
  successFlag: {
    ...
    description:
      'Text for a success flag when an automation rule has been triggered',
  },
  failureFlagTitle: {
    id: 'automation-platform.common.failure-flag-title',
    defaultMessage: 'Oops we ran into a problem',
    description:
      'Title for an error flag when an automation rule failed to be triggered',
  },
  failureFlagDescription: {
    id: 'automation-platform.common.failure-flag-description',
    defaultMessage:
      "There was a problem and we couldn't run the automation '{0}'",
    description:
      'Description for an error flag when an automation rule failed to be triggered',
  },
  ...
  errorInputMustNotBeEmpty: {
    ...
    description:
      'The error message to show the value of a required field is empty',
  },
  ...
  errorInputTypeIsNotSupported: {
    ...
    description:
      'The error message to show when the type of user input is not recognised',
  },
