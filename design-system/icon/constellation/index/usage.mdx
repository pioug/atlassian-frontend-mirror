...
import settingsDo from './images/settings-do-light.png';
import settingsDoDark from './images/settings-do-dark.png';
import settingsDont from './images/settings-dont-light.png';
import settingsDontDark from './images/settings-dont-dark.png';
import menuDo from './images/menu-do-light.png';
import menuDoDark from './images/menu-do-dark.png';
import menuDont from './images/menu-dont-light.png';
import menuDontDark from './images/menu-dont-dark.png';
import iconTileLight from './images/icon-tile-light.png';
import iconTileDark from './images/icon-tile-dark.png';
import iconSpacing from './images/icon-spacing-light.png';
import iconSpacingDark from './images/icon-spacing-dark.png';
import iconSmall from './images/small-icons-light.png';
import iconSmallDark from './images/small-icons-dark.png';
...
<SectionMessage appearance="warning">
	...
	<p>
		See the <a href="/components/icon/examples#spacing-props">examples page</a> for migration
		guidance.
	</p>
</SectionMessage>
...
<Image src={iconSpacing} srcDark={iconSpacingDark} alt="Icon with two different sizes." />
...
<Image
	src={iconSmall}
	srcDark={iconSmallDark}
	alt="Diagram of 12 pixel small icons in components. The chevron icon in the select field and the drag handle dots icon are both 12 px."
/>
