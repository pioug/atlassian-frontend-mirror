...
import { Example as Example2 } from '../../../examples/exif-orientations-vr.vr.ap';
...
import Example7 from '../../../examples/vr-media-inline-card-text-wrap.vr.ap';
import Example8 from '../../../examples/vr-media-inline-card.vr.ap';
