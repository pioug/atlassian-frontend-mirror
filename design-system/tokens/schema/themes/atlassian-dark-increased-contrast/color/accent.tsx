...
const color: ExtendedValueSchema<AccentColorTokenSchema<BaseToken>> = {
	color: {
		...
		border: {
			accent: {
				blue: { '[default]': { value: 'Blue300' } },
				red: { '[default]': { value: 'Red300' } },
				orange: { '[default]': { value: 'Orange300' } },
				yellow: { '[default]': { value: 'Yellow300' } },
				green: { '[default]': { value: 'Green300' } },
				purple: { '[default]': { value: 'Purple300' } },
				teal: { '[default]': { value: 'Teal300' } },
				magenta: { '[default]': { value: 'Magenta300' } },
				lime: { '[default]': { value: 'Lime300' } },
				gray: { '[default]': { value: 'DarkNeutral800' } },
			},
		},
		background: {
			accent: {
