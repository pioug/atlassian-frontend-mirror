...
[Typography foundations](/foundations/typography-beta#heading).
...
See the [Heading provider example](/components/heading/examples#heading-provider) for more
information.
...
See the [color example](/components/heading/examples#color) for more information.
