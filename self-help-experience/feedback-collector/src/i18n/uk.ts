...
export default {
  'feedback-collector.can-be-contacted.label':
    'Atlassian може зв’язатися зі мною щодо цього відгуку',
  'feedback-collector.cancel-button.label': 'Скасувати',
  'feedback-collector.enrol-in-research.label':
    'Я хочу взяти участь у дослідженні продукту',
  ...
  'feedback-collector.form.suggestion.label':
    'Розкажіть, що б ви хотіли покращити',
  ...
  'feedback-collector.success-flag.description':
    'Ваші відгуки допомагають нам постійно покращувати продукти.',
