...
-   [#2093](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/2093)
    [`359575566a`](https://bitbucket.org/atlassian/atlassian-frontend/commits/359575566a) -
    [NO-ISSUE] Move the WidthDetector deprecated warning to the constructor avoid unnecessary logs
    everywhere.- Updated dependencies
