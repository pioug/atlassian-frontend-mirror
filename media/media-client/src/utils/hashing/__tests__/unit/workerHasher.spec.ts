...
describe('WorkerHasher', () => {
	...
	it('should hash provided blobs', () => {
		...
		expect(fakeWorkers[0].addEventListener).toHaveBeenCalledWith('message', expect.anything());
		expect(fakeWorkers[1].addEventListener).toHaveBeenCalledWith('message', expect.anything());
		expect(fakeWorkers[2].addEventListener).toHaveBeenCalledWith('message', expect.anything());
