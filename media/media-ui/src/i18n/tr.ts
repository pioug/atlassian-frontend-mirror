...
export default {
  ...
  'fabric.media.or_select_default_avatars': 'Bir fotoğraf yükleyin veya bazı varsayılan seçeneklerden belirleyin',
  ...
  'fabric.media.select_an_avatar_from_all_defaults': 'Tüm varsayılan seçeneklerden belirleyin',
