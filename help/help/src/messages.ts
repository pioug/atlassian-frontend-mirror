...
export const messages = defineMessages({
	...
	help_article_rating_form_contact_me: {
		...
		description: 'Text for the "Contact me" checkbox in the article rating form',
	},
	...
	help_related_article_endpoint_error_title: {
		...
		description: 'Title for the message displayed when the related articles fetching fails',
	},
	...
	help_related_article_endpoint_error_button_label: {
		...
		defaultMessage: `Try Again`,
		description: 'text for the retry button displayed when the related articles fetching fails',
	},
	...
	help_article_error_button_label: {
		...
		description: 'text for the retry button displayed when an article fetching fails',
	},
	help_search_error: {
