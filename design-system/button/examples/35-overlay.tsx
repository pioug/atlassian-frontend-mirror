				...
				<tbody>
					{variants.map(({ name, Component }) => (
						<tr key={name}>
							...
							<td>
								<Component key={name} overlay={overlay ? overlayElement : undefined}>
									Button
								</Component>
							</td>
							<td>
								<Component key={name} overlay={overlay ? overlayElement : undefined} isSelected>
									Button
								</Component>
							</td>
							<td>
								<Component key={name} overlay={overlay ? overlayElement : undefined} isDisabled>
									Button
								</Component>
							</td>
							<td>
