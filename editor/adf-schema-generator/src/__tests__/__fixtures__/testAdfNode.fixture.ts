...
export const expectedNodes: string[] = [
	...
	'export const decisionList: PMNodeSpecFactoryInstance<DecisionListNode> = createPMNodeSpecFactory<DecisionListNode>({"content":"paragraph+","marks":"_","group":"block","selectable":false})',
	...
	'export const emoji: PMNodeSpecFactoryInstance<EmojiNode> = createPMNodeSpecFactory<EmojiNode>({"group":"inline","inline":true,"attrs":{"shortName":{"default":""},"id":{"default":""},"text":{"default":""}},"selectable":true})',
	'export const hardBreak: PMNodeSpecFactoryInstance<HardBreakNode> = createPMNodeSpecFactory<HardBreakNode>({"group":"inline","inline":true,"selectable":false,"linebreakReplacement":true})',
	...
	'export const paragraphWithAlignment: PMNodeSpecFactoryInstance<ParagraphWithAlignmentNode> = createPMNodeSpecFactory<ParagraphWithAlignmentNode>({"content":"inline*","marks":"code annotation","group":"block","selectable":false})',
	...
	'export const paragraphWithNoMarks: PMNodeSpecFactoryInstance<ParagraphWithNoMarksNode> = createPMNodeSpecFactory<ParagraphWithNoMarksNode>({"content":"inline*","marks":"code annotation","group":"block","selectable":false})',
	"export interface PlaceholderDefinition {type: 'placeholder'}",
	'export type PlaceholderNode = PMNode & PlaceholderDefinition',
	'export const placeholder: PMNodeSpecFactoryInstance<PlaceholderNode> = createPMNodeSpecFactory<PlaceholderNode>({"marks":"","group":"inline","inline":true})',
	...
	'export const testDoc: PMNodeSpecFactoryInstance<TestDocNode> = createPMNodeSpecFactory<TestDocNode>({"content":"(block | blockRootOnly)+","marks":"alignment"})',
	...
	'export const textCodeInline: PMNodeSpecFactoryInstance<TextCodeInlineNode> = createPMNodeSpecFactory<TextCodeInlineNode>({"group":"inline"})',
];

export const expectedMarks: string[] = [
	"import { createPMMarkSpecFactory, type PMMarkSpecFactoryInstance } from '../../schema/createPMSpecFactory'",
	...
	'export const alignment: PMMarkSpecFactoryInstance<AlignmentMark> = createPMMarkSpecFactory<AlignmentMark>({"attrs":{"align":{"default":"center"}},"excludes":"indentation"})',
	...
	'export const annotation: PMMarkSpecFactoryInstance<AnnotationMark> = createPMMarkSpecFactory<AnnotationMark>({"attrs":{"id":{"default":""},"annotationType":{"default":"inlineComment"}},"inclusive":true})',
	'export interface CodeDefinition {type: "code"}',
	'export type CodeMark = Mark',
	'export const code: PMMarkSpecFactoryInstance<Mark> = createPMMarkSpecFactory({"inclusive":true,"excludes":"fontStyle"})',
];
