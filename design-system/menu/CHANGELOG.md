...
-   [#58913](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/58913)
    ...
    [ux] This change includes heading role for HeadingItem and new prop `headingLevel` to specify
    the level of heading to be defined by assistive technologies.
...
-   [#41571](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/41571)
    ...
    codemod to convert link item components with invalid `href` attributes to button items. The
    `href` attribute will be required for link items in a later major upgrade. Using this will ease
    the transition.
...
-   [#37339](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/37339)
    [`71c51a488d7`](https://bitbucket.org/atlassian/atlassian-frontend/commits/71c51a488d7) -
    Removes max-height constraint on compact density.
...
-   [#35038](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/35038)
    ...
    internal menu context now can have no border or notch for the selected state. This is being
    tested under a feature flag and if successful will be available in a later release.
...
-   [#31691](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/31691)
    [`a8debc96871`](https://bitbucket.org/atlassian/atlassian-frontend/commits/a8debc96871) -
    Internal update to menu primitive so it renders a span instead of a div as child of button.
...
-   [#30362](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/30362)
    ...
    Adds a new spacing prop to on `MenuGroup`. The prop can be used to control the content density
...
-   [`bcbd0c5b5bf`](https://bitbucket.org/atlassian/atlassian-frontend/commits/bcbd0c5b5bf) - Fix
    text color styling of disabled descriptions in menu and link items
...
-   [#25860](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/25860)
    [`3acf8a89149`](https://bitbucket.org/atlassian/atlassian-frontend/commits/3acf8a89149) -
...
-   [#24710](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/24710)
    [`8f2153a45a7`](https://bitbucket.org/atlassian/atlassian-frontend/commits/8f2153a45a7) -
    Convert Menu Group to use primitives.
-   Updated dependencies
...
-   [#23381](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/23381)
    ...
    items no longer intercept mouse down events to force focus or blur behavior depending on the
...
-   [`96cfc6c1c7f`](https://bitbucket.org/atlassian/atlassian-frontend/commits/96cfc6c1c7f) -
    Deprecates the `cssFn` and `overrides` APIs in '@atlaskit/menu'. These APIs are not performant
    and allow unbounded customisation of the Menu components. These APIs will be removed in a future
    release.
-   Updated dependencies
...
-   [#16405](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/16405)
    ...
    supported `testId` prop instead. The `data-testid` prop was unintentionally removed in a
    previous version however will be removed as a breaking change in a later major version and
    remains not officially typed.
...
-   [`63888b03b49`](https://bitbucket.org/atlassian/atlassian-frontend/commits/63888b03b49) -
    Internal refactor to align style declarations to common techstack.
...
-   [#13864](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/13864)
    [`224028babd3`](https://bitbucket.org/atlassian/atlassian-frontend/commits/224028babd3) - Menu
    now uses the design system and emotion styling techstacks.
-   [`506282a89f2`](https://bitbucket.org/atlassian/atlassian-frontend/commits/506282a89f2) - [ux]
    Menu items now have their text color set using `currentColor` instead of using colors directly
    off the palette.
...
-   [`f5a527024d4`](https://bitbucket.org/atlassian/atlassian-frontend/commits/f5a527024d4) -
    Suppress `@atlaskit/design-system/ensure-design-token-usage` token fallback errors.
-   Updated dependencies
...
-   [#10569](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/10569)
    [`1648daf0308`](https://bitbucket.org/atlassian/atlassian-frontend/commits/1648daf0308) -
    Updates button item props.
...
-   [#10255](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/10255)
    [`9ea5f8887cd`](https://bitbucket.org/atlassian/atlassian-frontend/commits/9ea5f8887cd) -
    Internal change to menu styling to allow for the separator color to be customisable in
    side-navigation
...
-   [`11fea0f7e4b`](https://bitbucket.org/atlassian/atlassian-frontend/commits/11fea0f7e4b) -
    Memoise menu item variants
...
-   [#2393](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/2393)
    ...
    characters with descenders (eg. 'g', 'j', 'p') in Menu Items from being clipped by increasing
    the line-height.
...
-   [patch][ed8d8dea65](https://bitbucket.org/atlassian/atlassian-frontend/commits/ed8d8dea65):
    ...
    Fixes users being able to select text and drag both the link and custom item components.-
    Updated dependencies
...
-   [minor][795a9503da](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/795a9503da):
    ...
    -   **BREAKING:** Height for all `Item` components when there is no `description` defined now
        equals `40px`.
    -   **BREAKING:** `SkeletonHeadingItem` & `SkeletonItem` now match the real components
        dimensions, this means they will no longer move things around when swapping them in & out.
    -   `SkeletonHeadingItem` has had its width slightly increased.
    -   `Skeleton` items now have a shimmer effect that you can opt into with the `isShimmering`
        prop.
...
-   [patch][eaca633b3d](https://bitbucket.org/atlassian/atlaskit-mk-2/commits/eaca633b3d):
    ...
    Style ItemSkeletons and ItemHeadings. Add the ability to add icon or avatar and configure
    skeleton width.
