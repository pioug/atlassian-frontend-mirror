...
export default {
  ...
  'fabric.linking.direct_access_description_crossjoin': '您的團隊使用 {product} 協作，您可以立即開始使用！',
  'fabric.linking.direct_access_title_crossjoin': '加入 {product} 以檢視此內容',
  ...
  'fabric.linking.forbidden_description_crossjoin': '請連絡您的管理員以要求 {hostname} 存取權。',
  ...
  'fabric.linking.no_access_title_crossjoin': '加入 {product} 以檢視此內容',
  ...
  'fabric.linking.request_access_description_crossjoin': '您的團隊使用 {product} 來協作。向您的管理員傳送存取要求。',
