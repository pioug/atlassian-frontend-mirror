...
import type { BasePlugin, BasePluginState } from '@atlaskit/editor-plugins/base';
import type {
...
export const MobileAppearance = forwardRef<HTMLDivElement, MobileAppearanceProps>(
	function MobileAppearance(
		...
		const api =
			...
			>();
		const { maxContentSizeState, mobileDimensionsState } = useSharedPluginState(api, [
			'maxContentSize',
			'mobileDimensions',
		]);
