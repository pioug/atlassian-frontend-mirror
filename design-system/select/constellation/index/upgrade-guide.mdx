...
please see the **custom data structures** section of our [api docs](./api) for more details.
...
For more information on how to customise filtering and displaying options/values please see the custom data structures section of our [api docs](./api).
...
However, with the **component customisation api** section of our [api docs](./api) wrapping your options in an `@atlaskit/tooltip` instance
...
For a more detailed explanation of these configurations, please see the 'Custom Filter' section of the [api page](./api).
