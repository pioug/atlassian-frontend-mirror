					...
					onChange={() => {
						...
						switch (attribute) {
							case 'thisWeek':
								...
								dateTimeInMilliSeconds = new Date(today).setDate(today.getDate() - 1);
								break;
							...
							case 'lastMonth':
								...
								dateTimeInMilliSeconds = new Date(today).setMonth(today.getMonth() - 1);
								break;

							case 'aFewMonths':
								dateTimeInMilliSeconds = new Date(today).setMonth(today.getMonth() - 3);
								break;

							case 'severalMonths':
								dateTimeInMilliSeconds = new Date(today).setMonth(today.getMonth() - 7);
								break;

							case 'moreThanAYear':
								dateTimeInMilliSeconds = new Date(today).setMonth(today.getMonth() - 13);
								break;
			...
			<StoryWrapper>
				<ProfileCardWrapper>
					<ProfileCard
						...
						companyName={this.state.hasCompanyName ? this.state.companyName : ''}
						meta={this.state.hasMeta ? meta : ''}
						nickname={this.state.nickname}
						timestring={this.state.hasTime ? getTimeString(this.state.hasWeekday) : ''}
						reportingLines={{
							managers: this.state.hasManagers ? reportingLinesData.managers : undefined,
							reports: this.state.hasDirectReports ? reportingLinesData.reports : undefined,
						}}
						reportingLinesProfileUrl={this.state.hasReportingLineProfileUrl ? '/' : undefined}
