...
export default {
  ...
  "fabric.emoji.choose.file.screenReaderDescription": "Válassz fájlt a hangulatjelnek. JPG, PNG vagy GIF. Maximális méret: 1 MB.",
  ...
  "fabric.emoji.select.skin.tone.ariaLabel": "Bőrszín kiválasztása: {selectedTone}"
};
