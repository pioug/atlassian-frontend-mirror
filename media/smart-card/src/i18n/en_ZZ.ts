...
export default {
  ...
  'fabric.linking.annotate.confirmation.close.anyway':
    '⁣⁢Close anyway‍‍⁫⁫⁪⁭⁭⁠⁭⁠⁫⁮⁭⁭⁭‌⁠⁬⁯⁫⁮⁯؜⁬⁬⁭⁣⁤',
  ...
  'fabric.linking.annotate.tool.line.thickness':
    '⁣⁢Line thickness‌⁮⁠⁪‍⁡⁯⁫⁠⁫⁮؜⁭⁠⁠⁡⁭⁪؜⁬⁫؜⁣⁤',
  ...
  'fabric.linking.connect_link_account':
    '⁣⁢Connect to preview‍؜⁯⁪‍⁮⁪⁠⁪‍؜⁬⁡⁡‍⁭⁬⁮⁯⁯⁮⁣⁤',
  'fabric.linking.connect_link_account_card_view':
    '⁣⁢Connect‌‍؜⁡؜⁬⁠⁫‍⁮‍⁭⁬⁠⁠⁯؜⁯⁣⁤',
  ...
  'fabric.linking.couldnt_load_file':
  ...
  'fabric.linking.disable_fullscreen':
    '⁣⁢disable fullscreen‌⁡؜⁡⁡⁡⁫‍⁬‌‍‍⁠‍‌⁬‌‌‍⁮؜⁯⁡⁣⁤',
  'fabric.linking.display_thumbnail':
    '⁣⁢Display thumbnail⁭؜⁠⁠‌⁮‍‍⁫⁮⁡⁫‍⁯⁮⁯⁠⁮⁫⁪⁮⁣⁤',
  ...
  'fabric.linking.drop_your_files_here':
  ...
  'fabric.linking.failed_to_upload':
    '⁣⁢Failed to upload⁮⁬⁬‍⁫⁮‌⁫⁡⁯⁬⁫⁮⁯⁮⁫⁠⁭‌⁫؜⁠‍⁯؜⁡⁡⁡⁣⁤',
  ...
  'fabric.linking.playback_default_speed':
    '⁣⁢Default‍⁪⁬⁡⁯⁪⁬⁡⁫⁫⁬⁭‌⁬⁭⁮⁬⁮⁬⁪⁠‍⁬⁬⁣⁤',
  ...
  'fabric.linking.preview_unavailable':
    '⁣⁢Preview unavailable⁮⁮‌⁠⁯⁪‍⁮⁯‌‌‌‍؜‍⁪⁠⁫⁯⁮⁬⁣⁤',
  ...
  'fabric.linking.request_access_pending':
    '⁣⁢Access pending⁮⁯‍⁪⁭⁬⁬⁭⁯⁪‍⁫⁭⁯؜‌⁫⁫⁡⁫⁯⁡⁠⁣⁤',
  ...
  'fabric.linking.search_all_gifs':
    '⁣⁢Search all the GIFs!⁯⁠⁬‌⁪⁮‍⁭⁫؜⁡⁮؜⁮‌⁠⁮⁯⁡⁫‌⁫⁯⁪⁣⁤',
  ...
  'fabric.linking.something_went_wrong':
