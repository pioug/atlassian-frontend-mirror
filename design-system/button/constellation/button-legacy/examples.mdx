...
You should never put a tooltip on a disabled button. For more information see our [usage guidelines](/components/button/button-legacy/usage#do-not-put-tooltips-on-disabled-buttons).
