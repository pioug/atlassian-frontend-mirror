...
import { Object as ObjectNode } from '../object';
...
describe('Object', () => {
	describe('hasProperty', () => {
		it('returns true when the property exists on the object', () => {
			...
			const result = ObjectNode.hasProperty(node, 'padding');
		...
		it("returns false when the property doesn't exist on the object", () => {
			...
			const result = ObjectNode.hasProperty(node, 'margin');
	...
	describe('isFlat', () => {
		it('returns true when the object contains no nested values', () => {
			...
			const result = ObjectNode.isFlat(node);
			expect(result).toBe(true);
		});
	...
	describe('containsSpreadProps', () => {
		it('returns true when the object has spread props', () => {
			...
			const result = ObjectNode.containsSpreadProps(node);
			expect(result).toBe(true);
		});
	...
	describe('getEntryByPropertyName', () => {
		it('returns an entry when an entry with that property name exists', () => {
			...
			const result = ObjectNode.getEntryByPropertyName(node, 'padding');
		...
		it("returns undefined when an entry with that property name doesn't exist", () => {
			...
			const result = ObjectNode.getEntryByPropertyName(node, 'margin');
	...
	describe('getProperty', () => {
		it('returns the property when it exists on the object', () => {
			...
			const result = ObjectNode.getProperty(node, 'padding');
		...
		it("returns undefined when the property doesn't exist on the object", () => {
			...
			const result = ObjectNode.getProperty(node, 'margin');
	...
	describe('getEntries', () => {
		it('returns an array containing an element for each entry', () => {
			...
			const result = ObjectNode.getEntries(node);

			expect(result.length).toBe(2);
			expect(((result[0] as Property).key as PrivateIdentifier).name).toBe('padding');
			expect(((result[1] as Property).key as PrivateIdentifier).name).toBe('margin');
		});
	...
	describe('getValueByPropertyName', () => {
		it('returns the value when the it exists on the object', () => {
			...
			const result = ObjectNode.getValueByPropertyName(node, 'padding');
	...
	describe('updateValue', () => {
		it('calls fixer.replaceText()', () => {
			...
			ObjectNode.updateValue(node, 'padding', 'space.100', fixer);
	...
	describe('appendEntry', () => {
		it('calls fixer.insertText()', () => {
			...
			ObjectNode.appendEntry(node, 'padding', 'space.100', fixer);
	...
	describe('deleteEntry', () => {
		it('calls fixer.remove()', () => {
			...
			ObjectNode.deleteEntry(node, 'padding', fixer);
