 ...
 * @codegen <<SignedSource::4ae791920572f5e487141c53b822cf49>>
 ...
 */
export function SearchLogo({ label, testId }: AppLogoProps) {
	return <LogoWrapper svg={svg} label={label || 'Search'} testId={testId} />;
}
