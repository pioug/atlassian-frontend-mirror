	...
	describe('analytics', () => {
		...
		describe('contentRetrievalPerformed events', () => {
			function testContentRetrievalPerformedAnalytics({
				...
				analyticsEventHandler: (event: GasPurePayload | GasPureScreenEventPayload) => void;
			}) {
				let onReadyEditorActions: EditorActions;

				render(
					<FabricAnalyticsListeners client={analyticsClient(analyticsEventHandler)}>
						<EditorContext editorActions={editorActions}>
							<Editor
								onEditorReady={(localEditorActions) => (onReadyEditorActions = localEditorActions)}
								{...editorProps}
							/>
						</EditorContext>
					</FabricAnalyticsListeners>,
				...
				const editorActionsFinal = useOnReadyEditorActions ? onReadyEditorActions! : editorActions;
