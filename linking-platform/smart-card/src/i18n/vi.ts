...
export default {
  ...
  "fabric.linking.forbidden_description": "Bạn không có quyền truy cập vào bản xem trước này. Hãy liên hệ với quản trị viên trang web nếu bạn cần quyền truy cập.",
  ...
  "fabric.linking.request_denied_description": "Yêu cầu quyền truy cập của bạn đã bị từ chối. Hãy liên hệ với quản trị viên trang web nếu bạn vẫn cần quyền truy cập.",
