...
describe('formatter', () => {
	...
	it('should parse token', () => {
		...
		expect(result).toEqual(
			expect.stringContaining(`export type InternalTokenIds =  | 'color.brand';`),
		);
	});
	...
	it('should preserve camelCase tokens', () => {
		...
		expect(result).toEqual(
			expect.stringContaining(`export type InternalTokenIds =  | 'color.specialAccent';`),
		);
	});
	...
	it('should omit palette tokens', () => {
		...
		expect(result).toEqual(expect.stringContaining(`// No active tokens in this theme\nexport {}`));
	});
	...
	it('should parse deeply nested token', () => {
		...
		expect(result).toEqual(
			expect.stringContaining(`export type InternalTokenIds =  | 'color.accent.brand';`),
		);
	});
