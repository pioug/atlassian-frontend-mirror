 ...
 * @codegen <<SignedSource::6664c66d9ad9369b2e719a2eb006614b>>
...
const svg = `<svg height="100%" viewBox="0 0 327 32">
    <g clip-path="url(#clip0_95164_15622)">
        ...
        <g clip-path="url(#clip1_95164_15622)">
    ...
    <defs>
        <clipPath id="clip0_95164_15622">
            <path fill="var(--icon-color, white)" d="M0 0h326.667v32H0z"/>
        </clipPath>
        <clipPath id="clip1_95164_15622">
            <path fill="var(--icon-color, white)" d="M6.375 6.958h19.063v19.063H6.375z"/>
        </clipPath>
    </defs>
</svg>
`;
