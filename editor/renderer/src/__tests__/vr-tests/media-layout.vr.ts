...
snapshot(MediaWrappedLayout, {
  description:
    'should render 2 media items in 1 line when wrapped with text in between',
});

snapshot(MediaWrappedLayoutSplit, {
  description:
    'should render 2 media items in 2 lines when wrapped with a large enough width',
});

// ED-14454
snapshot(MediaWrappedLayoutShiftUp, {
  description:
    'should not let content outside renderer slide up next to wrapped media',
});
