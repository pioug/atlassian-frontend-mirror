...
-   [#7425](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/7425)
    ...
    Re-generated icons using newer version of build process, and added missing 'archive' and
    'mobile' buttons
...
-   [#7539](https://bitbucket.org/atlassian/atlassian-frontend/pull-requests/7539)
    [`5a25ec3086`](https://bitbucket.org/atlassian/atlassian-frontend/commits/5a25ec3086) -
    Regenerate icon-sprite after forcing resolution for xmldom to `^0.2.1`.
