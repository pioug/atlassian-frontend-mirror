...
export default {
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Provjerite svoju vezu i osvježite ili <a>otvorite ovaj Jira prostor u Confluenceu</a> za pregled.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Povežite svoj {providerName} račun radi suradnje na radovima u sklopu Atlassian aplikacija.',
