...
export default {
  ...
  'fabric.media.annotate.confirmation.close.anyway':
    '⁣⁢Close anyway‍‍⁫⁫⁪⁭⁭⁠⁭⁠⁫⁮⁭⁭⁭‌⁠⁬⁯⁫⁮⁯؜⁬⁬⁭⁣⁤',
  ...
  'fabric.media.annotate.tool.line.thickness':
    '⁣⁢Line thickness‌⁮⁠⁪‍⁡⁯⁫⁠⁫⁮؜⁭⁠⁠⁡⁭⁪؜⁬⁫؜⁣⁤',
  ...
  'fabric.media.cant_retrieve_files':
    '⁣⁢Ouch! We could not retrieve any files⁭⁬⁫⁬⁠‍؜؜‌؜⁡⁯‌⁡⁪⁭؜⁫⁬⁠⁫⁣⁤',
  'fabric.media.cant_retrieve_gifs':
    '⁣⁢Ouch! We could not retrieve any GIFs⁮⁬‍⁭⁬‍⁪⁯‍⁪⁬⁡⁮⁡⁫؜⁮⁯؜؜؜⁬⁭⁣⁤',
  'fabric.media.change_view': '⁣⁢Change view⁪⁪⁯⁠⁯⁠⁯⁪⁫⁡⁫‌⁡‌⁭‍⁭⁮⁪⁫‍‌⁣⁤',
  'fabric.media.check_your_network':
  ...
  'fabric.media.could_not_load_editor':
    '⁣⁢Ouch! We could not load the editor⁬⁡⁠⁪⁡⁯⁭؜⁫⁮⁫⁬⁠⁡⁠‍⁪⁪⁡⁯⁣⁤',
  'fabric.media.could_not_save_image':
    '⁣⁢Ouch! We could not save the image⁪⁠⁯⁠⁬⁯⁯⁪⁭⁡‍⁪⁡⁠⁭⁪⁯‍⁯؜‍⁫⁣⁤',
  ...
  'fabric.media.couldnt_load_file':
  ...
  'fabric.media.disable_fullscreen':
    '⁣⁢disable fullscreen‌⁡؜⁡⁡⁡⁫‍⁬‌‍‍⁠‍‌⁬‌‌‍⁮؜⁯⁡⁣⁤',
  'fabric.media.display_thumbnail':
    '⁣⁢Display thumbnail⁭؜⁠⁠‌⁮‍‍⁫⁮⁡⁫‍⁯⁮⁯⁠⁮⁫⁪⁮⁣⁤',
  ...
  'fabric.media.drop_your_files':
    '⁣⁢Drop your files to upload⁪⁮⁪⁠‍⁡‌؜⁪‌⁫⁡⁮⁭⁫؜⁡؜⁬⁠‌⁭⁣⁤',
  'fabric.media.drop_your_files_here':
  ...
  'fabric.media.preview_unavailable':
    '⁣⁢Preview unavailable⁮⁮‌⁠⁯⁪‍⁮⁯‌‌‌‍؜‍⁪⁠⁫⁯⁮⁬⁣⁤',
  ...
  'fabric.media.request_access_pending':
    '⁣⁢Access pending⁮⁯‍⁪⁭⁬⁬⁭⁯⁪‍⁫⁭⁯؜‌⁫⁫⁡⁫⁯⁡⁠⁣⁤',
  ...
  'fabric.media.upload_file_from':
    '⁣⁢Upload a file from {name}⁡⁮⁮‍⁫؜‌⁮‍⁮⁬⁯‍‍⁫⁯⁭‌⁠⁯⁮‌⁫⁠⁣⁤',
