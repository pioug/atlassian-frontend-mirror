...
const filterFeatureFlagNames = (flags: RequiredNCSFeatureFlags): Array<keyof NCSFeatureFlags> => {
	const pairs = Object.entries(flags) as Array<[keyof RequiredNCSFeatureFlags, boolean]>;
