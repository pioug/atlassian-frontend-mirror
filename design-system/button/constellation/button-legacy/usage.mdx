...
2. **Label:** Text that explains the result of selecting the button. Use action verbs or phrases to tell the user what will happen next, and follow the [button label content guidelines](/components/button/button-legacy/usage#content-guidelines).
...
Make sure the button is large enough to interact with but not visually overwhelming. There is a [compact button](/components/button/button-legacy/examples#spacing) for tight spaces.
