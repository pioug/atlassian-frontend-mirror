...
export default {
  ...
  'fabric.editor.ai.config.item.advanced-prompt.form.instructions.label': 'คำแนะนำ',
  'fabric.editor.ai.config.item.advancedPrompt.description': 'ระบุงาน คำแนะนำ และกฎต่าง ๆ',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.label': 'ความคิดสร้างสรรค์',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.high': 'สูง',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.low': 'ต่ำ',
  'fabric.editor.ai.config.item.advancedPrompt.form.creativity.option.medium': 'ปานกลาง',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'ตัวอย่างเช่น: 1. เริ่มต้นเอกสารด้วยภาพรวมคร่าว ๆ ของเป้าหมายของบริษัทของเรา 2. สร้างรายชื่อสมาชิกทีมที่สำคัญที่จะพบปะกันในสัปดาห์แรก',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'ให้คำแนะนำเกี่ยวกับงานเพื่อช่วยสร้างผลลัพธ์ที่เจาะจง',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'ตัวอย่างเช่น: ผลลัพธ์ต้องเป็นไปตามแนวทางรูปแบบของบริษัทและไม่ใช้ข้อมูลที่ไม่ได้รับการยืนยัน',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.label': 'กฎ',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder': 'ร่างกฎที่คุณต้องการให้มีการปฏิบัติตาม',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.error.required': 'โปรดระบุงาน',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'ตัวอย่างเช่น: สร้างเอกสารประกอบในการเข้าร่วมสำหรับพนักงานใหม่ที่กำลังเข้าร่วมทีม',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.label': 'งาน',
  'fabric.editor.ai.config.item.advancedPrompt.form.task.placeholder': 'อธิบายงานที่ต้องการทำให้เสร็จสมบูรณ์',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.label': 'ลักษณะการสื่อสาร',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.casual': 'ไม่เป็นทางการ',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.educational': 'วิชาการ',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.empathetic': 'เห็นอกเห็นใจ',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.neutral': 'เป็นกลาง',
  'fabric.editor.ai.config.item.advancedPrompt.form.tone.option.professional': 'มืออาชีพ',
  'fabric.editor.ai.config.item.advancedPrompt.promptLabel': 'สร้างพร้อมท์ขั้นสูง',
  'fabric.editor.ai.config.item.advancedPrompt.title': 'สร้างข้อความแจ้งเตือนขั้นสูง',
