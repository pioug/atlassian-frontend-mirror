...
- For guidelines on applying color to custom components for data visualization, see [data visualization color](/foundations/color-new/data-visualization-color/).
