...
interface Props {
	...
	/** Optional header image to show at the top of the survey */
	headerImage?: string;
	...
	/** label text for the survey text area */
	textLabel?: string;
}
...
export default ({
	...
	textLabel = 'Tell us why? (Optional)',
	headerImage,
	scoreSubtext,
	...
	useEffect(() => {
		...
		if (
			['SIGN_UP_SUCCESS', 'POST_SURVEY_NO_CONSENT', 'POST_SURVEY_HAS_SIGN_UP'].includes(currentStep)
		) {
