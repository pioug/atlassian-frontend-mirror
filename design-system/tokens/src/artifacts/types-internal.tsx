 ...
 * @codegen <<SignedSource::8554f7d7886811264d83ddea1e264847>>
...
export type InternalTokenIds =
	...
	| 'motion.keyframe.grid.column.out'
	...
	| 'color.background.danger.subtle.[default]'
	...
	| 'color.background.warning.subtle.[default]'
	...
	| 'color.background.success.subtle.[default]'
	...
	| 'color.background.discovery.subtle.[default]'
	...
	| 'color.background.information.subtle.[default]'
	...
	| 'color.border.accent.lime.[default]'
	| 'color.border.accent.lime.subtle'
	| 'color.border.accent.red.[default]'
	| 'color.border.accent.red.subtle'
	| 'color.border.accent.orange.[default]'
	| 'color.border.accent.orange.subtle'
	| 'color.border.accent.yellow.[default]'
	| 'color.border.accent.yellow.subtle'
	| 'color.border.accent.green.[default]'
	| 'color.border.accent.green.subtle'
	| 'color.border.accent.teal.[default]'
	| 'color.border.accent.teal.subtle'
	| 'color.border.accent.blue.[default]'
	| 'color.border.accent.blue.subtle'
	| 'color.border.accent.purple.[default]'
	| 'color.border.accent.purple.subtle'
	| 'color.border.accent.magenta.[default]'
	...
	| 'color.border.discovery.[default]'
	| 'color.border.discovery.subtle'
	| 'color.border.information.[default]'
	...
	| 'color.rovo.background.brand.bold.[default]'
	| 'color.rovo.background.brand.bold.hovered'
	| 'color.rovo.background.brand.bold.pressed'
	| 'color.rovo.border.lime'
	| 'color.rovo.border.saffron'
	| 'color.rovo.border.blue'
	| 'color.rovo.border.purple'
	| 'color.rovo.icon.lime'
	| 'color.rovo.icon.saffron'
	| 'color.rovo.icon.blue'
	| 'color.rovo.icon.purple'
	| 'elevation.surface.[default].[default]'
	| 'elevation.surface.[default].hovered'
	| 'elevation.surface.[default].pressed'
	| 'elevation.surface.container.[default]'
	...
	| 'elevation.rovo.surface.overlay.[default]'
