...
- The toggle component doesn't work within the form component by default. This is because the toggle is supposed to make change happen instantly, not after pressing a submit button. For options that require a button press to apply the setting, use a [checkbox](/components/checkbox).
...
- You can use a [tooltip](/components/tooltip) to explain what happens when a toggle is switched on or off.
