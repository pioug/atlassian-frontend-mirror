...
[view custom modal header.](/components/modal-dialog/examples#custom-modal-header)
...
Without this, it will not show up on top of the modal dialog and instead will remain within it's
boundaries. In some cases, this causes the select to visually seem like it is not opening whatsoever
...
For very custom use cases, you can achieve the same type of header as our `ModalHeader` component by
