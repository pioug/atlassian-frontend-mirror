...
const iconMetadata: UNSAFE_IconMetadata = {
  ...
  'arrow-right': {
    ...
    team: 'ADS',
    usage:
      'Known uses: link to nested menu item, a linked menu item, next slide.',
  ...
  'book-with-bookmark': {
    ...
    type: 'Core',
    usage:
      'Known uses: knowledge bases, articles, and other representations of books or info.',
  ...
  'chart-bar': {
    ...
    team: 'Analytics',
    usage:
      'Known uses: Reports in JSM, Space Analytics in Confluence, and other graph charts.',
  ...
  'checkbox-checked': {
    ...
    team: 'ADS',
    usage:
      'Reserved for interactive checkbox experiences. Consider using the checkbox component.',
  ...
  department: {
    ...
    team: 'Atlas',
    usage:
      'Reserved for departments, reporting lines, or other tree chart representations.',
  ...
  globe: {
    ...
    team: 'ADS',
    usage:
      'Known uses: public link in Confluence share dialog, global rules in Automation.',
    tags: 'world',
  },
  goal: {
    categorization: 'Single-purpose',
  ...
  grid: {
    ...
    team: 'ADS',
    usage:
      'Known uses: spaces in Confluence, and grid view, all content in Confluence.',
  ...
  information: {
    ...
    team: 'ADS',
    usage:
      'Known uses: helper message under textfield, information state insection messages.',
  ...
  'lock-locked': {
    ...
    team: 'ADS',
    usage:
      'Known uses: secure password in textfields, locked page in Confluence.',
  ...
  minimize: {
    ...
    team: 'ADS',
    usage:
      'Known uses: minimize modal window, minimize panel, minimize video screen.',
