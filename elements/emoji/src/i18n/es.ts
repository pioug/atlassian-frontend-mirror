...
export default {
  ...
  'fabric.emoji.emojipicker.emoi.roledescription': 'botón de emoticonos',
  ...
  'fabric.emoji.picker': 'Selector de emoticonos',
  'fabric.emoji.pickerlist.grid': '{showSearchResults, select, true {Resultados de la búsqueda} other {Emoticonos}}',
  'fabric.emoji.pickerlist.tabpanel': 'Panel de acciones y listas de emoticonos',
  ...
  'fabric.emoji.search.label': 'Nombre del emoticono',
  'fabric.emoji.search.placeholder': 'Buscar',
  'fabric.emoji.search.status': 'Viendo todos los emoticonos',
