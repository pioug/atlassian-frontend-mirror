...
export default {
  ...
  'fabric.elements.user-picker.team.member.50plus.official':
    '⁣⁢Official team {verifiedIcon} • 50+ members⁯⁮⁫⁫؜؜⁫⁪⁭⁫⁠⁮⁠⁭‌⁯⁡⁡؜⁬⁭⁪⁣⁤',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {⁣⁢Official team {verifiedIcon} • {count} member؜⁮⁠⁬‍⁪⁬⁪⁮⁭⁫⁭⁪⁪⁫‌⁯⁡⁯⁠⁣⁤} other {⁣⁢Official team {verifiedIcon} • {count} members؜⁮⁠⁬‍⁪⁬⁪⁮⁭⁫⁭⁪⁪⁫‌⁯⁡⁯⁠⁣⁤}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {⁣⁢Official team {verifiedIcon} • {count} member, including you؜⁯⁯⁪⁭⁠⁬‌⁯⁪‌⁬⁬⁬؜⁯⁮‌؜⁮⁯⁣⁤} other {⁣⁢Official team {verifiedIcon} • {count} members, including you؜⁯⁯⁪⁭⁠⁬‌⁯⁪‌⁬⁬⁬؜⁯⁮‌؜⁮⁯⁣⁤}}',
