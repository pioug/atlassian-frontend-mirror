...
describe('JIRA wiki markup - Issue key (smart card)', () => {
	const testCases: Array<[string, string]> = [
		...
		['should parse more than one issue inside a paragraph', 'ABC-10 and ABC-20 are smart cards'],
		...
		['should parse issue inside a quote macro', 'this {quote}ABC-10{quote} is a smart card'],
		['should parse issue inside a panel macro', 'this {panel}ABC-10{panel} is a smart card'],
		...
		['should not parse issue inside a bold', '*this ABC-10 is an important smart card*'],
		[
		...
		['should parse issues inside a color macro', 'this {color:red}ABC-10{color} is a smart card'],
		[
		...
		['should parse issues inside exclaimation mark', 'this !ABC-10 ! is a smart card'],
		['should parse issues after an exclaimation mark', 'this !ABC-10 is a smart card'],
		['should parse issues in between exclaimation mark', 'this !ABC-10 !ABC-20 are smart cards'],
		['should parse issues that end with a period', 'this ABC-10 text ABC-20.'],
		['should parse issues that end with a comma', 'this ABC-10 text ABC-20, ABC-30'],
