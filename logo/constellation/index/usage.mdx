...
[Download the logos](/foundations/logos).
...
There are 4 types of product logos: the logomark, the wordmark, lockups, and special use cases.
...
The logo mark is always present in global navigation. It sits center-aligned horizontally, from the container header or product wordmark.

![logomarks](images/logomark-alignment.png)

#### Logomark and wordmark in product home pages

On product home both the logomark and wordmark are present. They sit separately. The logomark sits within global navigation, and the word mark sits within the site navigation.
...
Make sure product or brand name is always included as alternative text when you use a logomark, wordmark or lockup.
