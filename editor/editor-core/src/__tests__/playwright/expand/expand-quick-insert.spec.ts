...
test.describe('quick-insert: numbered list', () => {
  ...
  test('Insert Expand in numbered list', async ({ editor }) => {
  ...
  test('Insert Expand in the middle of numbered list', async ({ editor }) => {
  ...
  test('Insert Expand in the beginning of numbered list', async ({
    editor,
  }) => {
  ...
  test('Insert Expand in the end of numbered list', async ({ editor }) => {
...
test.describe('quick-insert: nested numbered list', () => {
  ...
  test('Insert Expand in nested numbered list', async ({ editor }) => {
  ...
  test('Insert Expand in the middle of nested numbered list', async ({
    editor,
  }) => {
  ...
  test('Insert Expand in the beginning of nested numbered list', async ({
    editor,
  }) => {
  ...
  test('Insert Expand in the end of nested numbered list', async ({
    editor,
  }) => {
    await editor.selection.set({ anchor: 16, head: 16 });
    await editor.keyboard.type(' ');
