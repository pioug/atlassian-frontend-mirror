 ...
 * @codegen <<SignedSource::acd95a158c4d9053886b7ab10ef58b63>>
...
const svg = `<svg height="100%" viewBox="0 0 188 32">
    <g clip-path="url(#clip0_95164_15560)">
        ...
        <g clip-path="url(#clip1_95164_15560)">
    ...
    <defs>
        <clipPath id="clip0_95164_15560">
            <path fill="var(--icon-color, white)" d="M0 0h188v32H0z"/>
        </clipPath>
        <clipPath id="clip1_95164_15560">
            <path fill="var(--icon-color, white)" d="M7.708 8.125h16.506v15.78H7.708z"/>
        </clipPath>
    </defs>
</svg>
`;
