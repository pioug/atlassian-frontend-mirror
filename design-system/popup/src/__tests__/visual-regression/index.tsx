...
describe('Snapshot Test', () => {
	it('it should match visual snapshot for popup', async () => {
		const url = getExampleUrl('design-system', 'popup', 'popup', global.__BASEURL__);
	...
	it.skip('it should match visual snapshot for async popup', async () => {
		const url = getExampleUrl('design-system', 'popup', 'asynchronous-popup', global.__BASEURL__);
	...
	it('it should match visual snapshot for setting focus', async () => {
		const url = getExampleUrl('design-system', 'popup', 'setting-focus', global.__BASEURL__);
