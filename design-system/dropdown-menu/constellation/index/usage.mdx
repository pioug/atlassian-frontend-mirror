...
- A number of components can be used to give people the ability to select options. See the listed of related components below for advice on choosing the right one.
