...
export default {
  ...
  'fabric.media.add_captions': 'Додати субтитри',
  ...
  'fabric.media.file.display_options': 'Варіанти відображення',
  ...
  'fabric.media.manage_captions': 'Керувати субтитрами',
  ...
  'fabric.media.video_captions_delete_captions_confirmation_description':
    'Підтвердьте, що бажаєте видалити ці субтитри.',
  'fabric.media.video_captions_delete_captions_confirmation_header': 'Видалення субтитрів',
  'fabric.media.video_captions_delete_error_description': 'Не вдалося видалити субтитри.',
  'fabric.media.video_captions_delete_success_description': 'Субтитри відео видалено.',
  'fabric.media.video_captions_enable': 'Приховані субтитри',
  'fabric.media.video_captions_select_captions': 'Вибрати субтитри',
  'fabric.media.video_captions_upload_captions_form_header': 'Передати субтитри',
  'fabric.media.video_captions_upload_captions_form_language_picker': 'Вибрати мову файлу',
  'fabric.media.video_captions_upload_error_description': 'Не вдалося передати субтитри.',
  'fabric.media.video_captions_upload_success_description': 'Субтитри для цього відео передано.',
  ...
  'media.media-avatar-picker.image-cropper.arrow-keys.action':
    '{key, select, left {Зображення переміщено зліва праворуч. Для переміщення та обрізання зображень використовуйте клавіші зі стрілками} right {Зображення переміщено справа ліворуч. Для переміщення та обрізування зображень використовуйте клавіші зі стрілками} top {Зображення переміщено згори вниз. Для переміщення та обрізування зображень використовуйте клавіші зі стрілками} other {Зображення переміщено знизу вгору. Для переміщення та обрізування зображень використовуйте клавіші зі стрілками}}',
  'media.media-avatar-picker.image-cropper.arrow-keys.label':
    'Перетягуване зображення. Упевніться, що для програми читання з екрана не встановлено режим перегляду. Для переміщення та обрізування зображень використовуйте клавіші зі стрілками',
  'media.media-avatar-picker.image-cropper.zoom_in': 'Збільшення',
  'media.media-avatar-picker.image-cropper.zoom_out': 'Зменшення',
  'media.media-avatar-picker.image-cropper.zoom_slider': 'масштабування',
};
