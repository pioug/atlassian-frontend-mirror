...
snapshot(HoverCardForbiddenJira, {
  description:
    'standalone hover card forbidden view with direct_access context for Jira ',
  states: [
    {
      state: 'hovered',
...
snapshot(HoverCardForbiddenJira, {
  description:
    'standalone hover card forbidden view with request_access context for Jira',
  states: [
    {
      state: 'hovered',
...
snapshot(HoverCardForbiddenJira, {
  description:
    'standalone hover card forbidden view with pending_request_exists context for Jira',
  states: [
    {
      state: 'hovered',
...
snapshot(HoverCardForbiddenJira, {
  description:
    'standalone hover card forbidden view with denied_request_exists context for Jira',
  states: [
    {
      state: 'hovered',
...
snapshot(HoverCardForbiddenJira, {
  description:
    'standalone hover card forbidden view with forbidden context for Jira',
