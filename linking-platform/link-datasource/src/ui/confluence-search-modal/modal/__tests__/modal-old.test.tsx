...
ffTest(
	// TODO on cleaning up this ff, delete the whole file.
	'platform.linking-platform.datasources.use-refactored-config-modal',
	() => {
		// skipping ff on tests, they resides in modal.test.tsx
		expect(fg('platform.linking-platform.datasources.use-refactored-config-modal')).toBeTruthy();
	},
	() => {
