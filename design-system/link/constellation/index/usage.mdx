...
Link has an underline by default but it can be disabled in some circumstances. Underlines help
...
Only remove underlines if the context surrounding the link makes it clear that it is interactive,
