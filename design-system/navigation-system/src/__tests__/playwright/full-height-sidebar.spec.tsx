...
test.describe('full height sidebar', () => {
	 ...
	 */
	test('should have a scrolled indicator border on scroll in TopNavStart when there is no SideNavHeader', async ({
		page,
		skipAxeCheck,
		browserName,
	}) => {
	...
	test('should have a scrolled indicator border on scroll in SideNavContent when there is a SideNavHeader', async ({
		page,
		skipAxeCheck,
		browserName,
	}) => {
