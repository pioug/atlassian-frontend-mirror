...
export default {
  ...
  'fabric.elements.user-picker.group.byline.admin-managed': 'Ylläpitäjäryhmä {verifiedIcon}',
  ...
  'fabric.elements.user-picker.source.other-atlassian-appify': 'Muut Atlassian-sovellukset',
  'fabric.elements.user-picker.team.byline': 'Tiimi',
  'fabric.elements.user-picker.team.byline.official': 'Virallinen tiimi {verifiedIcon}',
  ...
  'fabric.elements.user-picker.team.member.50plus.official': 'Virallinen tiimi {verifiedIcon} • yli 50 jäsentä',
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'Virallinen tiimi {verifiedIcon} • yli 50 jäsentä, sinä mukaan lukien',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {Virallinen tiimi {verifiedIcon} • {count} jäsen} other {Virallinen tiimi {verifiedIcon} • {count} jäsentä}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {Virallinen tiimi {verifiedIcon} • {count} jäsen, sinä mukaan lukien} other {Virallinen tiimi {verifiedIcon} • {count} jäsentä, sinä mukaan lukien}}',
