...
snapshot(VrJsFallbackBlockEndAlignStart, { ...opts, description: 'js-fallback-block-end-align-start' });
snapshot(VrJsFallbackBlockEndAlignEnd, { ...opts, description: 'js-fallback-block-end-align-end' });
snapshot(VrJsFallbackInlineEndAlignStart, { ...opts, description: 'js-fallback-inline-end-align-start' });
snapshot(VrJsFallbackInlineEndAlignEnd, { ...opts, description: 'js-fallback-inline-end-align-end' });
