...
export default {
  ...
  'fabric.media.add_captions': 'เพิ่มคำอธิบาย',
  ...
  'fabric.media.file.display_options': 'ตัวเลือกการแสดง',
  ...
  'fabric.media.manage_captions': 'จัดการคำอธิบาย',
  ...
  'fabric.media.video_captions_delete_captions_confirmation_description': 'โปรดยืนยันว่าคุณต้องการลบคำบรรยายนี้',
  'fabric.media.video_captions_delete_captions_confirmation_header': 'ลบคำบรรยาย',
  'fabric.media.video_captions_delete_error_description': 'ลบคำบรรยายไม่สำเร็จ',
  'fabric.media.video_captions_delete_success_description': 'ลบคำบรรยายออกจากวิดีโอนี้เรียบร้อยแล้ว',
  'fabric.media.video_captions_enable': 'ปิดคำบรรยายแล้ว',
  'fabric.media.video_captions_select_captions': 'เลือกคำบรรยาย',
  'fabric.media.video_captions_upload_captions_form_header': 'อัปโหลดคำบรรยาย',
  'fabric.media.video_captions_upload_captions_form_language_picker': 'เลือกภาษาของไฟล์',
  'fabric.media.video_captions_upload_error_description': 'อัปโหลดคำบรรยายไม่สำเร็จ',
  'fabric.media.video_captions_upload_success_description': 'อัปโหลดคำบรรยายสำหรับวิดีโอนี้เรียบร้อยแล้ว',
  ...
  'media.media-avatar-picker.image-cropper.arrow-keys.action':
    '{key, select, left {คุณได้ย้ายรูปจากทางซ้ายไปทางขวาแล้ว ใช้คีย์ลูกศรเพื่อเลื่อนและครอบตัดรูป} right {คุณได้ย้ายรูปจากทางขวาไปทางซ้ายแล้ว ใช้คีย์ลูกศรเพื่อเลื่อนและครอบตัดรูป} top {คุณได้ย้ายรูปจากทางด้านบนไปทางด้านล่างแล้ว ใช้คีย์ลูกศรเพื่อเลื่อนและครอบตัดรูป} other {คุณได้ย้ายรูปจากทางด้านล่างไปทางด้านบนแล้ว ใช้คีย์ลูกศรเพื่อเลื่อนและครอบตัดรูป}}',
  'media.media-avatar-picker.image-cropper.arrow-keys.label':
    'รูปที่สามารถลากได้ ตรวจดูให้แน่ใจว่าตัวอ่านหน้าจอของคุณไม่อยู่ในโหมดการเรียกดู ใช้คีย์ลูกศรเพื่อเลื่อนและครอบตัดรูป',
  'media.media-avatar-picker.image-cropper.zoom_in': 'ซูมเข้า',
  'media.media-avatar-picker.image-cropper.zoom_out': 'ซูมออก',
  'media.media-avatar-picker.image-cropper.zoom_slider': 'ตั้งค่าการซูม',
};
