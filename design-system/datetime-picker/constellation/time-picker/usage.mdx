...
- If using a field with a label other than "Time", use `timePickerSelectProps` to pass the
  `aria-label` prop. Assistive technologies will announce these along with the label from the field
