...
export interface AnnotationBridge {
	setAnnotationFocus(annotationFocusPayload?: Serialized<AnnotationPayload>): void;
...
export type CallBackToNotifyConfigChange = (config: RendererConfiguration) => void;
...
export default interface RendererBridge
	...
	scrollToContentNode(nodeType: ScrollToContentNode, id: string, index?: number): Promise<boolean>;
	...
	setCallbackToNotifyConfigChange: (callback: CallBackToNotifyConfigChange) => void;
