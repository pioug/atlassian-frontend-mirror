...
<Example
	Component={AutoDismissFlagDefault}
...
<Example
	Component={AutoDismissFlagSuccess}
	packageName="@atlaskit/flag"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
...
link, use a regular [flag](/components/flag/examples) instead.

<Example
	Component={AutoDismissFlagActions}
	packageName="@atlaskit/flag"
	featureFlagDefaults={{ 'platform-dst-motion-uplift-button': true }}
/>
