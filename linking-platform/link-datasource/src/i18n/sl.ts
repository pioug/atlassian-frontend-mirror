...
export default {
  '1M7iXg': 'Urejevalnik poizvedb JQL',
  ...
  'linkDataSource.confluence-search.checkConnectionWithSource-galaxia':
    'Preverite povezavo in osvežite stran ali <a>odprite ta prostor Jira v Confluenceu</a> za pregled.',
  ...
  'linkDataSource.datasource.table.authScreenDescriptionText-appify':
    'Povežite svoj račun {providerName}, da boste lahko sodelovali pri delu v vseh aplikacijah Atlassian.',
  ...
  'linkDataSource.jira-issues.checkConnectionWithSource.visual-refresh-sllv-galaxia':
    'Preverite povezavo in osvežite stran ali <a>odprite ta prostor v Jiri</a> za pregled.',
