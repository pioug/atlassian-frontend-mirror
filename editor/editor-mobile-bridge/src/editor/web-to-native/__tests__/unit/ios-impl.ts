	...
	describe('iOS', () => {
		...
		describe('Lifecycle bridge', () => {
			describe('editorReady', () => {
				it('should call native', function () {
					...
					expect(
						windowWithMockBridges.webkit!.messageHandlers.lifecycleBridge!.postMessage,
				...
				it('should send analytics event called twice', function () {
					...
					expect(
						windowWithMockBridges.webkit!.messageHandlers.analyticsBridge!.postMessage,
		...
		describe('PageTitle bridge', () => {
			it('should call updateTitle in native', function () {
				...
				expect(
					windowWithMockBridges.webkit?.messageHandlers.pageTitleBridge?.postMessage,
				).toHaveBeenCalledWith({
					name: 'updateTitle',
					title,
				});
		...
		describe('TypeAhead bridge', () => {
			it('should call dismissTypeAhead in native', function () {
				...
				expect(
					windowWithMockBridges.webkit?.messageHandlers.typeAheadBridge?.postMessage,
				).toHaveBeenCalledWith({
		...
		describe('Content Bridge', () => {
			it('should call onContentRendered in native', function () {
				...
				expect(
					windowWithMockBridges.webkit?.messageHandlers.contentBridge?.postMessage,
				).toHaveBeenCalledWith({
		...
		describe('Toolbar Bridge', () => {
			it('should call onNodeSelected in native', () => {
				...
				expect(
					windowWithMockBridges.webkit?.messageHandlers.toolbarBridge?.postMessage,
				).toBeCalledWith({
					name: 'onNodeSelected',
					nodeType: 'panel',
					items: 'items',
		...
		describe('Collab Bridge', () => {
			it('should call updateStepVersion with version', () => {
				...
				expect(
					windowWithMockBridges.webkit?.messageHandlers.collabBridge?.postMessage,
				).toBeCalledWith({
