...
export default {
  'feedback-collector.can-be-contacted.label':
    'Atlassian voi ottaa minuun yhteyttä tähän palautteeseen liittyen',
  'feedback-collector.cancel-button.label': 'Peruuta',
  'feedback-collector.enrol-in-research.label':
    'Haluan osallistua tuotetutkimukseen',
  ...
  'feedback-collector.form.comment.label':
    'Kerro meille, mitä sinulla on mielessä',
  ...
  'feedback-collector.form.suggestion.label':
    'Kerro meille, mitä haluaisit parantaa',
