import { getExampleUrl, loadPage, waitForElementCount } from '@atlaskit/visual-regression/helper';

const datePickerSelector = '#react-select-datepicker-1-input';
const timePickerSelector = '[data-testid="timepicker-1--container"]';
const timePickerDropdownSelector = '[data-testid="timepicker-1--popper--container"]';
const datePickerDropdownSelector = '[data-testid="datepicker-1--popper--container"]';
