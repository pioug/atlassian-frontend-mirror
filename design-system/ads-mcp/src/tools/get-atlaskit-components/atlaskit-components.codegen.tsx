...
export const atlaskitComponents: ComponentMcpPayload[] = [
	...
	},
	{
		...
		usageGuidelines: [
			...
			'Use Card (comfy by default) or Card.CompactCard to select product-level density.',
			...
			'Use Card.Leading for a dedicated leading column, or Card.Header leading for avatar/tile inline with title.',
		...
		accessibilityGuidelines: [
			'Choose heading levels via Card.Title as to preserve document hierarchy.',
	...
	},
	{
		...
		props: [
			...
			{
				name: 'config',
				type: '{ actionOverrides?: ActionOverrides; actionSideEffects?: ActionSideEffects; shouldRenderInPortal?: boolean; AIButtonWrapper?: React.FC<{ children: React.ReactNode; }>; ... 37 more ...; useFreeGenerateEditorAgent?: boolean; }',
				isRequired: true,
			},
		],
	},
	...
	},
	{
		...
		description: 'Displays approved third-party brand icons as full-bleed assets inside ADS Tile.',
		status: 'early-access',
		usageGuidelines: [
