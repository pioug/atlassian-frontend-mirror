...
<SectionMessage title="Caution" appearance="warning">
  <p>
    This is an unsafe prop which will be removed in a later version. When the
    iconography system is updated to provide consistent sizing this will no
    longer be necessary.
  </p>
</SectionMessage>
...
The `overlay` prop disables the button and block user interaction. This can be used to show a spinner or other loading state.

<SectionMessage title="Caution" appearance="warning">
  <p>
    This isn't recommended for most cases. This feature may be removed in the
