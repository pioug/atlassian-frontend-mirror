...
export default () => {
  ...
  return (
    <>
      <p>
        <strong>
          These examples show different statuses effect when rendering
          "Reactions" component directly
        </strong>
      </p>
      ...
      <Example
        title={
          'Rendering "Reactions" with status of error and optional error message'
        }
        body={
          <IntlProvider locale="en">
            <Reactions
