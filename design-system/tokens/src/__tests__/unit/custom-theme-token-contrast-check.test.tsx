...
const expectedFailedLightPairs = [
	...
	['color.background.brand.bold', 'color.background.brand.subtlest.pressed'],
	['color.chart.brand', 'elevation.surface.pressed'],
	['color.chart.brand', 'elevation.surface.raised.pressed'],
	['color.chart.brand', 'elevation.surface.pressed'],
	['color.chart.brand', 'elevation.surface.raised.pressed'],
	['color.border.selected', 'elevation.surface.pressed'],
	['color.border.selected', 'elevation.surface.raised.pressed'],
	['color.border.brand', 'elevation.surface.pressed'],
	['color.border.brand', 'elevation.surface.raised.pressed'],
	['color.border.brand', 'color.background.brand.subtlest.pressed'],
	['color.text.subtlest', 'color.background.selected'],
	['color.text.subtlest', 'color.background.brand.subtlest'],
	['color.text.subtle', 'color.background.brand.subtlest.pressed'],
	['color.icon.brand', 'color.background.brand.subtlest.pressed'],
	['color.icon.subtlest', 'color.background.brand.subtlest.pressed'],
