  ...
  const content = (dimensions: Dimensions) => {
    ...
    if (!ssr) {
      if (subscribeError) {
        ...
        const errorMessage = isUploading
          ? messages.failedToUpload
          : messages.unableToLoadContent;
        const errorReason =
        ...
        return (
          <InlineImageCardErrorView message={formatMessage(errorMessage)} />
        );
      }
