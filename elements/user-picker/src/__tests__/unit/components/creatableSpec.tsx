...
import { isValidEmail, type EmailValidationResponse } from '../../../components/emailValidation';
...
describe('getCreatableProps', () => {
	...
	describe('isValidOption', () => {
		test.each([
			...
			[true, 'POTENTIAL'],
			[true, 'VALID'],
		])('should return %p when isValidEmail returns "%s"', (expected, isValidEmailReturn) => {
