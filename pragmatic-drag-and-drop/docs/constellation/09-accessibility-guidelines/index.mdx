...
The [core package](../core) does not enable accessible controls automatically, as there is no one pattern that works well for all situations. Instead, use these guidelines and our [optional packages](../optional-packages) and [Design System components](../components) to create accessible experiences.
