 ...
 * @codegen <<SignedSource::7a20e839654160570744db8a35bdd449>>
 ...
 */
export function TrelloLogo({ iconColor, textColor, label, testId }: ThemedLogoProps) {
	return (
		<LogoWrapper
			svg={svg}
