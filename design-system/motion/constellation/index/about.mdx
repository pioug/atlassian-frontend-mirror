...
We _also_ want a consistent experience across our apps. Need a particular motion that doesn't exist
yet?

Think about contributing to `@atlaskit/motion` so all apps at Atlassian can benefit.
