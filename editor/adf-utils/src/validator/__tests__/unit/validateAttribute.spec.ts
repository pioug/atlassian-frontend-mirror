...
describe('validate Attribute', () => {
	describe('at Mark Level', () => {
		...
		it('should make sure multiple marks containing' + ' invalid attributes throws errors', () => {
		...
		it(
			'should throw error when no error callback provided ' + 'and invalid attribute is present',
			() => {
				const unsupportedMarkAttribute = {
					type: 'textColor',
					attrs: {
		...
		it(
			'should throw error when no error callback provided and ' + 'redundant attribute is present',
			() => {
				const unsupportedMarkAttribute = {
					type: 'textColor',
					attrs: {
	...
	describe('at Node Level', () => {
        ...
        does not support any attribute and an attribute property is passed`, () => {
			...
			errorCallbackMock = jest.fn().mockReturnValueOnce(unsupportedNodeAttributeMark);
