...
export default {
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.helperMessage':
    'Esimerkki: 1. Aloita asiakirja lyhyellä katsauksella yrityksemme päämääristä. 2. Luettele tärkeimmät tiimin jäsenet, jotka tulokkaat tapaavat ensimmäisellä viikollaan.',
  'fabric.editor.ai.config.item.advancedPrompt.form.instructions.placeholder':
    'Anna tehtäväohjeet, joiden avulla on helpompi tuottaa tarkkoja tuloksia.',
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.helperMessage':
    'Esimerkki: Tulosten on noudatettava yrityksen tyyliohjeita eikä niissä saa käyttää vahvistamattomia tietoja.',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.rules.placeholder':
    'Määrittele säännöt, joita haluat noudatettavan.',
  ...
  'fabric.editor.ai.config.item.advancedPrompt.form.task.helperMessage':
    'Esimerkki: Luo perehdytysdokumentaatio tiimiin liittyville uusille työntekijöille.',
