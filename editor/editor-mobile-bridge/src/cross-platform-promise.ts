...
const pendingPromises: Map<string, Holder<any>> = new Map<string, Holder<any>>();
...
export function createPromise(name: 'getAuth', args: string): SubmitPromiseToNative<GetAuthPayload>;
export function createPromise(name: 'getConfig'): SubmitPromiseToNative<GetConfigPayload>;
export function createPromise(
...
export function createPromise(name: 'getAccountId'): SubmitPromiseToNative<GetAccountIdPayload>;
export function createPromise(
...
export function createPromise<T>(
	...
	const payload = typeof rawArgs === 'string' ? rawArgs : JSON.stringify(rawArgs);
