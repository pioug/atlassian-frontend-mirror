  ...
  return (
    <div>
      <div>
        ...
        <p>
          This example shows how the focus lock allowlist lets people interact
          with content outside of the modal dialog. When the nested modal is
          open, the parent modal remains accessible.
        </p>
        <p>
          Focus lock ignores specified areas. Pass the{' '}
          <code>focusLockAllowlist</code> prop a function which returns{' '}
          <code>false</code> for node which should ignored by focus lock.
        </p>
      </div>
      {isOpen && (
        <ModalDialog testId="modal-focus-lock" width="large" onClose={close}>
          ...
          <div data-allowlist-container="true">
            <ModalBody>
              <p>
                All elements of this modal are accessible through focus lock due
                to allowlisted container.
              </p>
