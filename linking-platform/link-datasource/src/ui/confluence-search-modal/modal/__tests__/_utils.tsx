...
const dest = setupFactory<ConfluenceSearchDatasourceParameters, InsertArgs, ConfluenceSearchDatasourceAdf>(
	'confluence-search',
	...
	(args) => {
		const {
			cloudId = '67899', lastModified, lastModifiedFrom, lastModifiedTo, searchString,
		} = args.parameters || {};
...
const setup: (args?: {
	...
	assertInsertResult: (args: InsertArgs, analyticsExpectedOverride?: {
		attributes?: object;
	}) => void;
