...
export default {
  ...
  "fabric.emoji.choose.file.screenReaderDescription": "Scegli un file per l'emoji. JPG, PNG o GIF. Dimensione massima: 1 MB.",
  ...
  "fabric.emoji.select.skin.tone.ariaLabel": "Seleziona la gradazione di colore, {selectedTone}"
};
