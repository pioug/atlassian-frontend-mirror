...
export default {
  ...
  'fabric.elements.user-picker.group.byline.admin-managed': "Groupe d'administrateurs {verifiedIcon}",
  ...
  'fabric.elements.user-picker.source.other-atlassian-appify': 'Autres applications Atlassian',
  'fabric.elements.user-picker.team.byline': 'Équipe',
  'fabric.elements.user-picker.team.byline.official': 'Équipe officielle {verifiedIcon}',
  ...
  'fabric.elements.user-picker.team.member.50plus.official': 'Équipe officielle {verifiedIcon} • Plus de 50 membres',
  'fabric.elements.user-picker.team.member.50plus.official.including.you':
    'Équipe officielle {verifiedIcon} • Plus de 50 membres, dont vous',
  ...
  'fabric.elements.user-picker.team.member.count.official':
    '{count, plural, one {Équipe officielle {verifiedIcon} • {count} membre} other {Équipe officielle {verifiedIcon} • {count} membres}}',
  'fabric.elements.user-picker.team.member.count.official.including.you':
    '{count, plural, one {Équipe officielle {verifiedIcon} • {count} membre, dont vous} other {Équipe officielle {verifiedIcon} • {count} membres, dont vous}}',
