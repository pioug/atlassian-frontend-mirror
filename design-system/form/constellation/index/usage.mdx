...
relevant information, such as changing personal settings or creating a Jira work item.
...
- flags
- section messages
- [Data Center forms](https://docs.atlassian.com/aui/latest/docs/forms.html)
...
<DoDont
	...
	image={{
		url: FormGroupingDo,
		alt: 'Form example where the fields "Project" and "Work type" are grouped under a subheading "Location and type".',
	}}
>
