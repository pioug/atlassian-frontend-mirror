...
const resolvedResults = [ConfluenceBlogPost, JiraIssue, SlackMessage] as JsonLd.Response[];
...
export const RelatedUrlsResolved = () => (
	<VRTestWrapper>
		<RelatedUrlsResolvedView relatedUrlsResponse={{ resolvedResults }} initializeOpened={false} />
	</VRTestWrapper>
);

export const RelatedUrlsResolvedOpened = () => (
	<VRTestWrapper>
		<RelatedUrlsResolvedView relatedUrlsResponse={{ resolvedResults }} initializeOpened={true} />
	</VRTestWrapper>
);
