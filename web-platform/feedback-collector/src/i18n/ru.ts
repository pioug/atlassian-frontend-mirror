...
export default {
  ...
  'feedback-collector.can-be-contacted.label-appify-without-link':
    'Да, команды Atlassian могут связаться со мной, чтобы узнать о моих впечатлениях и использовать эту информацию для улучшения приложений и услуг Atlassian. Я принимаю Политику конфиденциальности Atlassian.',
  'feedback-collector.can-be-contacted.label-without-link':
    'Да, команды Atlassian могут связаться со мной, чтобы узнать о моих впечатлениях и использовать эту информацию для улучшения продуктов и услуг Atlassian. Я принимаю Политику конфиденциальности Atlassian.',
  ...
  'feedback-collector.privacy-policy': 'Политика конфиденциальности Atlassian',
