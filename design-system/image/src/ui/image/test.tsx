...
describe('Image', () => {
  ...
  it('should use src even when srcDark is provided if theme is set to light', () => {
  ...
  it('should use srcDark when theme is set to dark', () => {
    setGlobalTheme('dark');
  ...
  it('should use src when theme is set to dark but srcDark is not provided', () => {
    setGlobalTheme('dark');
