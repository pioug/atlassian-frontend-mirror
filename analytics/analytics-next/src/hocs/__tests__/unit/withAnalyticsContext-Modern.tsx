import React, { createRef, forwardRef, memo, useCallback, useEffect, useMemo } from 'react';
...
const ContainerToBeWrapped = forwardRef<any, any>(({ children, dataId }, ref) => {
...
describe('withAnalyticsContext ModernContext', () => {
	...
	it('should provide analytics context via default data to children', () => {
		...
		const { getByTestId } = render(<UnderTestSingleContext onEvent={onEvent} />);
	...
	it('should provide analytics context via the anayticsContext prop to children', () => {
		...
		const { getByTestId } = render(
			<UnderTestSingleContext onEvent={onEvent} analyticsContext={analyticsContext} />,
		);
	...
	it('should provide analytics context work with many contexts to children', () => {
		...
		const { getByTestId, rerender } = render(<UnderTestManyContext onEvent={onEvent} />);
	...
	it('should not re-render consumer components when analytics-context changes', () => {
		const { getByTestId, rerender } = render(<UnderTestSingleContext onEvent={() => {}} />);
		...
		rerender(<UnderTestSingleContext onEvent={() => {}} analyticsContext={{ board: 'AFPAI' }} />);
