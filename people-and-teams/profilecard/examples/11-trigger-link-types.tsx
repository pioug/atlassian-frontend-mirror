...
const TriggerTypeTable = () => (
	<ExampleWrapper>
		...
		>
			<p>
				All of these options are available and described here for completeness. In practice only a
				small number of these will be used, but having them all available and giving a description
				of the suitability of each will reduce the chances of us having to add a new form of
				interaction later.
			</p>
			<p>
				If you’re going to add the team profile card to your product please choose sensibly from
				these options and consider accessibility.
			</p>
			<p>
			...
			<Table>
				<tr>
					...
					<Head>
						<p>No link</p>
						<Text>
							No href/interactivity added to the element. Users (especially those using keyboard or
							a screen-reader) may not realise there is a profile card here.
						</Text>
						<Text>
							Preferrably only use this if you are wrapping the trigger in a link yourself.
						</Text>
					</Head>
					<Head>
						<p>Link</p>
						...
						<Text>
							The trigger will now behave as a link to the team, but the on-click has been
							suppressed. Users can still access the link via cmd+enter (keyboard open in new tab
							shortcuts) or right-click+open in new tab, cmd+click, etc.
						</Text>
					</Head>
					<Head>
						<p>Clickable link</p>
						<Text>
							Not highly recommended unless the trigger is really <i>only</i> a link to the team
							profile page.
						</Text>
						<Text>
							Clicking the trigger will navigate to the team's profile page. Keyboard/screen-reader
							users cannot view the profile card as all they can do to interact is click.
						</Text>
					</Head>
				</tr>
				<tr>
					<Head>
						<p>Hover</p>
						<Text>
							Keyboard users can <i>never</i> open the profile card. Avoid unless the profile-card
							is superfluous and you'd rather users simply click through the view the team profile.
						</Text>
					</Head>
					<Cell>
				...
				<tr>
					<Head>
						<p>Click</p>
						<Text>
							Recommended generally for accessibility reasons. Trigger method is unambiguous and
							supports keyboard and mouse users equally.
						</Text>
					</Head>
					<Cell>
				...
				<tr>
					<Head>
						<p>Hover-click</p>
						<Text>
							Suitable for cases where mouse users <i>cannot</i> click on the trigger, e.g. the read
							view of an inline edit (looking at you, Jira team field)
						</Text>
					</Head>
					<Cell>
