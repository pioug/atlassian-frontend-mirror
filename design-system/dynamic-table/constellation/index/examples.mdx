...
add this to the empty state. See [empty state](https://atlassian.design/components/empty-state/examples) guidelines for more guidance.
...
When the table data exceeds the `rowsPerPage` quantity, the [pagination](https://atlassian.design/components/pagination/examples) component is added.
