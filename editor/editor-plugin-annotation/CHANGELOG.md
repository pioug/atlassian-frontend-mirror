...
-   [#80123](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/80123)
    ...
    state mapping so that create view component is removed when there's node changes invalidating
    the decoration
...
-   [#78508](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/78508)
    ...
    Expose setInlineCommentDraftState as one of the annotation plugin actions, extend the action
    with the ability to apply comment highlight to node, and add optional plugin dependency,
    FeatureFlagsPlugin
...
-   [#69617](https://stash.atlassian.com/projects/CONFCLOUD/repos/confluence-frontend/pull-requests/69617)
    ...
    [ux] When in editor view mode, creating new comment with annotations plugin will send step to
    NCS provider
