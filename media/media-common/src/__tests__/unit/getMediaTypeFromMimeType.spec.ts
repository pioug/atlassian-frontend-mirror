...
describe('getMediaTypeFromMimeType()', () => {
	it('should return media type for known images', () => {
		[
			...
			'image/heic',
			'image/heic-sequence',
		].forEach((mimeType) => expect(getMediaTypeFromMimeType(mimeType)).toEqual('image'));
	});
	...
	it('should return media type for known documents', () => {
		...
		].forEach((mimeType) => expect(getMediaTypeFromMimeType(mimeType)).toEqual('doc'));
	});
	...
	it('should return media type for known audios', () => {
		[
			...
			'audio/x-wav',
			'audio/x-ms-wma',
		].forEach((mimeType) => expect(getMediaTypeFromMimeType(mimeType)).toEqual('audio'));
	});
	...
	it('should return media type for known videos', () => {
		[
			...
			'video/webm',
			'video/x-ms-wmv',
		].forEach((mimeType) => expect(getMediaTypeFromMimeType(mimeType)).toEqual('video'));
	});
	...
	it('should return archive type for known archives', () => {
		[
			...
			'application/x-zoo',
			'application/x-par2',
		].forEach((mimeType) => expect(getMediaTypeFromMimeType(mimeType)).toEqual('archive'));
	});
