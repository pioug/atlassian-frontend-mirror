...
All flags require a `title` and an `icon`. Make sure the icon and color match the intent of your
message, such as warning, error, information, or success. A dismiss button will auto-display on the
