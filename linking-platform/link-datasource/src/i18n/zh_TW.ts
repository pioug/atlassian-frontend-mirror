...
export default {
  ...
  'linkDataSource.assets.configModal.renderAssetsContent.initialStateView.searchTitleOld': '搜尋物件',
  ...
  'linkDataSource.jira-issues.accessRequiredWithSiteOld': '您無法存取下列網站：',
  ...
  'linkDataSource.jira-issues.configmodal.chooseSiteOld': '選擇網站',
  ...
  'linkDataSource.jira-issues.noResultsFoundOld': '找不到結果',
  ...
  'linkDataSource.jira-issues.unableToLoadResults.visual-refresh-sllv': '我們在嘗試獲取結果時遇到問題',
  'linkDataSource.jira-issues.unableToLoadResultsOld': '無法載入結果',
  ...
  'linkDataSource.modal-initial-state.searchDescription-basic.visualRefreshSllv': '開始輸入或使用 JQL 進行搜尋。',
