...
import type { AuditLogsSidePanelProps, ProgressBarProps } from './types';
...
export default function AuditLogsSidePanel({ isSelected, testId, width }: AuditLogsSidePanelProps) {
	return (
		<div
			style={{ width }}
			css={[
