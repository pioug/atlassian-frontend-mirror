...
For a fuller guide on how to setup all the pieces, check out our [getting started guide](../getting-started)

</SectionMessage>

This page explains the high level pieces of Pragmatic drag and drop and how to use them.
